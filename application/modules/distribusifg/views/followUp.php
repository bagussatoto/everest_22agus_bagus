...
//
        $warning = "";
        $disabled_scan = "";
        if (isset($label_warning) && ($label_warning != NULL)) {
            $warning = "<div class='alert alert-danger text-center' style='font-size:15px;'>$label_warning</div>";
            ...
            <div class='row hidden-xs'>
                <div class='container-fluid'>
                    <div id='input-group-qr' class='input-group' style='display:block!important;'>
                        <input id='qr_scaner' type='$tipe_input' $disabled_checker onclick='select()' class='form-control text-center text-bold' value='' placeholder='kode produk' $disabled_scan>
        ...
        $list_data .= "<div id='hasil'></div>";
        $list_data .= "<br>" . $warning;

        if (isset($warning_sku) && sizeof($warning_sku)) {
            $list_data .= "<div class='alert alert-danger text-center' style='font-size:20px;'>";
            foreach ($warning_sku as $msgSpec) {
                $list_data .= $msgSpec . "<br>";
            }
            $list_data .= "</div class='alert alert-warning'>";
        }
