...
//            $str.="</ul class='pager'>";
            ...
            if (sizeof($arrayOnProgress) > 0) {
                ...
                $str .= "<table class='table table-condensed table-hover-color-red table-striped tablej-bordered'>";
...
//                    $strOnprogMbl .= "<p>Pengirim: " . $val['pengirim_nama'] . "</p>";
                ...
                $strOnprog .= "<table id='aarrayOnProgress_step_$stepper' class='table datatables stripe compact nowarp order-column table-condensed table-bordered no-padding' style='border:solid red 0px;'>";
                $strOnprog .= "<thead>";
...
//                            }
                ...
                $strOnprog .= "<script>
                    $(document).ready( function(){
                        var table = $('#aarrayOnProgress_step_$stepper').DataTable({
                            dom: 'lBfrtip',
                            fixedHeader: true,
                            lengthMenu: [ [10, 20, 50, 100, -1], [10, 20, 50, 100, 'All'] ],
                            pageLength: -1,
...
//                                    ],
                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                        ...
                                        var arrayFooter = $('#aarrayOnProgress_step_$stepper>tfoot>tr>th');
                                        var dpageTotal = [];
                            ...
                            $('.table-responsive.step_$stepper').scroll(function () {
                                setTimeout(function () {
                                    $('#aarrayOnProgress_step_$stepper').DataTable().fixedHeader.adjust();
                                }, 400);
                            });
                    </script>";
            }
...
//            if (strlen($description) > 0) {
            ...
            if (strlen($description) > 0) {
                ...
                echo "<span class='' style='font-style:italic;font-family:Monaco, Menlo, Consolas, \"Courier New\", monospace;'>-</span><br>";
            }
            echo "</td>";
            ...
            echo "<span class='text-muted'>description note</span><br>";
            if (strlen($description) > 0) {
                echo "<span class='' style='font-style:italic;font-family:Monaco, Menlo, Consolas, \"Courier New\", monospace;'>" . nl2br($specialDescription) . "</span><br>";
            }
            else {
                echo "<span class='' style='font-style:italic;font-family:Monaco, Menlo, Consolas, \"Courier New\", monospace;'>-</span><br>";
            }
...
//                }
                ...
                if (isset($label_catatan) && sizeof($label_catatan)) {
                    echo "<div class='alert alert-danger text-left font-size-1-5'>";
                    echo $label_catatan;
                    echo "</div class='alert alert-warning'>";
                }
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                if (isset($deleteSpec['targetUrl']) != "" && $deleteSpec['targetUrl'] != "") {
                    ...
                    class='btn btn-danger margin' style='border:1px #ff7700 solid;ccolor:#ff7700;' 
                ...
                if (isset($editSpec['targetUrl']) != "" && $editSpec['targetUrl'] != "") {
                    echo "<button type='button' 
                    class='btn btn-default margin' style='border:1px #ff7700 solid;color:#ff7700;' 
                    onclick=\"if(confirm('" . $editSpec['warning'] . "')==1){document.getElementById('f1').action='" . $editSpec['targetUrl'] . "';document.getElementById('f1').submit();}\"><span class='fa fa-pencil'></span> " . $editSpec['label'] . "</button>";
                }
                else {
                ...
                if ((isset($extBtns) && sizeof($extBtns) > 0) || (isset($payBtns) && sizeof($payBtns) > 0)) {
                    ...
                    if (isset($rejectionSpec['targetUrl']) != "" && $rejectionSpec['targetUrl'] != "") {
                        echo "<button type='button' 
                        class='btn btn-danger margin' style='border:1px #dd3300 solid;ccolor:#dd3300;' 
                        onclick=\"if(confirm('" . $rejectionSpec['warning'] . " " . $new_beforeStepLabels . "')==1){
...
//                        echo "&nbsp;&nbsp;";
                    ...
                    if (isset($rejectionSpecAll['targetUrl']) != "" && $rejectionSpecAll['targetUrl'] != "") {
                        echo "<button type='button' 
                        class='btn btn-danger' style='border:1px #000000 solid;color:#ffffff;background-color:#000000;' 
                        onclick=\"if(confirm('" . $rejectionSpecAll['warning'] . "')==1){
                    ...
                    if (isset($approvalSpec['targetUrl']) != "" && $approvalSpec['targetUrl'] != "") {
                        echo "<button button type='button' $disabled_checker
                        class='btn btn-success margin' style='border:1px #008800 solid;color:#ffffff;' 
                ...
                if (isset($xShipmentBtn['targetUrl']) && $xShipmentBtn['targetUrl'] != "") {
                    echo "&nbsp;&nbsp;<button type='button' 
                    class='btn btn-danger margin' style='bborder:1px #fff solid;color:#ffffff;' 
...
//        }
        ...
        $arrayHistoryLabels = isset($arrayHistoryLabels) ? $arrayHistoryLabels : array();
        $arrayHistory = isset($arrayHistory) ? $arrayHistory : array();
        $link_undone = base_url() . $this->modul . "/Transaksi/viewRequestItemsIndex2/$jenisTr";
        ...
        $strOnprog .= "<div class=\"box box-danger $cslass_hidden\">";
        $strOnprog .= "<div class=\"box-header with-border text-red\">";
        $strOnprog .= "<span><h4 class=\"box-title text-uppercase blink\">$onprogressTitle</h4></span>";
        $strOnprog .= "<span class='box-tools pull-right'>$strBg</span>";

        $strOnprog .= "<div class='box-tools pull-right'>";
        $strOnprog .= "<button type='button' class='btn btn-box-tool' onclick=\"$('#requestItems2').load('$link_undone');\"><i class='fa fa-refresh'></i></button>";
        $strOnprog .= "<button type='button' class='btn btn-box-tool' data-widget='collapse'><i class='fa fa-minus'></i></button>";
        $strOnprog .= "</div>";
...
//                    $strOnprogMbl .= "<p>Pengirim: " . $val['pengirim_nama'] . "</p>";
                ...
                if (count($steps) == $stepper) {
                    ...
                    foreach ($arrayOnProgress as $key => $val) {
                        //----------------------
//                        $background_color = isset($arrayOnprogressMarking[$key]['style']) ? $arrayOnprogressMarking[$key]['style'] : "";
                        $background_color = isset($arrayOnprogressPartialMark[$key]['style']) ? $arrayOnprogressPartialMark[$key]['style'] : "";
...
//                $strOnprogFooter = "";
    ...
    case "viewPrePo":
        ...
        if (sizeof($customerDetail) > 0) {
            ...
            $tlp = $customerDetail["tlp"];
            $alamat = $customerDetail["alamat_1"];
            $kecamatan = $customerDetail["kecamatan"];
            $kabupaten = $customerDetail["kabupaten"];
            $propinsi = $customerDetail["propinsi"];
            ...
            $tbl .= "<tr>";
            $tbl .= "<td width='100px'>Nama</td><td>:</td>";
            $tbl .= "<td>$nama</td>";
            $tbl .= "</tr>";
            $tbl .= "<tr>";
            ...
            $tbl .= "</tr>";
            $tbl .= "<tr>";
            $tbl .= "<td>NPWP</td><td>:</td>";
            $tbl .= "<td>$npwp</td>";
            $tbl .= "</tr>";

            $tbl .= "</table>";
            $str .= "<div class='panel'>";
            $str .= "<div class='panel-body bborder-cek'>";
            $str .= "<h4 class='title no-padding no-margin'>Konsumen</h4>";
            $str .= $tbl;
            $str .= "</div>";
            $str .= "</div>";
        }
        ...
        if (sizeof($deliveryDetail) > 0) {
            ...
            $str .= "<div class='panel'>";
            $str .= "<div class='panel-body bborder-cek'>";
            $str .= "<h4 class='title no-padding no-margin'>Alamat Pengiriman</h4>";
            $str .= $tbl;
            $str .= "</div>";
            $str .= "</div>";
        }

        // region items_blacklist
        $str .= "<div id='viewBlacklist' class='table-responsive'>";
        if (isset($items_blacklist) && (sizeof($items_blacklist) > 0)) {
            $str .= "<h4>$judulBlacklist</h4>";
            $str .= "<table class='table table-bordered table-condensed' style='margin-top:-10px;'>";
            if (isset($itemsHeader) && (sizeof($itemsHeader) > 0)) {
                $str .= "<tr bgcolor='#f5f5f5'>";
                $str .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>no.</th>";
                foreach ($itemsHeader as $key => $label) {
            ...
            $no = 0;
            $disabled_remove = (sizeof($items_blacklist) == 1) ? "disabled" : "";
            foreach ($items_blacklist as $iSpec) {
                $pid = $iSpec["id"];
                $bg_warning = "";
                if (array_key_exists($pid, $itemsBlacklist)) {
                    $bg_warning = "background-color:#f39c12;";
                }
                $no++;
                $str .= "<tr line=" . __LINE__ . " id='data_so_$pid' style='$bg_warning'>";
                $str .= "<td align='right'>";
                $str .= $no;
                $str .= ".</td>";
                foreach ($itemsHeader as $key => $label) {
                    ...
                    if ($key == "action") {
//                        $fieldVal = "<button class='btn btn-xs btn-danger' $disabled_remove
//                        onclick=\"$('#result').load('$link_remove?pid=$pid');\">
...
//                        </button>";
        ...
        // endregion items_blacklist

        // region items
        $str .= "<div id='viewPrePo' class='table-responsive'>";
        if (isset($items) && (sizeof($items) > 0)) {
            $str .= "<h4>$judulReguler</h4>";
            $str .= "<table class='table table-bordered table-condensed' style='margin-top:-10px;'>";
            if (isset($itemsHeader) && (sizeof($itemsHeader) > 0)) {
                $str .= "<tr bgcolor='#f5f5f5'>";
                $str .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>no.</th>";
            ...
            $no = 0;
            $disabled_remove = (sizeof($items) == 1) ? "disabled" : "";
            foreach ($items as $iSpec) {
                $pid = $iSpec["id"];
                $bg_warning = "";
                if (array_key_exists($pid, $itemsBlacklist)) {
                ...
                foreach ($itemsHeader as $key => $label) {
                    ...
                    if ($key == "action") {
                        $fieldVal = "<button class='btn btn-xs btn-danger' $disabled_remove $disabledLockerTransaksi
                        onclick=\"$('#result').load('$link_remove?pid=$pid');\">
                        <span class='glyphicon glyphicon-remove'></span>
                        </button>";
                    }
        ...
        if (isset($disabled_supplier_warning) && ($disabled_supplier_warning != NULL)) {
            $str .= "<div id='disabled_supplier_warning' class='alert alert-danger' style='font-size:15px;'>";
            $str .= "$disabled_supplier_warning";
            $str .= "</div>";
        }
        if (isset($newWarningLabel) && ($newWarningLabel != NULL)) {
            $str .= "<div id='newWarningLabel' class='alert alert-danger' style='font-size:15px;'>";
            $str .= "$newWarningLabel";
            $str .= "</div>";
        }

        cekHitam("[$disabled_supplier || $disabledLockerTransaksi]");

        $str .= "<div class='row'>";
        $str .= "<div class='col-md-6'>";
        $str .= "<button class='btn btn-block btn-default' data-dismiss='modal'
        onclick=\"document.getElementById('result').src='$link_remove';\">
        <span class='glyphicon glyphicon-chevron-left'></span> cancel</button>";
        $str .= "</div class='col-md-6'>";


        $str .= "<div class='col-md-6'>";
        $str .= "<button id='button_pre_po' class='btn btn-block btn-success' $disabled_supplier $disabledLockerTransaksi
        onclick=\"if(confirm('your selected items will be processed. Continue saving?')==1){top.open_holdon();document.getElementById('result').src='" . $actionTarget . "';this.style.visibility='hidden';}\">
        <span class='glyphicon glyphicon-ok'></span> terbitkan PRE-PO </button>";
        $str .= "</div class='col-md-6'>";
        $str .= "</div class='row'>";
