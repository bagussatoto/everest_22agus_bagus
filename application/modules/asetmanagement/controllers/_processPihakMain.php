...
//         matiHere();
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main']['pihakMainID_coa'] = $tmpB[0]->coa_code;
            $_SESSION[$cCode]['main']['pihakMainID_coa_name'] = $tmpB[0]->$selectColumn;
            $stat = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            $_SESSION[$cCode]['main']['pihakMainAkumID_coa'] = $staticAssetsAccountProduksi[$tmpB[0]->coa_code];
            $_SESSION[$cCode]['main']['pihakMainAkumName_coa'] = "akum penyu ".$tmpB[0]->$selectColumn;
            $accountChilds = null != $this->config->item('accountSubChilds') ? $this->config->item('accountSubChilds') : array();
//            arrPrint($accountChilds);
            if(isset($accountChilds[$staticAssetsAccountProduksi[$tmpB[0]->coa_code]])){
                $_SESSION[$cCode]['main']['comRekName_1_child_coa'] = $accountChilds[$staticAssetsAccountProduksi[$tmpB[0]->coa_code]];
            }
...
//                                        matiHEre("ini".$f_ex[1]);
                ...
                if (sizeof($temp2) > 0) {
                    ...
                    if (strlen($temp2[0]->$validateField) == 0) {
                        if ($selectMethod) {
                            ...
                            $_SESSION[$cCode]['main']['pphGate_coa'] = "2030030";//hutang pph23
                        }
                        else {
                            $_SESSION[$cCode]['main'][$replaceTarget] = 10;
                            $_SESSION[$cCode]['main']['pphGate'] = "hutang pph4 ayat 2";
                            $_SESSION[$cCode]['main']['pphGate_coa'] = "2030080";//hutang pph4 ayat 2
    ...
    public function remove()
    {
        ...
        $_SESSION[$cCode]['main']['pihakMainID_coa'] = null;
        $_SESSION[$cCode]['main']['pihakMainID_coa_name'] = null;
        ...
        unset($_SESSION[$cCode]['main']['pihakMainID_coa']);
        unset($_SESSION[$cCode]['main']['pihakMainID_coa_name']);
