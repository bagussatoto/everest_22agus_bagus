...
class _processSelectAktiva extends Modul_Controller
{
...
//                    $persediaan = sizeof($tmpC) > 0 ? $tmpC[0]->persediaan : "0";
                    if (sizeof($tmpC) > 0) {
//                        arrPrint($tmpC);
                        foreach ($tmpC as $row_price) {
                            $satuan = strlen($row_price->satuan) > 0 ? $row_price->satuan : "n/a";
                            $nama = $row_price->nama;

                            $jml_now = $row_price->jumlah;
...
//                            cekHere("jml_sudah_diambil: $jml_sudah_diambil, jml_diperlukan: $jml_diperlukan, jml_nambah: $jml_nambah");
                            ...
                            $new_jml_active = $jml_now - $jml_nambah;
...
//                            mati_disini(__LINE__ . " :: " . count($array_hold_sebelumnya));
//                            if (sizeof($array_hold_sebelumnya) > 0 && $array_hold_sebelumnya["jumlah"] > 0) {
...
//
//        echo "<script>";
//        echo "top.$('#result').load('" . base_url() . "ValueGate/buildValues/" . $this->jenisTr . "?selID=$id');";
//        echo "</script>";
    }
