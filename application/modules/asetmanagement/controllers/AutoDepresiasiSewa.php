...
class AutoDepresiasiSewa extends CI_Controller
{
...
//        cekHitam("LINE: " . __LINE__ . " || " . $this->db->last_query());
//        cekMerah("lockerValue");
//        arrPrint($lockerValue);
        ...
        foreach ($biayaMethodProduksi1 as $biayaMethodProduksiTmp) {
            $autoRekNameProduksi_1[$biayaMethodProduksiTmp->id] = $biayaMethodProduksiTmp->nama;
            $autoRekNameProduksi_lv1[$biayaMethodProduksiTmp->nama] = "RekeningPembantuBiayaKomposisiProduksi";
        }

//        arrPrint($biayaMethodProduksi1);
//        arrPrint($autoRekNameProduksi_1);
//        arrPrint($autoRekNameProduksi_lv1);
        ...
        foreach ($biayaMethodProduksi as $biayaMethodProduksiTmp) {
            ...
            $autoRekNameProduksi_lv2[$biayaMethodProduksiTmp->nama] = "RekeningPembantuBiayaKomposisiProduksi";
        }

//        arrPrint($biayaMethodProduksi);
//        arrPrint($autoRekNameProduksi_2);
//        arrPrint($autoRekNameProduksi_lv2);
...
//        arrPrint($rekeningBesar);
//        arrPrint($autoRekNameSales_lv2);
        ...
        foreach ($detailItems as $itemsData) {
            foreach ($kol as $kolom) {
                if ($itemsData->dtime_last_depresiasi == "" OR isset($itemsData->dtime_last_depresiasi) && date("Y-m-d", strtotime($itemsData->dtime_last_depresiasi)) != date("Y-m-d") OR isset($_GET['force'])) {
...
//            cekMerah("sourceItems");
//            arrPrint($sourceItems);
...
//
//                cekHere( "detilSourceTmp $cabID" );
//                arrPrint( $detilSourceTmp );
...
//                            arrPrint($prodsDetil);
                            ...
                            cekHitam(($dateNow - $tglDepreItems) == 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | saatnya amortisasi tgl " . date('Y-m-d H:i:s') : (($dateNow - $tglDepreItems) < 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | kurang " . ($tglDepreItems - $dateNow) . " hari hingga amortisasi" : "(pID:" . $prodsDetil['extern_id'] . ") $namaP | sudah lewat " . ($dateNow - $tglDepreItems) . " hari sejak amortisasi"));
...
//                            $comRekName_1_child = isset($staticAccountComRekening[$rekName_1_child]) ? $staticAccountComRekening[$rekName_1_child] : "";
                            $comRekName_2_child = $cabID == 25 ? $autoRekNameProduksi_lv2[$prodsDetil['rekening_main']] : (isset($staticAccountComRekeningSales[$prodsDetil['rekening_main']]) ? $staticAccountComRekeningSales[$prodsDetil['rekening_main']] : "");
                            $rekName_2_child = $cabID == 25 ? $prodsDetil['rekening_main'] : $prodsDetil['rekening_main'];
                            $comRekName_3_child = $cabID == 25 ? $autoRekNameProduksi_lv1[$autoRekNameProduksi_1[$prodsDetil['rekening_details']]] : (isset($staticAccountComRekeningSales[$prodsDetil['rekening_main']]) ? $staticAccountComRekeningSales[$prodsDetil['rekening_main']] : "");
...
//arrPrintWebs($autoRekNameSales_3);
//cekUngu($namaP);
...
//                                    "rekAkum_child" => isset($pihakMain[$prodsDetil['asset_account']]) ? "akum penyu ".$pihakMain[$prodsDetil['asset_account']] : "",
//                                    "rekName_1_child"       => $rekName_1_child,
//                                    "comRekName_1_child"    => $comRekName_1_child,
                                    "comRekName_2_child" => $comRekName_2_child,
                                    "rekName_2_child" => $rekName_2_child,
...
//                            arrPrint($arrItems);
                            ...
                            $cn->setModul("asetmanagement"); //di tembak dulu belum bisa pake $this->modul
                            $cn->setStepCode($this->jenisTr);
...
//        if (isset($_GET['exe'])) {
        ...
        mati_disini(__FUNCTION__ . " method dan fungsi ini dimatikan, silahkan menggunakan yang versi COA MODE, silahkan tutup popup ini");
