...
class SetupDepresiasi extends CI_Controller
{
    public function __construct()
    {
        ...
        $className = "Mdl" . $this->uri->segment(2) . $this->uri->segment(4);
...
//            $selectedCabType = false === strpos( $this->uri->segment(4) , "Production", 1) ? "Production" : "";
//            $className = $className . $selectedCabType;
//        }
//        else{
//            $selectedCabType = false === strpos( $this->uri->segment(4) , "Sales", 1) ? "Sales" : "";
//            $className = $className . $selectedCabType;
//        }
//
//        $this->load->model("Mdls/" . $className);
...
//        matiHere();
        ...
        if ($this->uri->segment(4) != "" && $this->uri->segment(4) == "Assets") {
...
//            "asset_account" => "asset_account",
        ...
        $ctrlName = "Mdl" . $this->uri->segment(2) . $this->uri->segment(4);
        $className = $this->uri->segment(2) . $this->uri->segment(4);
        $setupDepre = $this->uri->segment(4) != null ? $this->uri->segment(4) : "Assets";
...
//            cekOrange("pending: " . $lockerSource[$_SESSION['login']['cabang_id']][$rID]['nilai'] );
            ...
            if (!isset($existData[$rID]['repeat']) && ($rData['harga_perolehan'] * 1) > 0 && $lockerSource[$_SESSION['login']['cabang_id']][$rID]['nilai'] > 0) {
                ...
                if (isset($existData[$rID])) {
                    $updateLink = base_url() . get_class($this) . "/edit/" . $this->uri->segment(4) . "/" . $rID . "?val=" . $dataDef;
                    $addLink = "#";
                    ...
                    $updateLink = "#";
                    $addLink = base_url() . get_class($this) . "/add/" . $this->uri->segment(4) . "/" . $rID . "?val=" . $dataDef;
                    $editClick = "#";
                    $addClick = "
                    ...
                    elseif ($alias == 'repeat') {
                        ...
                        $addStr .= "
                                    <div style='margin-top: 2px;' class='btn-group btn-group-justified btn-group-xs' role='button' aria-label=''>
                                        ...
                                        <a type='button' class='btn btn-xs btn-info' disabled ><i class='fa fa-cogs'></i></a>
                                    </div>";
                        ...
                        $switchSewa = $this->uri->segment(4) == 'Sewa' ? 'Sewa' : "";
                        $txtSwitchSewa = $this->uri->segment(4) == 'Sewa' ? 'Amortisasi' : "Depresiasi";
                        $addStr .= "
                        \n <script>
                                ...
                                swal.queue([{
                                  ...
                                  preConfirm: function () {
                                    return new Promise(function (resolve) {
                                      $.get('" . base_url() . "AutoDepresiasi" . $switchSewa . "?byexternid=" . $Data->extern_id . "&force=1&exe')
                                        .done(function (data) {
...
//            arrPrint($rData['extern_id']);
            ...
            if (isset($existData[$rID])) {
                $updateLink = base_url() . get_class($this) . $this->uri->segment(4) . "/edit/" . $rID . "?val=" . $dataDef;
                $addLink = "#";
                $editClick = "BootstrapDialog.show(
                                   {
                                        title:'Modify setup data depresiasi',
                ...
                $updateLink = "#";
                $addLink = base_url() . get_class($this) . $this->uri->segment(4) . "/add/" . $rID . "?val=" . $dataDef;
                $editClick = "#";
                $addClick = "
                        BootstrapDialog.show(
                           {
        ...
        //button class
        if ($this->uri->segment(4) == "Assets") {
            $assetsActive = "success active";
        }
        if ($this->uri->segment(4) == "Sewa") {
            $sewaActive = "success active";
        }

        $menu_depresiasi = "<div class='btn-group'>";
        $menu_depresiasi .= "<button onclick =\"location.href='" . base_url() . "asetmanagement/SetupDepresiasi/view/Assets';\" type='button' class='btn btn-$assetsActive text-bold '>Depresiasi ASSET's  &nbsp; <span class='badge bg-red'></span></button>";
        $menu_depresiasi .= "<button onclick =\"location.href='" . base_url() . "asetmanagement/SetupDepresiasi/view/Sewa';\" type='button' class='btn btn-$sewaActive text-bold '>Amortisasi SEWA  &nbsp; <span class='badge bg-red'></span></button>";
        $menu_depresiasi .= "</div>";

//        echo json_encode($arrayHistorySold);
        ...
        $data = array(
            ...
            "title_depresiasi" => "<div style='font-size: 20px;' class='box-header text-bold text-green'>Asset Management (" . $this->uri->segment(4) . ")</div>",
            "subTitle" => "",
            ...
            "thisPagePending" => base_url() . get_class($this) . "/asetmanagement/" . $this->uri->segment(2) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(4) . "?trashed=$objState",
            "thisPageActive" => base_url() . get_class($this) . "/asetmanagement/" . $this->uri->segment(2) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(4) . "?trashed=$objState",
            "thisPageDepre" => base_url() . get_class($this) . "/asetmanagement/" . $this->uri->segment(2) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(4) . "?trashed=$objState",
            "thisPageSold" => base_url() . get_class($this) . "/asetmanagement/" . $this->uri->segment(2) . "/" . $this->uri->segment(4) . "/" . $this->uri->segment(4) . "?trashed=$objState",
...
//        cekBiru($this->db->last_query());
        ...
        $f->openForm(base_url() . get_class($this) . "/editProcess/" . $this->uri->segment(4) . "/" . $selectedID);
...
//        $this->load->view('data', $data);
    ...
    public function add()
    {
        ...
        $f->openForm(base_url() . get_class($this) . "/addProcess/" . $this->uri->segment(4));
        $f->fillForm($className, $tmp);
        $f->closeForm();
