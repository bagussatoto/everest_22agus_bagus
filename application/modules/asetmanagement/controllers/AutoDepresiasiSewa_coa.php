...
//class AutoDepresiasiSewa_coa extends CI_Controller
class AutoDepresiasiSewa_coa extends Modul_Controller
{
    ...
    {
        $fieldMidValidatorRules = isset($this->configUi[$this->jenisTr]["shoppingCartFieldMidValidators"]) ? $this->configUi[$this->jenisTr]["shoppingCartFieldMidValidators"] : array();
        $fieldMidPairedItemValidatorRules = isset($this->configUi[$this->jenisTr]["shoppingCartFieldMidValidatorsPairedItem"]) ? $this->configUi[$this->jenisTr]["shoppingCartFieldMidValidatorsPairedItem"] : array();
        $rowMidValidatorRules = isset($this->configUi[$this->jenisTr]["shoppingCartRowMidValidators"]) ? $this->configUi[$this->jenisTr]["shoppingCartRowMidValidators"] : array();
        $fieldMidComparisonValidatorRules = isset($this->configUi[$this->jenisTr]["shoppingCartFieldMidValidatorsComparison"]) ? $this->configUi[$this->jenisTr]["shoppingCartFieldMidValidatorsComparison"] : array();
    ...
    {
        $unionValidatorRules = isset($this->configUi[$this->jenisTr]["shoppingCartUnionValidators"]) ? $this->configUi[$this->jenisTr]["shoppingCartUnionValidators"] : array();
        $cCode = "_TR_" . $this->jenisTr;
        $rawPrevURL = isset($_GET['rawPrev']) ? $_GET['rawPrev'] : "";
        $errMsgs = array();
        $errLines = array();
    ...
    public function index_OLD()
    {
        ...
        $d = new MdlSetupDepresiasiSewaProduction(); //
        ...
        $a = new MdlSewaDetail(); //aset sewa saja
        $a->addFilter("jenis=sewa");
        ...
        $bmp1 = new MdlDtaBiayaProduksi();
        $biayaMethodProduksi1 = $bmp1->lookupAll()->result();
        $autoRekNameProduksi_1 = array();
        $autoRekNameProduksi_lv1 = array();
        foreach ($biayaMethodProduksi1 as $biayaMethodProduksiTmp) {
            $autoRekNameProduksi_1[$biayaMethodProduksiTmp->coa_code] = $biayaMethodProduksiTmp->nama;
            $autoRekNameProduksi_lv1[$biayaMethodProduksiTmp->nama] = "RekeningPembantuBiayaKomposisiProduksi";
        }
        ...
        foreach ($biayaMethodProduksi as $biayaMethodProduksiTmp) {
            ...
            $autoRekNameProduksi_lv2[$biayaMethodProduksiTmp->coa_code] = "RekeningPembantuBiayaKomposisiProduksi";
        }

        //Coa Account Alias
        $arrCoaAccount = fetchAccountStructureAlias();

//        cekHere($arrCoaAccount);
        ...
        if (sizeof($autoRekNameSales_lv2) > 0) {
            foreach ($autoRekNameSales_lv2 as $name => $mdlName) {
                ...
                foreach ($produkRakitanPreBiaya as $produkRakitanPreBiayaTmp) {
                    $autoRekNameSales_3[$name][$produkRakitanPreBiayaTmp->coa_code] = $produkRakitanPreBiayaTmp->nama;
                }
            }
        }

        $staticAccountComRekeningSales = array(
            // ini define coa lama
//            "0602" => "RekeningPembantuBiayaUsaha",
//            "0603" => "RekeningPembantuBiayaUmum",

            // sementara define diganti menjadi coa saat ini
...
//                    isset($itemsData->dtime_last_depresiasi) && date("Y-m-d", strtotime($itemsData->dtime_last_depresiasi)) != date("Y-m-d") OR
//                    isset($_GET['force'])) {
...
//                }
        ...
        $mainTmp = array(
            ...
            "jenisTrMaster" => "8788",
            "jenisTrTop" => "8788r",
            "jenisTrName" => "request amortisasi sewa",
            "stepNumber" => "1",
            "stepCode" => "8788r",
            "dtime" => "dtime",
            "fulldate" => "date",
            ...
            "comRekName_1_coa" => "comRekName_1_coa",
            "rekName_1_coa" => "rekName_1_coa",
            "comRekName_2_coa" => "comRekName_2_coa",
            "rekName_2_coa" => "rekName_2_coa",
            "comRekName_3_coa" => "comRekName_3_coa",
            "rekName_3_coa" => "rekName_3_coa",
            "comRekName_4_coa" => "comRekName_4_coa",
            "rekName_4_coa" => "rekName_4_coa",
            "comRekName_5_coa" => "comRekName_5_coa",
            "rekName_5_coa" => "rekName_5_coa",
        ...
        $itemsTmp = array(
            ...
            "rekName5ID_coa" => "rekName5ID_coa",
            "rekName5Name_coa" => "rekName5Name_coa",
            "pihakMainName_coa" => "pihakMainName_coa",
            "pihakMainID_coa" => "pihakMainID_coa",
        ...
        $tableIn_masterTmp = array(
            ...
            "jenis_top" => "8788r",
            "jenis" => "8788r",
            "jenis_label" => "request amortisasi sewa",
            "div_id" => "18",
            "div_nama" => "default",
            "oleh_id" => "olehID",
            "oleh_nama" => "olehName",
        ...
        if (sizeof($data) > 0) {
            ...
            foreach ($data as $dataExtern) {
                ...
                if ($dataExtern->dtime_last_depresiasi == "" OR
                    isset($dataExtern->dtime_last_depresiasi) && date("Y-m-d", strtotime($dataExtern->dtime_last_depresiasi)) != date("Y-m-d") OR
                    isset($_GET['force'])) {
...
//            arrPrint($groupItems);
            //region build dulu berdasarkan jenis amortisasi
            $finalData = array();
...
//                    arrPrint($finalData);
            ...
            //endregion build dulu berdasarkan jenis amortisasi
...
//                            cekHitam(
//                                ($dateNow - $tglDepreItems) == 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | saatnya amortisasi tgl " . date('Y-m-d H:i:s') :
//                                    (($dateNow - $tglDepreItems) < 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | kurang " . ($tglDepreItems - $dateNow) . " hari hingga amortisasi" :
//                                        "(" . $prodsDetil['extern_id'] . ") $namaP | sudah lewat " . ($dateNow - $tglDepreItems) . " hari sejak amortisasi || <span style='color: lime;font-weight:700;'>lastAmortisasi TGL: $tglTerakhirDepresiasi</span>")
//                            );
                            ...
                            $colorNotif = ($dateNow - $tglDepreItems) == 0 ? "background-color: green" : (($dateNow - $tglDepreItems) < 0 ? "background-color: yellow" : "background-color: gray");

                            $tableView .= "<tr style='$colorNotif'>";
                            ...
                            $tableView .= "<td>" . $prodsDetil['asset_account'] . "</td>";
                            $tableView .= "<td>" . $prodsDetil['rekening_main'] . "</td>";
                            $tableView .= "<td>" . $prodsDetil['rekening_details'] . "</td>";
                            ...
                            $rekName_2_coa = $cabID == 25 ? "5020040" : "5020040";
                            $rekName_3_coa = $cabID == 25 ? "5020040" : $prodsDetil['rekening_main'];

                            // 4 dan 5 khusus untuk solo
                            $rekName_4_coa = $cabID == 25 ? "5020040" : "";
                            $rekName_5_coa = $cabID == 25 ? "030201" : "";
                            $pihakMainID_coa = $cabID == 25 ? "3020010030" : "";
                            $pihakMainName_coa = $cabID == 25 ? $arrCoaAccount[$pihakMainID_coa] : "";

                            $comRekName_2_coa = $cabID == 25 ? "RekeningPembantuBiayaKomposisiProduksi" : $staticAccountComRekeningSales[$prodsDetil['rekening_main']];
                            $comRekName_3_coa = $cabID == 25 ? "RekeningPembantuBiayaSewa" : $staticAccountComRekeningSales[$prodsDetil['rekening_main']];
                            $comRekName_4_coa = $cabID == 25 ? "RekeningPembantuBiayaKomposisiProduksi" : "";
                            $comRekName_5_coa = $cabID == 25 ? "RekeningPembantuEfisiensiBiaya" : "RekeningPembantuBiayaSewa";

                            $rekName_1_child_coa = "6100030"; //COA: (Biaya Sewa Belum Ditempatkan) semua masuk sini dulu produksi maupun non produksi

                            $rekName_2_child_coa = $cabID == 25 ? "5020040" : $prodsDetil['rekening_main'];
                            $rekName2NameChild_coa = $cabID == 25 ? $arrCoaAccount[$rekName_2_child_coa] : $prodsDetil['rekening_details'];

                            $rekName_3_child = $cabID == 25 && $prodsDetil['rekening_details'] > 0 ? $autoRekNameProduksi_1[$prodsDetil['rekening_details']] : $autoRekNameSales_3[$prodsDetil['rekening_main']][$prodsDetil['rekening_details']];
                            $rekName_3_child_coa = $cabID == 25 && $prodsDetil['rekening_details'] > 0 ? $autoRekNameProduksi_1[$prodsDetil['rekening_details']] : $autoRekNameSales_3[$prodsDetil['rekening_main']][$prodsDetil['rekening_details']];
                            $rekName3IDChild = $cabID == 25 ? 0 : $prodsDetil['rekening_details'];
                            $rekName3IDChild_coa = $cabID == 25 ? 0 : $prodsDetil['rekening_details'];

                            //region items
                            if (isset($lockerSource[$cabID][$produk_id]) && $lockerSource[$cabID][$produk_id]['nilai'] > 1 && ($dateNow - $tglDepreItems) == 0 OR isset($_GET['force']) && isset($lockerSource[$cabID][$produk_id]) && $lockerSource[$cabID][$produk_id]['nilai'] > 1) {

                                if (isset($_GET['force'])) {
                                    cekMerah($namaP . ' DIPAKSA UNTUK DIamortisasi ');
                                }

                                $valCount = (($prodsDetil['harga_perolehan']) / $prodsDetil['economic_life_time']);
                                $valSisaLocker = isset($lockerSource[$cabID][$produk_id]['nilai']) ? $lockerSource[$cabID][$produk_id]['nilai'] : 0;
                                $valDef = (($valSisaLocker) < $valCount) ? ($valSisaLocker) : ceil(($prodsDetil['harga_perolehan']) / $prodsDetil['economic_life_time']);
                                ...
                                $arrItems[$produk_id] = array(
                                    ...
                                    "comRekName_2_child_coa" => $comRekName_2_coa,
                                    "rekName_2_coa" => $rekName_2_coa,
                                    "rekName_2_child_coa" => $rekName_2_child_coa,
                                    "rekName2NameChild_coa" => $rekName2NameChild_coa,

                                    "comRekName_3_child_coa" => $comRekName_3_coa,
                                    "comRekName_3_coa" => $comRekName_3_coa,
                                    "rekName_3_coa" => $rekName_3_coa,

                                    "comRekName_4_child_coa" => $comRekName_4_coa,
                                    "comRekName_4_coa" => $comRekName_4_coa,
                                    "rekName_4_coa" => $rekName_4_coa,

                                    "comRekName_5_child_coa" => $comRekName_5_coa,
                                    "comRekName_5_coa" => $comRekName_5_coa,
                                    "rekName_5_coa" => $rekName_5_coa,
                                    "rekName5ID_coa" => $prodsDetil['extern_id'],
                                    "rekName5Name_coa" => $prodsDetil['extern_nama'],
                        ...
                        $main = array(
                            ...
                            "jenisTrMaster" => "8788",
                            "jenisTrTop" => "8788r",
                            "jenisTrName" => "request amortisasi*",
                            "stepNumber" => "1",
                            "stepCode" => "8788r",
                            "dtime" => dtimeNow(),
                            "fulldate" => dtimeNow(),
                        ...
                        $tableJurnal = "<table cellspacing='1' cellpadding='1' border='1' bgcolor='#fff'>";
                        $tableJurnal .= "<caption>JURNAL #1</caption>";
                        $tableJurnal .= "<tbody>";

                        //=============jurnal 1
                        $tableJurnal .= "<tr>";
                        $tableJurnal .= "<th align='left'>011001 sewa dibayar dimuka</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>-$subtotal</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "</tr>";
                        ...
                        $tableJurnal .= "<tr>";
                        $tableJurnal .= "<th align='left'></th>";
                        $tableJurnal .= "<th align='right'>rekName_2_coa || $rekName_2_coa</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>$subtotal</th>";
                        $tableJurnal .= "</tr>";
                        ...
                        //=============jurnal 2
                        $tableJurnal .= "<th align='left'>rekName_2_coa || $rekName_2_coa</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>$subtotal</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "</tr>";
                        ...
                        $tableJurnal .= "<tr>";
                        $tableJurnal .= "<th align='left'></th>";
                        $tableJurnal .= "<th align='right'>rekName_3_coa || $rekName_3_coa</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>$subtotal</th>";
                        $tableJurnal .= "</tr>";
                        ...
                        //=============jurnal 3
                        $tableJurnal .= "<th align='left'>rekName_4_coa || $rekName_4_coa</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>$subtotal</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "</tr>";
                        ...
                        $tableJurnal .= "<tr>";
                        $tableJurnal .= "<th align='left'></th>";
                        $tableJurnal .= "<th align='right'>rekName_5_coa || $rekName_5_coa</th>";
                        $tableJurnal .= "<th align='right'></th>";
                        $tableJurnal .= "<th align='right'>$subtotal</th>";
                        $tableJurnal .= "</tr>";
                        ...
                        if ($cabID !== 25) {
//                            unset($itemsTmp['comRekName_5_child_coa']);
//                            unset($itemsTmp['comRekName_5_coa']);

//                            unset($main['comRekName_5_child_coa']);
//                            unset($main['comRekName_5_coa']);

//                            unset($mainTmp['comRekName_5_child_coa']);
//                            unset($mainTmp['comRekName_5_coa']);
                        }

//                        cekHijau($tableJurnal);
                                    ...
                                    foreach ($iterator as $cCtr => $tComSpec) {
                                        ...
                                        if (isset($tComSpec['static'])) {
                                            foreach ($tComSpec['static'] as $key => $value) {
                                                $realValue = makeValue($value, $gate['main'], $gate['main'], 0);
                                                ...
                                                foreach ($gotParams as $gateName => $gSpec) {
                                                    ...
                                                    if (sizeof($itemNumLabels) > 0) {
                                                        ...
                                                        foreach ($itemNumLabels as $key => $label) {
                                                            ...
                                                            if (isset($gate['main'][$key])) {
                                                                $gate['main']['sub_' . $key] = ($gate['main']['jml'] * $gate['main'][$key]);
                                                            }
                                                        }
                                                    }
                                                }
...
//                            matiHere("modul_transaksi: $modul_transaksi || jenisTrTarget: $jenisTrTarget");
...
//                                $doWriteReg = $tr->writeRegistries($insertID, $baseRegistries) or die(lgShowError("Ada kesalahan", "Gagal saat berusaha  write base params into registries"));
                            ...
                            if (sizeof($iterator) > 0) {
                                foreach ($iterator as $cCtr => $tComSpec) {
                                    ...
                                    $tmpOutParams[$cCtr] = array();
                                    if (isset($gate[$srcGateName]) && (sizeof($gate[$srcGateName]) > 0)) {
//                                        arrPrint($gate[$srcGateName]);
                                        foreach ($gate[$srcGateName] as $xid => $dSpec) {
                                            //                            $id = $dSpec['id'];

                                            foreach ($injectors_items as $ikey => $ival) {
                                                $gate[$srcGateName][$id][$ikey] = $ival;
                                            }
                                            ...
                                            if (isset($tComSpec['static'])) {
                                                ...
                                                $subParams['static']["fulldate"] = date("Y-m-d");
                                                $subParams['static']["dtime"] = date("Y-m-d H:i:s");
                                                if (isset($gate['revert']['postProc']['detail'])) {
                                                    $subParams['static']["reverted_target"] = $gate['main']['pihakExternID'];
                                                }
                            ...
                            if (sizeof($iterator) > 0) {
                                ...
                                foreach ($iterator as $cCtr => $tComSpec) {
                                    ...
                                    if (substr($comName, 0, 1) == "{") {
                                        ...
                                        $comName = trim($comName, "}");
                                        $comName = str_replace($comName, $gate['main'][$comName], $comName);
                                    }
                                    $srcGateName = $tComSpec['srcGateName'];
                                    $srcRawGateName = $tComSpec['srcRawGateName'];
                                    echo "component # $cCtr: $comName<br>";

                                    $dSpec = $gate[$srcGateName];
                                    $tmpOutParams = array();
                                    if (isset($tComSpec['loop'])) {
                                        foreach ($tComSpec['loop'] as $key => $value) {
                                            ...
                                            if (substr($key, 0, 1) == "{") {
                                                $key = trim($key, "{");
                                                $key = trim($key, "}");
                                                $key = str_replace($key, $gate['main'][$key], $key);
                                            }

                                            $realValue = makeValue($value, $gate[$srcGateName], $gate[$srcGateName], 0);
                                    ...
                                    if (isset($tComSpec['static2'])) {
                                        ...
                                        foreach ($tComSpec['static2'] as $key => $value) {
                                            ...
                                            $realValue = makeValue($value, $gate[$srcGateName][$cCtr], $gate[$srcGateName][$cCtr], 0);
...
//                            cekOrange('gak bikin transaksi mungkin nilai udh abiss wkwkwk');
        ...
        cekBiru("======================================= batas bawah SEWA =======================================");

//endregion batas sewa

//        if (isset($_GET['exe'])) {
//        mati_disini("============= BELUM COMMIT COA===============");
        ...
        if (isset($_GET['force'])) {
            if (isset($_GET['byexternid'])) {
                writeLog(__FUNCTION__, "force amortisasi", "amortisasi", $_GET['byexternid'], $this->session->login['nama']);
            }
            else {
                writeLog(__FUNCTION__, "force amortisasi", "amortisasi", "all", $this->session->login['nama']);
            }
        }

        echo "jika halaman tidak menutup dengan otomatis, anda bisa klik close";
//        }
//        else {
...
//                            );
                            ...
                            if ((isset($lockerSource[$cabID][$produk_id]) && $lockerSource[$cabID][$produk_id]['nilai'] > 1 && ($dateNow - $tglDepreItems) == 0) OR
                                (isset($_GET['force']) && isset($lockerSource[$cabID][$produk_id]) && $lockerSource[$cabID][$produk_id]['nilai'] > 1)) {
...
//                            arrPrint($arrItems);
                            ...
                            if (sizeof($buildTablesDetail) > 0) {
                                foreach ($buildTablesDetail as $buildTablesDetail_specs) {
                                    foreach ($sessionData["items"] as $itemSpec) {
                                        $mdlName = $buildTablesDetail_specs['comName'];
                                        if (substr($mdlName, 0, 1) == "{") {
                                            $mdlName = trim($mdlName, "{");
                                            $mdlName = trim($mdlName, "}");
                            ...
                            if (sizeof($iterator) > 0) {
                                foreach ($iterator as $cCtr => $tComSpec) {
                                    ...
                                    if (isset($sessionData[$srcGateName]) && (sizeof($sessionData[$srcGateName]) > 0)) {
                                        foreach ($sessionData[$srcGateName] as $xid => $dSpec) {
                                            foreach ($injectors_items as $ikey => $ival) {
                                                $sessionData[$srcGateName][$id][$ikey] = $ival;
                                            }
                                            $id = $xid;
                                            $subParams = array();
                                            if (isset($tComSpec['loop'])) {
                            ...
                            if (sizeof($iterator) > 0) {
                                ...
                                foreach ($iterator as $cCtr => $tComSpec) {
                                    ...
                                    if (isset($tComSpec['static'])) {
                                        ...
                                        $tmpOutParams['static']["fulldate"] = date("Y-m-d");
                                        $tmpOutParams['static']["dtime"] = date("Y-m-d H:i:s");
                                        $tmpOutParams['static']["keterangan"] = $this->configUi[$this->jenisTr]['steps'][1]['label'] . " nomor " . $tmpNomorNota . " oleh SYSTEM";
                                    ...
                                    if (isset($tComSpec['static2'])) {
                                        ...
                                        $tmpOutParams['static2']["fulldate"] = date("Y-m-d");
                                        $tmpOutParams['static2']["dtime"] = date("Y-m-d H:i:s");
                                        $tmpOutParams['static2']["keterangan"] = $this->configUi[$this->jenisTr]['steps'][$stepNum]['label'] . " nomor " . $tmpNomorNota . " oleh SYSTEM";
...
//        mati_disini("============= BELUM COMMIT COA =============== code: " . __LINE__);
        ...
        if (isset($_GET['force'])) {
            if (isset($_GET['byexternid'])) {
                writeLog(__FUNCTION__, "force amortisasi", "amortisasi", $_GET['byexternid'], "SYSTEM");
            }
            else {
                writeLog(__FUNCTION__, "force amortisasi", "amortisasi", "all", "SYSTEM");
            }
        }
