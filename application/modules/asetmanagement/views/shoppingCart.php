                ...
                foreach ($itemLabels as $key => $label) {
                    ...
                    switch ($listMode[$key]) {
                        case "input":
                            ...
                            $pemicuGerbangAsli = "pemicuGerbangAsli editTarget='" . $iSpec['editTarget'] . "' onblur=\"if(this.value!=this.defaultValue){hiliteDiv(this);document.getElementById('result').src='" . $iSpec['editTarget'] . "'$qtyParam+'$queryParams&key_source=$keyID';} \" $keyupData";
                            ...
                            if (isset($keyupAction) && $keyupAction == true) {
                                ...
                                echo "onkeyup=\"delay( function(){ $('#shopping_cart').trigger('change'); console.log(this); }, 1000, this );if(parseFloat(removeCommas(this.value))>0){ this.value=addCommas(this.value) }else{ this.value=0 }\"";
                            }
                            echo ">";
...
//                    echo "<td colspan='" . sizeof($itemLabels) . "' class='text-right $bottom_borderless valign-m text-uppercase'>$label</td>";
                    echo "<td colspan='" . $colspan_r . "' class='text-right  valign-m text-uppercase'>$label</td>";
