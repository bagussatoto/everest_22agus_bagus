                        ...
                        if (isset($imageType)) {
                            switch ($imageType) {
                                case "images":
                                    ...
                                    echo "<input type='file' id='file-upload' style='border: none;' name='file' class='file' accept='.jpg,.jpeg,.png,.webp,.gif,image/*' onchange=\"if(this.files && this.files[0] && this.files[0].size > 5242880){swal({'text':'file terlalu besar (maks 5MB)'}); this.value=''; return false;} document.getElementById('myForm_$iID').submit();swal({'text':'uploading image ... ... ',showConfirmButton: false,timer:5000,});\">";
