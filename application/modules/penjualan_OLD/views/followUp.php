            ...
            <div class='row hidden-xs'>
                <div class='container-fluid'>
                    <div id='input-group-qr' class='input-group' style='display:block!important;'>
                        <input id='qr_scaner' type='$tipe_input' $disabledScanner $disabled_checker onclick='select()' class='form-control text-center text-bold' value='' placeholder='kode produk'>
