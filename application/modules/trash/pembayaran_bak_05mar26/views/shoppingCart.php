            ...
            if (isset($showFormulirFaktur) && ($showFormulirFaktur == true)) {
                ...
                foreach ($fakturBlocks as $bIdx => $block) {
                    ...
                    foreach ($currentData as $ctt => $fSpec) {
                        $faktur .= "<div class='panel $panelClass' style='margin-top: 15px; border-width: 2px;'>";
                        $faktur .= "<div class='panel-heading' style='font-weight: bold;'>$blockTitle</div>";
                        ...
                        foreach ($currentParam["fields"] as $fff => $f_labels) {
                            ...
                            if (isset($currentParam["editableFields"][$fff])) {
                                ...
                                if ($currentParam["editableFields"][$fff] == "checkbox") {
                                    ...
                                    $value = ($ctt == 0) ? "<input type='$inputType' id='$inputID' class='$classinputType' name='$fff' onclick='this.select()' value='$defValues' $checked onblur=\"eksekutor_$blockGate(this.$vals,this.name,$ctt)\">" : "";
                                    ...
                                    if ($isClonable) {
                                        ...
                                        $vals = "value";
                                        $checked = "";
                                    $value = "<input type='$inputType' id='$inputID' class='$classinputType' name='$fff' onclick='this.select()' value='$defValues' $checked onblur=\"eksekutor_$blockGate(this.$vals,this.name,$ctt)\">";
                                    }
                                }
                                else {
