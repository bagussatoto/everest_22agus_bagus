...
//                        $arrDiskonLockerData[$mnSpec->transaksi_id][$mnSpec->produk_id] = array(
//                            "suppliers_id" => $mnSpec->supplier_id,
//                            "suppliers_nama" => $mnSpec->supplier_nama,
//                        );
...
//                        $tmp[$fName] = isset($row->$fName) ? formatField_he_format($fName, $row->$fName, $jenis_trans, $modules_path) : formatField_he_format($fName, 0, $jenis_trans, $modules_path);
                        $tmp[$fName] = isset($row->$fName) ? formatField_he_format($fName, $row->$fName, $jenis_trans, $modules_path) : "n/a";
...
//                            }
//                            else {
//                                $tmpByPihakID[$row->suppliers_id][$fName] = isset($row->$fName) ? formatField_he_format($fName, $row->$fName, $jenis_trans, $modules_path) : formatField_he_format($fName, 0, $jenis_trans, $modules_path);
//                            }
//                        }
//                        else {
//                            $tmpByPihakID[$row->suppliers_id][$fName] = "";
...
//                    if ($fName == "no") {
//                        $tmp[$fName] = formatField_he_format($fName, $numb, $jenis_trans, $modules_path);
//                        $tmpByPihakID[$row->suppliers_id][$fName] = formatField_he_format($fName, $numb, $jenis_trans, $modules_path);
//                    }
                ...
                $arrayOnprogressGroupPartialMark[$currentStepNum][] = $tmpMark;
                //--------------
//                $arrayOnprogressByPihakID[$row->suppliers_id] = "";
                //--------------
//                break;
            }
        }
