        ...
        if($_GET["sub_target"] == "produk"){
            ...
            foreach($mainDataMaterial as $idMaterial => $dataMaterial){
                ...
                if($dataMaterial['hpp_supplier']*1 == 0){
                    ...
                    matiHere("material <r>($nama_materialnya)</r> belum memiliki nilai anggaran, silahkan update nilai anggaran pada menu harga & diskon agar mendapatkan nilai anggaran yang sesuai.<br><br>semua material yang belum memiliki harga anggaran, tidak dapat digunakan pada project.");
                }
                else{
...
//        );
    ...
    public function recordTermin()
    {
        ...
        if($_SESSION[$cCode]['main']['harga_nppn']*1<=0){
        ...
        $total_project = $_SESSION[$cCode]['main']['harga_nppn']*1 > 0 ? $_SESSION[$cCode]['main']['harga_nppn']*1 : matiHere('silahkan menyusun RAB untuk mengetahui harga project.');
...
//        matiHere(__LINE__);
        ...
        $total_project = $_SESSION[$cCode]['main']['harga_nppn']*1 > 0 ? $_SESSION[$cCode]['main']['harga_nppn']*1 : 0;
...
//            cekmerah("cCode: $cCode");
//            cekmerah("total_project_last: $total_project_last");
//            cekmerah("total_project: $total_project");
        ...
        echo "<script>";
//        echo "top.console.log('#2  SUDAH SAMA');";
//        echo "top.console.log('#2 cCode: $cCode | total_project: $total_project || total_project_last: $total_project_last');";
        echo "top.$('#shopping_cart').load('" . base_url() . $this->modul . "/" . "_shoppingCart/viewCart/" . $this->jenisTr . "?epreketek=yes&populate=1');";
        echo "</script>";
    }

    function sessionTotalCheck(){
