...
//                            echo "<span class='hidden'><input name='retensi' class='validationCheck' type='checkbox'></span>";
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                //JIKA ADA TOMBOL UNLOCK TRANSAKSI (TIDAK JADI DIPAKAI KARENA TRANSAKSI BISA DI UNLOCK SAAT PENGUNCI CLOSE UI PREVIEW)
                //echo "<button type='button' class='btn btn-sm btn-warning btn-shine margin text-bold' style='border:1px #ff7700 solid;'><span class='fa fa-unlock'></span> Buka Kunci Transaksi </button>";
