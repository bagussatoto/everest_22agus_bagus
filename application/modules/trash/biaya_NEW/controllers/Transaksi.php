...
class Transaksi extends Modul_Controller
{
    ...
    public function validate()
    {
        ...
        $pihakMainValueValidator = isset($this->configUi[$this->jenisTr]['pihakMainValueValidator']) ? $this->configUi[$this->jenisTr]['pihakMainValueValidator'] : array();
        ...
        if(sizeof($pihakMainValueValidator)>0){
            if(isset($pihakMainValueValidator["enabled"]) && ($pihakMainValueValidator["enabled"] == true)){
                $gateTarget = $pihakMainValueValidator["gateTarget"];
                if(!isset($_SESSION[$cCode][$gateTarget])){
                    $msg = $pihakMainValueValidator["label"] . " code: " . __LINE__;
                    $errMsgs[] = $msg;
                }
                elseif(sizeof($_SESSION[$cCode][$gateTarget]) == 0){
                    $msg = $pihakMainValueValidator["label"] . " code: " . __LINE__;
                    $errMsgs[] = $msg;
                }
            }
