...
//         arrPrint($tmpTr);
        ...
        if (sizeof($tmpTr) > 0) {
            ...
            //            cekHijau($receiptDetailFieldsReplacerConfig);
            $fieldSrcs2_sum = isset($this->configUi[$tmpTr[0]->jenis_master]['shoppingCartFieldSrc2_sum']) ? $this->configUi[$tmpTr[0]->jenis_master]['shoppingCartFieldSrc2_sum'] : array();
            $itemLabels2_sum = $shoppingCartFields2_sum = isset($this->configUi[$tmpTr[0]->jenis_master]['shoppingCartFields2_sum'][$currentStepNum]) ? $this->configUi[$tmpTr[0]->jenis_master]['shoppingCartFields2_sum'][$currentStepNum] : array();
                        ...
                        if (isset($row->$param)) {
                            switch ($param) {
                                ...
                                case "items2"://
                                    ...
                                    break;
                                case "items2_sum"://
                                    $items2_sum = $items2_sumRegistries = unserialize(base64_decode($row->$param));
                                    break;
                                case "items3_sum"://
...
//arrPrintCyan($receiptSumFields);
//arrPrintCyan($receiptSumFieldsUi);
//arrPrintHitam($receiptSumFieldsLayout);
...
//            "freelancerMark" => isset($freelancerMark) ? $freelancerMark : array(),
            ...
            "label_items2_sum" => isset($this->configUi[$jenisTr]['pihakMainReferencelabel']) ? $this->configUi[$jenisTr]['pihakMainReferencelabel'] : "",

        );


//         arrPrintHijau($itemLabels2_sum);
        // arrPrint($globalVars);
        //arrPrintWebs($fixedElementsReplace);
