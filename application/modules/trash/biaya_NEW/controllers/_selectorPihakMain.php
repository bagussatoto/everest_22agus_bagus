...
//        $this->jenisTr = $this->uri->segment(4);
    ...
    public function selectPihak()
    {
        ...
        $pihakMainFiltersRulesAdd = isset($this->configUi[$jenisTr]['pihakMainFiltersRulesAdd']) ? $this->configUi[$jenisTr]['pihakMainFiltersRulesAdd'] : array();
        ...
        $selectorFields2 = isset($this->configUi[$jenisTr]['pihakMainViewedFields2']) ? $this->configUi[$jenisTr]['pihakMainViewedFields2'] : array();
...
//                $tmpName=isset($row->nama)?$row->nama:"";
                    ...
                    elseif (sizeof($selectorFields2) > 0) {
                        $nCtr = 0;
                        $tmpName = "";
                        if (isset($pairedStock[$row->id])) {

                        }
                        foreach ($selectorFields2 as $f) {
                            $nCtr++;
                            $align = $nCtr == 1 ? "text-left" : "text-right";
                            $fSize = $nCtr == 1 ? "font-size:1em" : "font-size:0.9em";
                            $color = isset($colors[$nCtr]) ? $colors[$nCtr] : "#000000";
