    ...
    case "view":
        ...
        if (isset($items)) {
            if (is_array($items) && (sizeof($items) > 0)) {
                ...
                $strContent .= "<li class='list-group-item text-center text-muted' style='background:#e5e5c5;'><small>... type more keywords for more specific results ...</small> $data_kunci";
                $strContent .= "</li>";
