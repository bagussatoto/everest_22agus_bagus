...
switch ($mode) {
    case "recap":
        ...
        $btn_netto = "";
        if ($allowReportAkses > 0) {
            $link_rnetto = base_url() . "penjualan/ActivityReport/viewSalesMonthly/582?gr=cGVuanVhbGFu";
            $btn_netto .= "<span class='input-group-btn'>";
            $btn_netto .= "<button type='button' class='btn btn-info text-capitalize' onclick=\"location.href='$link_rnetto'\">ke report penjualan netto</button>";
            $btn_netto .= "</span>";
        }
        ...
        $nav_top = $ly->selectTahun($thPilihan, "year", $btn_netto);
        //region main conten
        $content = "";
        ...
        if (sizeof($names) > 0) {
            ...
            if (isset($names[$selectedFilter]) && sizeof($names[$selectedFilter]) > 0) {
                ...
                $content .= "<div> <span class='btn btn-sm btn-warning btn-flat' onclick=\"fnExcelReport('main_$selectedFilter')\"> Export/Download to Excel </span> </div>";
                $content .= "<div class='clearfix'>&nbsp;</div>";
                $content .= "<div class='table-responsive main_$selectedFilter'>";
                $content .= "<table id='main_$selectedFilter' align='center' class='table display table-bordered no-padding' styles='table-layout: fixed; width: 100%; display: -webkit-flex; /* Safari */
  -webkit-flex-wrap: wrap; /* Safari 6.1+ */
  display: flex;   
  flex-wrap: wrap;'>";

                $timeColspan = count($times) * 2 + 6;

                $content .= "<thead>";
                $content .= "<tr>";
//                $content .= "<td colspan='$timeColspan' time_colspan='$timeColspan' class='text-center fa-2x text-bold'><h4>$title $subTitle by $identifierLabels[$selectedFilter]</h4>";
                $content .= "<td colspan='$timeColspan' time_colspan='$timeColspan' class='text-left fa-2x text-bold text-uppercase'><h4>$title $subTitle by $identifierLabels[$selectedFilter] Report $currYear  &nbsp;<small>($dtime)</small></h4>";
                $content .= "</td>";
                $content .= "</tr>";
                ...
                foreach ($names[$selectedFilter] as $oID => $oName) {
                    ...
                    foreach ($times as $pID => $pName) {
                        ...
                        if (isset($recaps[$selectedStep][$selectedFilter][$pID][$oID]['qty']) && $recaps[$selectedStep][$selectedFilter][$pID][$oID]['qty'] > 0) {
                            $countQty += 1;
                        }
                        if (isset($recaps[$selectedStep][$selectedFilter][$pID][$oID]['value']) && $recaps[$selectedStep][$selectedFilter][$pID][$oID]['value'] > 0) {
                            $countVal += 1;
                        }
                    ...
                    $avgQty = number_format($totalH[$oID]['qty'] / $countQty);
                    $avgVal = number_format($totalH[$oID]['value'] / 1000 / $countVal);
                    ...
                    $content .= "<td align='right' class='text-muted'>";
                    $content .= $histLink['open'] . $avgQty . $histLink['close'];
                    $content .= "</td>";
                    $content .= "<td align='right' class='text-muted text-blue'>";
                    $content .= $histLink['open'] . $avgVal . $histLink['close'];
                    $content .= "</td>";
                ...
                $content .= "<script>
                    $('#main_$selectedFilter').DataTable({
                        dom: 'lBfrtip',
                        fixedHeader: true,
                        ...
                        buttons: [],
                        bSort: true,
                        columnDefs: [{orderable: false, target: 0},{orderable: false, target: 1}]
                    });
                    $('.table-responsive.main_$selectedFilter').floatingScroll();
                    $('.table-responsive.main_$selectedFilter').scroll(function () {
                        setTimeout(function () {
                            $('#main_$selectedFilter').DataTable().fixedHeader.adjust();
                        }, 400);
                    });
                </script>";
        ...
        if (sizeof($recapName) > 0) {
            if (sizeof($recapName > 0)) {
                ...
                $content2 .= "<div> <span class='btn btn-sm btn-warning btn-flat' onclick=\"fnExcelReport('main2_recapName')\"> Export/Download to Excel </span> </div>";
                $content2 .= "<div class='clearfix'>&nbsp;</div>";
                $content2 .= "<div class='table-responsive main2_recapName'>";

                $content2 .= "<table id='main2_recapName' align='center' class='table display table-bordered no-padding' styles='table-layout: fixed; width: 100%; display: -webkit-flex; /* Safari */
  -webkit-flex-wrap: wrap; /* Safari 6.1+ */
  display: flex;   
  flex-wrap: wrap;'>";
                ...
                $content2 .= "<thead>";
                $content2 .= "<tr>";
                $content2 .= "<td colspan='$timeColspan' class='text-center'><h4>$title $subTitle (by seller)</h4>";
                $content2 .= "</td>";
                $content2 .= "</tr>";
...
//                            $content2 .= "<tr>";
//                            $content2 .= "<td td_pertama rowspan='$rowspan'>$n</td>";
//                            $content2 .= "<td td_kedua rowspan='$rowspan'>" . $recapNameLabel[$sID] . "</td>";
//                            $content2 .= "</tr>";
                            if (isset($recapChild[$selectedStep][$kn][$selectedFilter][$sID]) && sizeof($recapChild[$selectedStep][$kn][$selectedFilter][$sID]) > 0) {
                                ...
                                foreach ($recapChild[$selectedStep][$kn][$selectedFilter][$sID] as $ddID => $ddLabel) {
                                    ...
                                    if ($nr == 0) {
                                        $content2 .= "<td style=''>$n</td>";
                                        $content2 .= "<td style=''>" . $recapNameLabel[$sID] . "</td>";
                                    }
                                    else {
                                        $content2 .= "<td style='color: transparent;'>$n</td>";
                                        $content2 .= "<td style='color: transparent;'>" . $recapNameLabel[$sID] . "</td>";
                                    }
                                    $content2 .= "<td rowspan3='nih' rowspan='$rowspan3'>$ddLabel</td>";
                                    ...
                                    foreach ($times as $pID => $pName) {
                                        ...
                                        if (isset($recapList[$selectedStep][$kn][$selectedFilter][$pID][$sID][$ddID]['qty']) && $recapList[$selectedStep][$kn][$selectedFilter][$pID][$sID][$ddID]['qty'] > 0) {
                                            $countQty += 1;
                                        }
                                        if (isset($recapList[$selectedStep][$kn][$selectedFilter][$pID][$sID][$ddID]['value']) && $recapList[$selectedStep][$kn][$selectedFilter][$pID][$sID][$ddID]['value'] > 0) {
                                            $countVal += 1;
                                        }
                                    }
                                    ...
                                    $avgQty = number_format($totalH[$ddID]['qty'] / $countQty);
                                    $avgVal = number_format($totalH[$ddID]['value'] / 1000 / $countVal);
                                    ...
                                    $content2 .= "<td align='right' class='text-muted'>";
                                    $content2 .= $histLink['open'] . $avgQty . $histLink['close'];
                                    $content2 .= "</td>";
                                    $content2 .= "<td align='right' class='text-muted text-blue'>";
                                    $content2 .= $histLink['open'] . $avgVal . $histLink['close'];
                                    $content2 .= "</td>";
                ...
                $content2 .= "<script>
                    ...
                    $('.table-responsive.main2_recapName').floatingScroll();
                    $('.table-responsive.main2_recapName').scroll(function () {
                        setTimeout(function () {
                            $('#main2_recapName').DataTable().fixedHeader.adjust();
                        }, 400);
                    });
                </script>";
...
//cekHere(";; $title :: $subTitle");
//        $p = New Layout("$title", "$subTitle (by " . $identifierLabels[$selectedFilter] . createObjectSuffix($identifierLabels[$selectedFilter]) . ")", MODUL_TEMPLATE_PATH . "template/abReport.html");
        $p = New Layout("$title", "$subTitle", MODUL_TEMPLATE_PATH . "template/abReport.html");
                ...
                if (is_array($detailFields)) {
                    ...
                    if (sizeof($detailFields) > 0) {
                        ...
                        foreach ($detailFields as $key => $keTmp) {
                            ...
                            //
                            $content .= "<span class='pull-left $status'>" . formatField("nomer", $nmr) . "</span><br>";
                    ...
                    $content .= "<td>" . formatField($field, $tempValue[$field]) . "</td>";
                }
                    ...
                    $(document).ready( function(){
                        var table = $('table#dataTabel').DataTable({
                            ...
                            buttons: [
                                ...
                                $('.table-responsive.dataTabel').scroll(function () {
                                    setTimeout(function () {
                                        $('#dataTabel').DataTable().fixedHeader.adjust();
                                    }, 400);
                            });
                    </script>";
...
//                        $addLinkParam_00['trID_reference_master'] = "";
        ...
        $link_content2 = base_url() . "ActivityReport/viewSalesOrderMonthly";
  ...
  flex-wrap: wrap;'>";
    ...
    case "recap_ext2":
        ...
        if (sizeof($masterRekeningData) > 0) {
            ...
            $content .= "<div class='clearfix'>&nbsp;</div>";
            $content .= "<div class='table-responsive rekening'>";
                    ...
                    $(document).ready( function(){
                        var table = $('#rekening').DataTable({
                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                        ...
                                        var arrayFooter = $('#rekening>tfoot>tr>th');
                                        var dpageTotal = [];
                                        jQuery.each(arrayFooter, function(i,d){
                                            var id_n_index = parseFloat(i);
                                            dpageTotal[id_n_index] = 0;
                                ...
                                $('.table-responsive.rekening').floatingScroll();
                                $('.table-responsive.rekening').scroll(function() {
                                    setTimeout(function () {
                                        $('#rekening').DataTable().fixedHeader.adjust();
                                    }, 100);
                                });
                            });
                    </script>";
        ...
        if (sizeof($recaps) > 0) {
            ...
            $content .= "<div> <span class='btn btn-sm btn-warning btn-flat' onclick=\"fnExcelReport('main_1')\"> Export/Download to Excel </span> </div>";
            $content .= "<div class='clearfix'>&nbsp;</div>";
            $content .= "<div class='table-responsive main_1'>";
            $content .= "<table id='main_1' align='center' rules='all' class='table table-condensed table-bordered table-hover' sjtyle='tableu-layout: fixed; width: 100%; display: -webkit-flex; /* Safari */
  -webkit-flex-wrap: wrap; /* Safari 6.1+ */
  display: flex;   
  flex-wrap: wrap;'>";
                    ...
                    $(document).ready( function(){
                        var table = $('#main_1').DataTable({
                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                        ...
                                        var arrayFooter = $('#main_1>tfoot>tr>th');
                                        var dpageTotal = [];
                                        jQuery.each(arrayFooter, function(i,d){
                                            var id_n_index = parseFloat(i);
                                            dpageTotal[id_n_index] = 0;
                                ...
                                //new $.fn.dataTable.FixedHeader( table );
                                $('.table-responsive.main_1').floatingScroll();
                                $('.table-responsive.main_1').scroll(function() {
                                    setTimeout(function () {
                                        $('#main_1').DataTable().fixedHeader.adjust();
                                    }, 100);
                                });
                            });
                    </script>";
        ...
        $addLink = "";
        $p = New Layout("", "", MODUL_TEMPLATE_PATH . "template/abReport.html");
        $str_group = isset($_GET['gr']) ? "?gr=" . $_GET['gr'] : "";
        $content2 = "";
        $p->addTags(array(
            "jenisTr" => "",
