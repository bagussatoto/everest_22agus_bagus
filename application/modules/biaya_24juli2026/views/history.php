...
//            $content .= "to go back to index, you can click BACK button<br>";
        ...
        if (isset($conten_null)) {
            $content = "";
            // $content .= "<div id='historyList'><div class='text-center'></div>";
            cekBiru($conten_null);
            $content .= "<div id='historyList'><div class='text-center'>loading ... ... <div style='margin-left:49%;margin-top: 10px;'>$loader_indikator</div></div></div>";
            $content .= "<script>$('#historyList').load('$conten_null');</script>";
        }
...
//        arrPrint($arrLinkMenuAdd);
    ...
    case "showData":
        ...
        $content .= "<button type='button' class='btn btn-box-tool' onclick=\"viewhistoryList()\"><i class='fa fa-refresh'></i> Refresh</button>";
        $content .= "</div>";
        $content .= "</div>";
         ...
         * body isi
         * --------------------------------------*/
        $content .= "<div line='" . __LINE__ . "' class='box-body'>";
        if (sizeof($arrayHistory) > 0) {
//            $content .= "<form name='fSelect'>";
            ...
            foreach ($arrayHistoryLabels as $key => $label) {
                $content .= "<th>";
                if (isset($arrayHistorySumField) && isset($arrayHistorySumField[$key])) {
                    $content .= formatField_he_format($key, $arrayHistorySumField[$key]);
                }
                else {
                    $content .= "--";
                }
