    ...
    public function updateSourceField()
    {
        ...
        if ($refresh == 1) {
            ...
            $actionTarget = "top.BootstrapDialog.closeAll();top.BootstrapDialog.show(
                                   {
                                       title:'Followup preview',
                                       message: " . 'top.$' . "('<div></div>').load('" . MODUL_PATH . "FollowUp/followupMultiPreview/" . $this->uri->segment(4) . "/" . $this->uri->segment(5) . "/" . $this->uri->segment(6) . "/" . $this->uri->segment(7) . "/$topIDSO?rawBuilderURL=$rawBuilderURL'),
                                        size:top.BootstrapDialog.SIZE_WIDE,
                                        draggable:false,
                                        animate:false,
                                        closable:false,
            ...
            echo "<script>";
            echo "  if(top.document.getElementById('followupPreview')){";
            echo "  top.$('#followupPreview').load('" . MODUL_PATH . "FollowUp/followupMultiPreview/" . $this->uri->segment(4) . "/" . $this->uri->segment(5) . "/" . $this->uri->segment(6) . "/" . $this->uri->segment(7) . "/$topIDSO?rawBuilderURL=$rawBuilderURL');";
            echo "  }";
            echo "</script>";
        }
