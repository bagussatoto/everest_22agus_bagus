        ...
        if (sizeof($tmpHist) > 0) {
            ...
            foreach ($tmpHist as $row) {
                ...
                if ($allowFollowup) {
                    ...
                    // $targetFollowupLink = $isCancelPacking == true ? "followupCancelPackingPrePreview" : "followupMultiPrePreview";
                    ...
                    // $followupLink = "disableShopCart();top.$('#result').load('" . MODUL_PATH . "FollowUp/$targetFollowupLink/$jenisTr/" . $row->id_master . "/$nextStepNum/" . $row->sub_step_number ."/$currentStepCode". "');";
...
//matiHere();
    ...
    public function viewResume()
    {
        ...
        $pairRegistry = isset($this->configUi[$jenisMasterTrans]["pairRegistries"]) ? $this->configUi[$jenisMasterTrans]["pairRegistries"] : array("maian", "items");
