...
//                                        cekMerah("ini unit AC");
                                    ...
                                    else if($kategori_id==3 && $sub_kategori_id==5){
                                        //sparepart
...
//                                        )
                                    ...
                                    else if($kategori_id==3 && $sub_kategori_id==4 && $kapasitas_id*1>0){
                                        //non unit AC
//                                        cekKuning("ini ac non unit");
                                    }
                                    else if($kategori_id==3 && $sub_kategori_id==4 && $kapasitas_id==0){
                                        //non unit AC
