...
// matiHEre();
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main']['pihakID_coa'] = isset($tmpB[0]->coa_code) ? $tmpB[0]->coa_code : "";
            $_SESSION[$cCode]['main']['pihakName_coa'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            $_SESSION[$cCode]['main']['pihakMainID_coa'] = isset($tmpB[0]->coa_code) ? $tmpB[0]->coa_code : "";
            $_SESSION[$cCode]['main']['pihakMainName_coa'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
