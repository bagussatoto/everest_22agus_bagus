...
class _processSelectBank extends Modul_Controller
{
...
//                    }
            ...
            if (sizeof($_SESSION[$cCode]['items']) > 0) {
                ...
                $_SESSION[$cCode]['main']['pihakID'] = $_SESSION[$cCode]['items'][$id]['id'];
                $_SESSION[$cCode]['main']['pihakName'] = $_SESSION[$cCode]['items'][$id]['nama'];
            }
