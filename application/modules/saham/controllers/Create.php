            ...
            if (isset($_SESSION[$cCode]['items2_sum'])) {
                foreach ($_SESSION[$cCode]['items2_sum'] as $iSpec) {
                    $tmp = array(
                        ...
                        "nilai_target" => isset($iSpec['nilai_target']) ? $iSpec['nilai_target'] : "0",
                        "sub_nilai_target" => isset($iSpec['sub_nilai_target']) ? $iSpec['sub_nilai_target'] : "0",
                    );
                    if (sizeof($itemNumLabels) > 0) {
                        foreach ($itemNumLabels as $key => $label) {
                            $tmp[$key] = isset($iSpec[$key]) ? $iSpec[$key] : 0;
...
// matiHere("cek rekening pembantu");
            //endregion
