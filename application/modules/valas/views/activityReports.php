...
switch ($mode) {
  ...
  flex-wrap: wrap;;'>";
                ...
                $content .= "<td>" . formatField_he_format("value", $sumVal) . "</td>";
                for ($i = 1; $i <= 2; $i++) {
  ...
  flex-wrap: wrap;;'>";
                ...
                $content2 .= "<td>" . formatField_he_format("value", $sumVal) . "</td>";
                for ($i = 1; $i <= 2; $i++) {
  ...
  flex-wrap: wrap;'>";
            ...
            foreach ($names as $oID => $oName) {
                ...
                foreach ($times as $pID => $pName) {
                    foreach ($headerList as $j => $al) {
                        ...
                        $content .= "<td align='right' class='text-muted text-blue'>";
                        $content .= $histLink['open'] . formatField_he_format("harga", $val) . $histLink['close'];
                        $content .= "</td>";
                        if (!isset($totalH[$j])) {
                            $totalH[$j] = 0;
                        }
                ...
                foreach ($headerList as $j => $jName) {
                    $content .= "<td align='right' class='text-muted text-blue'>";
                    $content .= formatField_he_format("harga", $totalH[$j]);
                    $content .= "</td>";
                }
                //
                // $qty = isset($totalH[$oID]['qty']) ? number_format($totalH[$oID]['qty']) : "";
            ...
            foreach ($times as $pID => $pName) {
                ...
                foreach ($headerList as $j => $jName) {
                    $content .= "<td align='right' class='text-muted text-blue'>";
                    $content .= formatField_he_format("harga", $totalV[$pID][$j]);
                    $content .= "</td>";
                }
                // $qty = isset($totalV[$pID]['qty']) ? number_format($totalV[$pID]['qty']) : "";
                // $val = isset($totalV[$pID]['value']) ? number_format($totalV[$pID]['value'] / 1000) : "";
    ...
    case "viewSales":
        ...
        if (sizeof($tblBodies) > 0) {
            ...
            foreach ($sumValue as $kolom => $kAlias) {
                ...
                if (isset($cbFieldSumrows[$kolom])) {
                    $content .= "<th class='text-right bg-info'>" . formatField_he_format('nilai_af', $footerValue) . "</th>";
                }
                else {
            ...
            foreach ($sumValue as $kolom => $kAlias) {
                $footerValue = $sumValue[$kolom];
                if (isset($sFieldSumrows[$kolom])) {
                    $content .= "<th class='text-right bg-success'>" . formatField_he_format('nilai_af', $footerValue) . "</th>";
                }
                else {
    ...
    case "viewInvoice":
        ...
        if (sizeof($tblBodies) > 0) {
            ...
            foreach ($historyFields as $label => $attrs) {
                ...
                $fvalue = isset($sumValue[$label]) ? formatField_he_format($label, $sumValue[$label]) : "-";
                $content .= "<th align='center' $attr>";
                $content .= $fvalue;
                $content .= "</th>";
            }
