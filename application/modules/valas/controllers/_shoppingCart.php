                                ...
                                foreach ($elementConfigs[$eName]['usedFields'] as $src => $label) {
                                    ...
                                    if (strlen($fieldLabel) > 0 || $showNull == true) {
                                        if (strlen($label) > 0) {
                                            ...
                                            $defValue .= "&nbsp;</td>";
                                            $semicolonnbsp = ":&nbsp; ";
                                            $newValue_r = $fieldLabel == "" && $showNull == true && $nullValue != "" ? ($nullSrc == $label ? $nullValue : formatField_he_format($src, $fieldLabel)) : formatField_he_format($src, $fieldLabel);
                                            if ($src == 'saldo') {
                                            ...
                                            $defValue .= "<td align='left' colspan='2' class='text-bold text-uppercase'>$semicolonnbsp " . formatField_he_format($src, $fieldLabel);
                                            $defValue .= "</td>";
                                        }
                                    }
                                    $defValue .= "</tr>";
...
//                $id = $row->id;
                ...
                if (!array_key_exists($val, $_SESSION[$cCode]["items2_sum"][$iID])) {
                    $tmp = array(
