...
//        $tmpJenis = isset($this->configUi[$this->uri->segment(3)]['aliasMainTrans']) ? $this->configUi[$this->uri->segment(3)]['aliasMainTrans'] : $this->uri->segment(3);
    ...
    public function index()
    {
        ...
        if (sizeof($arrProduk) > 0) {
            ...
            $strContent .= "</th>";
            $strContent .= "<th>";
            $strContent .= formatField_he_format('nomer_top', $header['nomer_top']);
            $strContent .= "</th>";
            $strContent .= "</tr>";
            ...
            $strContent .= "</th>";
            $strContent .= "<th>";
            $strContent .= formatField_he_format('nomer', $header['nomer']);
            $strContent .= "</th>";
            $strContent .= "</tr>";
...
//            $strContent .= "<span class='clearfix'>&nbsp;</span>";
            ...
            foreach ($arrProduk as $pid => $row) {
                ...
                foreach ($qtips as $nm => $val) {
                    $strContent .= "<td>";
                    $strContent .= formatField_he_format($nm, $row[$nm]);
                    $strContent .= "</td>";
                }
                $strContent .= "</tr>";
            }
            ...
            foreach ($qtips as $nm => $val) {
                ...
                if ($nm != 'sub_total') {
                    ...
                    $strContent .= formatField_he_format($nm, $grandTotal);
                    $strContent .= "</td>";
                }
