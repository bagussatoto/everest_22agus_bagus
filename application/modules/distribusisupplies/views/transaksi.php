...
//        }
        ...
        if (sizeof($steps) > 1) {
            ...
            foreach ($steps as $tStep => $stepData) {
                ...
                $strOnprog .= "<span class='text-uppercase text-bold' style='$visibility;'>$strOnprog $trSelesai" . $stepData['label'] . "</span>  $isiBadge </a>";
                $strOnprog .= "</li>";
            }
            $strOnprog .= "</ul>";
...
//                cekKuning("::");
                ...
                foreach ($tabHistoryFields as $ky => $arrLab) {
                    ...
                    $str .= "<div class='table-responsive table_$ky'>";
