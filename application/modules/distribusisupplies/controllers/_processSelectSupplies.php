...
//                                echo "<script>top.alert('Stok $nama tidak cukup. Stok tersedia $jml_now')";
//                                echo "</script>";
//
                                echo lgShowAlertBiru("Stok $nama tidak cukup. Stok tersedia $jml_now");
                                die();
                            }
...
//                                        die();
                        ...
                        cekOrange("jml_now: " . $jml_now . " | diperlukan: " . $jmlParam . " | avail: " . $tmpJml . " | kurang: " . ($jmlParam - $jml_now));

                        if (!array_key_exists($id, $_SESSION[$cCode]['items'])) {
                            $tmp = array(
                                "handler" => $this->uri->segment(1) . "/" . $this->uri->segment(2),
                                "id" => $id,
                                "request_jml" => $jmlParam,
                                "jml" => $tmpJml,
                                "stok_avail" => $jml_now,
                                "outstanding" => (int)($jmlParam - $jml_now) < 0 ? 0 : (int)($jmlParam - $jml_now),
                                "harga" => 0,
                                "subtotal" => 0,
                            );
