            ...
            if (is_array($items) && (sizeof($items) > 0)) {
                ...
                foreach ($items as $iSpec) {
                    ...
                    if (isset($iSpec["confirm"]) && ($iSpec["confirm"] == 1)) {
                        $gudang_1 = $iSpec["gudang_asal"];
                        $gudang_2 = $iSpec["gudang_tujuan"];
                        $arrAlert = array(
                            "html" => "Apakah anda akan pindah barang dari <span style=font-size:15px;color:#000000;font-weight:bold;>$gudang_1</span> ke gudang <span style=font-size:15px;color:#000000;font-weight:bold;>$gudang_2 </span>???",
                        );
                        $arrAlertFix = array(
                            "type" => "warning",
