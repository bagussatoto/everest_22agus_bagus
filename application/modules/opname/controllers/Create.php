...
class Create extends Modul_Controller
{
    ...
    public function index()
    {
        ...
        $heWebOpname = $this->config->item('stokOpname') != null ? $this->config->item('stokOpname') : array();
...
//        );
        ...
        if($this->jenisTr == 4418 || $this->jenisTr == 4419){
            $_SESSION[$cCode]['main']['gudangID'] = 9;
            $_SESSION['login']['gudang_id'] = 9;
        }
        ...
        $downloadConfig = isset($this->configUi[$jenisTr]['downloadFields']) ? $this->configUi[$jenisTr]['downloadFields'] : array();
        $downloadFieldSupplies = isset($this->configUi[$jenisTr]['downloadFieldSupplies']) ? $this->configUi[$jenisTr]['downloadFieldSupplies'] : array();
        ...
        if($heWebOpnames["notif"] && $jenisTr != 4419 && $jenisTr != 4418 ){
        ...
        $data = array(
            ...
            "downloadConfigSupplies" => $downloadFieldSupplies,
