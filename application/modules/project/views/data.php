...
//                    $('#sub_fase').trigger('change');
        ...
        if (count($taskistProject) > 0) {
            $taskListData .= "<div class='box-header table-responsive'>
                    <div class='col-xs-12 col-md-4 no-padding'>
                <!-- <h3>AKTIVASI TASK LIST PROJECT <span id='pendingtask' class='badge bg-red'></span></h3>
                        <small><r>MASUKAN NOMOR PRE-SPK DAN TEKAN SEND</r>&nbsp;&nbsp;&nbsp;<i class='fa fa-question-circle' title='contoh: PRESPK-002-256-123-XXX'></i></small>
                        <div class='input-group'>
                            <div class='input-group-addon'>
                                <i class='fa fa-qrcode'></i>
                            </div>
                            <input id='nomer_check' onfocus=\"select()\" placeholder='masukan nomer pre spk atau scan pada barcode' class='form-control'>
                            <div onclick=\"checkActivatePreSpk()\" class='input-group-addon btn bg-green'>
            ...
            $taskListData .= "<table id='daftar_tugas' class='table dataTable compact display table-bordered table-condensed'>";
            $taskListData .= "<thead>";
            $taskListData .= "<tr>";
            $taskListData .= "<th>No</th>";

            arrPrint($tasklistProjectField);
...
//                                                        });
                                ...
                                var dft_tugas = top.$('#daftar_tugas').DataTable({
                                    serverSide: true,
                                    ajax: '" . base_url() . "master_project/MasterData/daftar_tugas/tasklist/$produkID',
                                    searching: false,
                                    paging: false,
                                    info: false,
                                    order: [8, 'desc'], //sesuaikan dengan kolom status atau kom apa saja yg perlu auto short
                                    columnDefs: [{
                                        targets: 2,
...
//                    console.log( encodeURI(this.value) );
...
//            "content"            => $strMain,
            ...
            "class_projectSudahStart" => $projectStart ? "" : "hidden",
