...
//                        arrPrint($tmpH);
//                        matiHere(__LINE__ . " || item_komposit");
                    }
                    //endregion
                }
                else {
    ...
    public function recordTermin()
    {
        ...
        switch ($tabelName) {
            case "termin":
                ...
                if($total_project < ($prev+$per_termin) ){
                    echo "<script>";
                    echo "top.swal('STOP', 'Anda tidak bisa membuat termin lebih besar dari nilai Project...!!!', 'warning');";
                    echo "</script>";
                    die();
                }
                else{
            ...
            case "garansi":
                $_SESSION[$cCode]['items5'][0] = array(
                    ...
                    "tgl_akhir_garansi"  => $_GET['tgl_akhir_garansi'],
