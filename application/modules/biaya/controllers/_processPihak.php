...
//            echo "</script>";
    ...
    public function selectValas()
    {

        $cCode = $this->cCode;
        $id = isset($_GET['val']) ? $_GET['val'] : 0;
        $mdlName = $_GET['mdl'];
        $mdlKey = $_GET['key'];
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main'][$mdlKey] = $tmpB[0]->id;
            $_SESSION[$cCode]['main'][$mdlKey . '_id'] = $tmpB[0]->id;
            $_SESSION[$cCode]['main'][$mdlKey . '_nama'] = $tmpB[0]->nama;
            $_SESSION[$cCode]['main'][$mdlKey . '_label'] = $tmpB[0]->nama;
