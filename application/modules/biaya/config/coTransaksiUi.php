...
//            "sinkron=.0",
            ...
            "stock_locker.gudang_id=gudangID", // mengambil dari $this->session->login(gudang_id) JANGAN LUPA DIGANTI YA..
            "stock_locker.jumlah>.0",
            "stock_locker.state=.active",
            "stock_locker.biaya_id is null",
        ),
        "selectorCaller" => "_selectorItem/selectItem",// bikin shopping cart background
        "selectorLabel" => "item",
//        "selectorParamFields" => array(
...
//            "jenis_label" => "activity",
            ...
            "nomer_top" => "PO number",
            "nomer" => "receipt number",
            "piutang_cabang" => "total biaya",
            "pihakWoProjekSpk" => "nomer spk",
            "pihakWoProjekName" => "tasklist",
...
//                    "label_info_pph_2" => "Tarif PPh mengikuti Data Konsumen (punya NPWP: 2%, tidak punya NPWP: 4%).",
                    ...
                    "labelFieldsReplacer" => array(
                        ...
                        "nilai_kas_cn" => "jumlah diserahkan ke penerima",
                    ),
                ),
                "73" => array(
                    "elName" => "pph21Methode",
...
//                    "mdlName" => "MdlPph21MethodPenjualanJumlahLain",
                ...
                "78" => array(
                    "elName" => "pph21Methode",
                    "mdlName" => "MdlPph21MethodPenjualanUuHpp",
                    "subElName" => "pajakOption",
                    "subMdlName" => "MdlPajakPPhOptionNik",
                    "subKey" => "pph21_uuhpp_fasilitas",
                    "editableFields" => array("harga"),
                    "editableFields2" => array("harga"),
                    "label_info_pph" => "Anda pilih: {pihakName} {pihakMainName} (Undang Undang Harmonisasi Peraturan Perpajakan), pajak yang dipakai PPH 21.",
                    "sub_label_info_pph" => "Mengganti jenis biaya akan menghapus data yang sudah diisi di formulir.",
                    "sub_label_freelancer" => "Tidak bisa didetailkan nama per-orang karena jika detail sudah masuk modul HRIS.",
                    "labelFieldsReplacer" => array(
                        "pph__tarif" => "PPh 21 (%)",
                ...
                "79" => array(
                    ...
                    "subElName" => "pajakOption",
                    "subMdlName" => "MdlPajakPPhOptionNik",
                    "subKey" => "pph21_uuhpp_nofasilitas",
                    "editableFields" => array("harga"),
                    "editableFields2" => array("harga"),
                    "label_info_pph" => "Anda pilih: {pihakName} {pihakMainName} (Undang Undang Harmonisasi Peraturan Perpajakan), pajak yang dipakai PPH 21.",
                    "sub_label_info_pph" => "Mengganti jenis biaya akan menghapus data yang sudah diisi di formulir.",
        ...
        "shortHistoryFields" => array(
            ...
            "nilai_kas_cn" => "netto",
            "type_cashback" => "jenis cashback/hadiah",
...
//            ),
        ...
        "shoppingCartCashbackAddProduct" => array(
            1 => array(
                ...
                "labelPajak" => "Barang Hadiah hanya bisa diserahkan setelah Penerima melunasi pajak hadiah sebesar <b>{nilai_pajak}</b><br>Hubungi {hak_akses_uang_pajak} untuk melakukan Penerimaan Uang Untuk Pembayaran Pajak.",
            ),
        ),
...
//                            "saldo" => "saldo",
        ...
        "connectToWarehouse" => array(
            "modul" => "biaya",
            "connectTo" => "66771",
            "connecToValidateKey" => "selectMetodcasback",
            "connecToValidateValue" => "3",//produk
            "cloneItems" => array(
                "items7" => "items2",
                "items10_sum" => "items",
            ),
            "replacerConnectTo" => array(
                ...
                "gudang_id" => "cabang2ID",
                "cabangID" => "cabang2ID",
                "cabangName" => "cabang2Name",
                "placeID" => "place2ID",
                "placeName" => "place2Name",
                "gudangID" => "gudang2ID",
                "gudangName" => "gudang2Name",
...
//                        'disabled' => "disabled",
        ...
        //----
        "shoppingCartUuHpp" => array(
            1 => array(
                "label" => "Tarif",
                "bruto_layer" => "Bruto (Rp)",
                "tarif_efektif" => "Tarif Efektif (%)",
                "pph_layer" => "Nominal PPh 21 (Rp)",
            ),
        ),
    ),
    "16677" => array(
...
//                "reference",
        ...
        "shoppingCartTypeCashbackValidators" => array(//type_cashback
            2 => array(
                "enabled" => true,
                "key" => "type_cashback",
                "validate" => array(
                    "barang" => array(// gerbang yang harus > 0 atau wajib ada nilainya
                        "valas_nonhutang_komisi_qty" => "Jumlah valas untuk cashback wajib lebih dari 0. Pastikan anda isikan dengan benar.",
                        "biaya_cashback" => "Biaya cashback wajib lebih dari 0. Pastikan anda isikan dengan benar.",
                        "valas_hpp" => "Jumlah valas untuk cashback wajib lebih dari 0. Pastikan anda isikan dengan benar.",
                    ),
                    "cash" => array(
                        "biaya_cashback" => "Biaya cashback wajib lebih dari 0. Pastikan anda isikan dengan benar.",
                        "hutang_pph_total" => "Wajib pilih PPh Ps21 atau PPh Ps23. Pastikan anda sudah pilih PPh Ps21 atau PPh Ps23.",
                    ),
                ),
            ),
            3 => array(),
...
//                    "kredit_limit" => "KREDIT LIMIT",
            ...
            "selectMetodcasback" => array(
                ...
                "label" => "Metode cashback",
                "mdlName" => "MdlCashbackMetod",
                "mdlFilter" => array("id=cashbackCheck"),
                "key" => "id",
                "labelSrc" => "nama",
                "usedFields" => array(
                    "nama" => "nama",
...
//            2 => array(
//                "label" => "otorisasi rebate penjualan (barang)",
//                "actionLabel" => "simpan",
//                "source" => "",
//                "target" => "66772",
//                "userGroup" => "o_kasir",
...
//            "trash_4=.0",
        ...
        "selectorCaller" => "_selectorItem/selectItemBarang",// bikin shopping cart background
        "selectorLabel" => "pilih barang sebagai rebate",
        "selectorParamFields" => array(
            "id" => "id",
            "nama" => "nama",
            "produk_kode" => "kode",
        ...
        "selectorProcessor" => "_prosesSelectProduk/selectBarang",
        "editHandlerMethod" => "select",
//        "pairSelectorItem" => array(
//            "enabled" => true,
//            "mdl" => "MdlLockerTransaksi",
...
//        ),
        ...
        "pihakModel" => "MdlCustomer",
        "pihakCaller" => "_selectorPihak/selectPihak",
        "pihakLabel" => "pilih konsumen penerima rebate",
        "pihakFilters" => array(//            "id=.-1",
        ),
        "pihakMainValueSrc" => array(),
        "pihakProcessor" => "_processPihak/select",
...
//            ),
        ...
        "connectToEdit" => array(
            1 => array(
                "enabled" => true,
                "connectTo" => "66772re",
                "label" => "EDIT rebate penjualan (barang)",
            ),
        ),
        "connectToReject" => array(
            1 => array(
                "enabled" => true,
                "connectTo" => "66772rrj",
                "label" => "REJECT rebate penjualan (barang)",
            ),
        ),
        "shortStepHistoryFields" => array(
            //            "no" => "no",
...
//        ),
    ...
    "66772" => array(
        ...
        "template" => "template/transaksi_rebate.html",
        //-------------------------
        "selectorModel" => "MdlTransaksiData",
        "selectorSrcModel" => "MdlTransaksiData",
        "selectorValidateSourceItem" => array(
...
//            "nomer",
        ...
        "autoLoadRebate" => array(
            "enabled" => true,
            "link" => "/_processSelectProductPpn/cashback/66772?val=3&key=cashbackCheck&name=produk",
        ),
        //-------------------------
        "pihakModel" => "MdlCustomer",
        "pihakCaller" => "_selectorPihak/selectPihak",
