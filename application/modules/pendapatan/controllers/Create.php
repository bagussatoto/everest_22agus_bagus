...
class Create extends Modul_Controller
{
    ...
    public function index()
    {
        ...
        * ---------------------------------------------------------------------*/
        ...
        //-----------------------------------------------------
//matiHere($_SESSION[$cCode]["main"]["bookingNumber"]);
        $globalTemplate = "";
        $globalTemplate .= "<span>";
...
//            unset($_SESSION[$cCode]["main"]["bookingNumber"]);
            if (!isset($_SESSION[$cCode]["main"]["bookingNumber"])) {
                $msg = "Data gagal dikirim ke server, Silahkan refresh halaman ini sebelum melanjutkan. code: " . __LINE__;
                mati_disini($msg);
            }
