...
//            $strOnprogFooter = "<a class='btn btn-default' href='" . base_url() . $this->uri->segment(1) . "/viewIncomplete/" . $jenisTr . "'><span class='glyphicon glyphicon-time'></span> complete list ...</a>";
        ...
        $p->addTags(
            array(
                ...
                //---------------
                "pihak_projek_tasklist_label" => isset($pihakProjekTaskListLabel) ? $pihakProjekTaskListLabel : "",
                "pihak_projek_tasklist_caller" => isset($pihakProjekTaskListCaller) ? $pihakProjekTaskListCaller : "",
                "pihak_projek_tasklist_caller_delete" => isset($pihakProjekTaskListCallerDelete) ? $pihakProjekTaskListCallerDelete : "",
...
//            echo "</tr>";
            ...
            foreach ($items as $iSpec) {
                ...
                $biy_id = $iSpec['biaya_id'];
                $no++;
                $fieldVal = "";
                echo "<tr line=" . __LINE__ . " style='font-size: 18px;'>";
                echo "<td align='right' class='text-bold text-uppercase bg-success'>";
                echo $no;
                echo ".</td>";
                foreach ($itemLabels as $key => $label) {
                    echo "<td class='text-bold text-uppercase bg-success'>";
                    if (substr($key, 0, 1) == "*") {
                ...
                echo "</tr>";
                if (isset($items2[$biy_id]) && sizeof($items2[$biy_id]) > 0) {

                    echo "<tr>";
                    echo "<td colspan='2'>";
//                    echo "<div class='table-responsive'>";
                    echo "<table class='table dataTable compact table-bordered table-condenseds'>";
                    ...
                    echo "</tr>";
                    $no2 = 0;
                    foreach ($items2[$biy_id] as $iSpec) {
                        $no2++;
