...
//                            cekHere("[$pihakID] :: $source_jml :: $target_jml ::");
                            if ($source_jml == $target_jml) {
//                                $tmp["disabled"] = $shoppingCartItemMode["mode"];
                                $tmp["disabled"] = NULL;
...
//        );
    ...
    public function modalInfoIntransit($produk_id = "")
    {
        ...
        if($pakai_ini == 1){
            ...
            $gudangID = $_GET["gudang_id"];
            $cabangID = $_GET["cabang_id"];
...
//        $st->addFilter("$tbl_001.gudang_id in ('" . implode("','", $allGudangDefault) . "')");
            ...
            $produk_id = isset($_GET['id']) ? $_GET['id'] : "";
            if ($produk_id > 0) {
