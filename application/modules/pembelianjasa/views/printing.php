...
//arrPrintPink($itemLabels);
    ...
    case "viewReceipt_mod":
        ...
        $pihakProfile = "<div class='box box-danger box-solid' style='min-height: 150px;'>";
        ...
        if ($shippingMethod == 1) {
            ...
            $deliveryDetails = "<div class='box box-danger box-solid' style='min-height: 150px;'>";
        ...
        if (strlen($strSupplierInv) > 0) {
            $paymentMethod = "<div style='border: 1px solid #000f79;padding: 10px 5px;margin-top: 5px;margin-bottom: 10px;'>";
