...
//        $_SESSION[$cCode]['tableIn_master_values']['partial'] = 1;
        ...
        fillValues_he_value_builder($this->jenisTr, $fromStep, $intoStep, $this->configCoreJenis, $this->configUiJenis, $this->configValuesJenis, $this->ppnFactor);
...
//        echo "</script>";
        ...
        $this->load->helper("he_value_builder");
        fillValues_he_value_builder($jenisTr, $fromStep, $intoStep, $this->configCoreJenis, $this->configUiJenis, $this->configValuesJenis, $this->ppnFactor);
