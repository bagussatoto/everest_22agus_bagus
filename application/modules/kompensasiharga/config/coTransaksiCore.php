...
//                "subtotal" => "qty*diskon_supplier_nilai",//diskon_supplier_nilai->ini sudah subtotal
                ...
                //------
                "produk_rel_harga_dpp" => "((diskon_supplier_nilai*100)/(100+ppnFactor))*ppnMethode__key",
                "produk_rel_harga_dpp_pengganti" => "((11/12)*produk_rel_harga_dpp)*ppnMethode__key",
                "produk_rel_harga_ppn" => "((12/100)*produk_rel_harga_dpp_pengganti)*ppnMethode__key",
            ),
            "master_dependent" => array(
//                "pph23Methode" => array(
//                    // dipotong pph23
...
//                        "nilai_cash" => "((100-pph23Methode__tarif)/100)*diskon_supplier_nilai",// pph23 nya masih ditembak langsung disini, perlu diganti
                        ...
                        "nilai_ppn_belum_faktur" => ".0",
                        "nilai_ppn_sudah_faktur" => ".0",
                    ),
                    // credit note
                    "2" => array(
                        "pph_pembagi" => ".100",
...
//                        "nilai_persediaan" => "cek_pph*produk_rel_harga_persediaan",
                        "nilai_piutang" => "diskon_supplier_nilai",
                        "nilai_credit_note" => ".0",
                        "nilai_voucher" => ".0",
                        "nilai_cash" => ".0",
...
//                        "grandtotal_netto" => "nilai_persediaan",
                        "nilai_hutang_pph23" => ".0",
                        "nilai_ppn_belum_faktur" => "nilai_ppn*ppn_pending",
                        "nilai_ppn_sudah_faktur" => "ppn_final-nilai_ppn_belum_faktur",

                        "nilai_persediaan" => "diskon_supplier_nilai-nilai_pph23-nilai_ppn",
                        "grandtotal_netto" => "nilai_persediaan",
                    ),
...
//                        "nilai_hutang_pph23" => "nilai_pph23",
                ...
                "ppnMethode" => array(
                    "pm" => array(
                        "nilai_dpp" => "((diskon_supplier_nilai*100)/(100+ppnFactor))",
                        "nilai_dpp_pengganti" => "(11/12)*nilai_dpp",
                        "nilai_ppn" => "(12/100)*nilai_dpp_pengganti",
                        "ppnMethode__key" => ".1",
                        "dpp_final" => "nilai_dpp",
                        "dpp_pengganti" => "nilai_dpp_pengganti",
                        "ppn_final" => "nilai_ppn",
                    ),
                    "non_pm" => array(
                        "nilai_dpp" => ".0",
                        "nilai_dpp_pengganti" => ".0",
                        "nilai_ppn" => ".0",
                        "ppnMethode__key" => ".0",
                        "dpp_final" => ".0",
                        "dpp_pengganti" => ".0",
                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "loop" => array(
                            ...
                            "1010040050" => "nilai_ppn_belum_faktur",// ppn masukan belum faktur
                            "1010040060" => "nilai_ppn_sudah_faktur",// ppn masukan sudah faktur
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "jml" => "logam_mulia__qty",
                    ...
                    // rekening ppn masukan belum faktur
                    array(
                        "comName" => "RekeningPembantuSupplier",
                        "loop" => array(
                            "1010040050" => "nilai_ppn_belum_faktur",// ppn masukan belum faktur
                    ...
                    // rekening ppn masukan sudah faktur
                    array(
                        "comName" => "RekeningPembantuSupplier",
                        "loop" => array(
                            "1010040060" => "nilai_ppn_sudah_faktur",// ppn masukan sudah faktur
...
//                            "sisa" => "new_sisa",
                            ...
                            "tagihan" => "nilai_ppn_sudah_faktur",
                            "sisa" => "nilai_ppn_sudah_faktur",
                            "extern_label2" => "eFaktur",
                            "ppn" => "nilai_ppn_sudah_faktur",
                            "ppn_sisa" => "nilai_ppn_sudah_faktur",
                            "ppn_sudah_faktur" => "nilai_ppn_sudah_faktur",
                            "extern_nilai2" => "produk_rel_harga_dpp",
...
//                "subtotal" => "qty*diskon_supplier_nilai",//diskon_supplier_nilai->ini sudah subtotal
                ...
                "produk_rel_harga_after_pph" => "harga-nilai_items_pph23",
                //------
                "produk_rel_harga_dpp" => "diskon_supplier_nilai",
                "produk_rel_harga_dpp_pengganti" => "((11/12)*produk_rel_harga_dpp)*ppnMethode__key",
                "produk_rel_harga_ppn" => "((12/100)*produk_rel_harga_dpp_pengganti)*ppnMethode__key",
            ),
            "master_dependent" => array(
...
//                        "nilai_hutang_pph23" => "nilai_pph23",
                ...
                "ppnMethode" => array(
                    "pm" => array(
                        "nilai_dpp" => "diskon_supplier_nilai",
                        "nilai_dpp_pengganti" => "(11/12)*nilai_dpp",
                        "nilai_ppn" => "(12/100)*nilai_dpp_pengganti",
                        "ppnMethode__key" => ".1",
                        "dpp_final" => "nilai_dpp",
                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "loop" => array(
                            ...
                            "1010040050" => "nilai_ppn_belum_faktur",// ppn masukan belum faktur
                            "1010040060" => "nilai_ppn_sudah_faktur",// ppn masukan sudah faktur
//                            "7010170" => "nilai_ppn",// pedapatan lain-lain
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                "pph23Methode__tarif" => "pph23MethodeTarif__tarif",
            ...
            "detail" => array(
                ...
                "subtotal" => "qty*harga",
                "diskon_supplier_nilai" => "harga",//nilai perunit karena akan dikali qty/jml jadi dihitung lagi
                "diskon_supplier_nilai_netto" => "harga-diskon_supplier_nilai_disc",
            ...
            "master_dependent" => array(
                "revisi_ppn" => array(
                    1 => array(
                        "diskon_supplier_nilai_total" => "diskon_supplier_nilai_revisi",
                    ),
                    0 => array(
...
//                        "nilai_credit_note" => "((100-pph23Methode__tarif)/100)*diskon_supplier_nilai",// pph23 nya masih ditembak langsung disini, perlu diganti
                    ...
                    "4" => array(
                        "pph_pembagi" => ".100",
                        "cek_pph" => "((pph_pembagi-pph23MethodeBarang__tarif)/pph_pembagi)",
                        "nilai_piutang" => "diskon_supplier_nilai_total",
                        "nilai_credit_note" => ".0",
                        "nilai_voucher" => ".0",
                        "nilai_logam_mulia" => ".0",
                        "nilai_pph23" => "(((pph23MethodeBarang__tarif)/pph_pembagi)*defaultDPP_PPh)",
                        "nilai_cash" => "(nilai_pph23*(-1))*pph23MethodeBarang__kode",
                        "nilai_hutang_pph23" => ".0",
                        "nilai_ppn_belum_faktur" => "nilai_ppn*ppn_pending",
                        "nilai_ppn_sudah_faktur" => "ppn_final-nilai_ppn_belum_faktur",

                        "nilai_persediaan" => "diskon_supplier_nilai_total",
                        "grandtotal_netto" => "nilai_dpp+nilai_ppn",
                        //pph23 ditanggung ditanggung pemberi hadiah -> +laba lain-lain
                        //pph23 ditanggung ditanggung penerima hadiah -> -kas
                        "laba_lain_lain" => "nilai_ppn+nilai_pph23+nilai_cash",
                    ),
                    // logam mulia dan permata
                    "5" => array(
//                        "pph_pembagi" => ".100",
...
//                        "laba_lain_lain" => ".0",
                        ...
                        "nilai_credit_note" => ".0",
                        "nilai_voucher" => ".0",
                        "nilai_logam_mulia" => "diskon_supplier_nilai",
//                        "nilai_pph23" => "(((pph23MethodeBarang__tarif)/pph_pembagi)*diskon_supplier_nilai)",
                        "nilai_pph23" => "(((pph23MethodeBarang__tarif)/pph_pembagi)*defaultDPP_PPh)",
                        "nilai_cash" => "(nilai_pph23*(-1))*pph23MethodeBarang__kode",
                        "nilai_hutang_pph23" => ".0",
                        "nilai_ppn_belum_faktur" => "nilai_ppn*ppn_pending",
                ...
                "ppnMethode" => array(
                    "pm" => array(
//                        "nilai_dpp" => "diskon_supplier_nilai",
                        "nilai_dpp" => "diskon_supplier_nilai_total",
                        "nilai_dpp_pengganti" => "(11/12)*nilai_dpp",
                        "nilai_ppn" => "(12/100)*nilai_dpp_pengganti",
                        "ppnMethode__key" => ".1",
                        "dpp_final" => "nilai_dpp",
...
//                            "1010030030" => "sub_produk_rel_harga",//persediaan produk
                            /**
                             * README 7/17/2027 cek widi jas
                             * gerbang [sub_diskon_supplier_nilai_netto]
                             * dimatikan karena gerbang tidak terdaftar
                             * menyebakan pembantu produk tidak dicatat. dikembalikan ke [sub_produk_rel_harga_persediaan]
                             */

                            "1010030030" => "sub_produk_rel_harga_persediaan",//persediaan produk
//                            "1010030030" => "sub_diskon_supplier_nilai_netto",//README
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "id",
