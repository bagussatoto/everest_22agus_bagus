                    ...
                    if ((sizeof($tmpReg_result) > 0) && (isset($tmpReg_result[$row->id]))) {
                        foreach ($tmpReg_result[$row->id] as $param => $eReg) {
                            if ($param == "main") {
                                ...
                                if ($param == "items") {
                                    foreach ($eReg as $iiReg) {
                                        $row->nomer_referensi = $iiReg["nama"];
                                    }
                                }
                            }
                        }
                        ...
                        if (is_array($hisKey)) {
                            ...
                            if ($hisKey == "nomer") {
                                ...
                                if (isset($fLabel['transaksi_jenis2'][$row->transaksi_jenis2])) {
                                    ...
                                    if ($hisKey == "nomer_referensi") {
                                        $colValue = isset($row->nomer_referensi) ? formatField_he_format("nomer", $row->nomer_referensi) : "";
                                    }
                                    else {
                                        $colValue = "-";
                                    }
