...
//                "description_main_followup" => "Vendor INV",
        ...
        "receiptDetailFields" => array(
            ...
            3 => array(
                ...
                "keterangan" => "part",
                "produk_ord_jml" => "Qty",
//                "qty_reguler" => "Gudang Reguler",
//                "qty_daikin" => "Gudang Daikin",
//                "qty_alokasi" => "Total Terima",
//                "qty_sisa_alokasi" => "Sisa",
                // "satuan" => "UOM",
            ),
            4 => array(
                "produk_kode" => "sku",
...
//        ),
        ...
        "customHistoriExcel" => array(
            ...
            "qty" => array(
                "label" => "QTY Free Product",
                "type" => "integer",
            ),
            "produk_rel_harga" => array(
                "label" => "Harga Free Product",
                "type" => "integer",
            ),
            "sub_produk_rel_harga" => array(
                "label" => "Sub Total Free Product",
                "type" => "integer",
            ),
            //--------------------------------------
            // "sub_diskon_7_nilai"      => array(
            //     "label" => "freeproduk",
            //     "type"  => "integer",
            // ),
            // "harga_pricelist"      => array(
            //     "label" => "Amount",
            //     "type"  => "integer",
            // ),
            "sub_harga" => array(
    ...
    "967" => array(
        "receiptTemplate" => array(
            //            1 => "template/466r_mod_1.html",
            //            2 => "template/466r_mod_2.html",
            //            3 => "template/466r_mod.html",
            1 => "template/466r_mod.html",
            2 => "template/466r_mod.html",
            3 => "template/466r_mod.html",
