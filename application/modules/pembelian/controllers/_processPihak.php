...
//        mati_disini("==========");
        ...
        if (isset($_GET["noreload"]) && ($_GET["noreload"] == 1)) {
            ...
            /* --------------------------------------------------
                 ...
                 * --------------------------------------------------*/
            echo "<script>";
            echo "\ntop.$('#biItems').load('" . base_url() . "$calcStockPath/" . $this->jenisTr . "/" . $this->modul . "?selID=$id')";
            echo " \ntop.$('#shopping_cart').load('" . MODUL_PATH . "_shoppingCart/viewCart/" . $this->jenisTr . "?selID=$id');";
            echo "</script>";
        }
    }
...
//        mati_disini("$selectColumn :: $tmpPihakName");
    ...
    public function remove()
    {
        ...
        echo "\n\n<script>\n";
        echo "\ntop.$('#biItems').load('" . base_url() . "$calcStockPath/" . $this->jenisTr . "/" . $this->modul . "?selID=$id')";
        // echo "\ntop.$('#biItems').load('" . base_url() . "Bi/viewProdukSales/" . $this->jenisTr . "/" . $this->modul . "?selID=$id')";
        echo "\ntop.$('#shopping_cart').load('" . base_url() . $this->modul . "/_shoppingCart/viewCart/" . $this->jenisTr . "?selID=$id')";
        // echo alert("hhh");
        // echo "  }";
        echo "\n</script>";
    }
