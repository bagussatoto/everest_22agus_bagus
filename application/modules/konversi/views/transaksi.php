...
//            $strOnprogFooter = "<a class='btn btn-default' href='" . base_url() . $this->uri->segment(1) . "/viewIncomplete/" . $jenisTr . "'><span class='glyphicon glyphicon-time'></span> complete list ...</a>";
        ...
        $p->addTags(
            array(
                ...
                "sub_keterangan" => isset($sub_keterangan) ? $sub_keterangan : "",
...
//                                            echo ">";
                ...
                if ($pairedItemPotongEnabled == true) {
                    ...
                    $c_colspan = ($c_itemLabels - $c_pairedItemField + 1);
                    echo "<td colspan='" . $c_colspan . "'>";
//cekHere("$pairedItemRecorder");
//                    echo "<input type='text' class='form-control text-left' style='margin-bottom:5px;'
//                        placeholder='pilih barang hasil konversi'
//                        onclick='this.select()'
//                    >";
...
//                                >";
//                    asort($konversiItems);
//                    foreach ($konversiItems as $piID => $piName) {
//                        if ($piID != $iSpec['id']) {
//                            $selectedState = (isset($pairedKonversiItems[$iID]) && ($piID == $pairedKonversiItems[$iID]['id'])) ? "selected" : "";
//                            $selItemsKodes = isset($konversiItemsKode[$piID]) ? $konversiItemsKode[$piID] : "-";
//                            $selItemsFolders = isset($konversiItemsFolder[$piID]) ? $konversiItemsFolder[$piID] : "-";
//                            $selItemsKeterangans = isset($konversiItemsKeterangan[$piID]) ? $konversiItemsKeterangan[$piID] : "-";
//                            $selItemsBarcodes = isset($konversiItemsBarcode[$piID]) ? $konversiItemsBarcode[$piID] : "-";
//                            $selItemsKategori = isset($konversiItemsKategori[$piID]) ? $konversiItemsKategori[$piID] : "-";
//                            $selItemsSubKategori = isset($konversiItemsSubKategori[$piID]) ? $konversiItemsSubKategori[$piID] : "-";
//                            $piName_f = htmlspecialchars($piName);
//                            echo "<option data-subtext='$selItemsKodes' data-tokens='$piID $selItemsFolders $selItemsKeterangans $selItemsBarcodes $selItemsKategori $selItemsSubKategori'
//                                value='$piID' $selectedState>$piName </option>";
//                        }
//                    }
//                    echo "</select>";
                                    ...
                                    foreach ($itemLabels2 as $key => $label) {
                                        ...
                                        switch ($listMode[$key]) {
                                            case "input":
                                                ...
                                                $sid = $iSpec['id'];
                                                $linkSubEditable = $pairedItemEditTarget . "?id=$iID&sid=$sid&$key=";
                                                $thisValue = "'+removeCommas(this.value)";
                                                echo "<input type='text'  min='$moq' autocomplete='off' " . $readOnly[$key] . " 
                                                keyid=$keyID noid=$noID id_jml=$iID id=$colID  
...
//                }
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                if (isset($deleteSpec['targetUrl']) != "" && $deleteSpec['targetUrl'] != "") {
                    echo "<button type='button' class='btn btn-danger margin' style='border:1px #ff7700 solid;ccolor:#ff7700;' 
                    $disabled_button onclick=\"if(confirm('" . $deleteSpec['warning'] . " " . $new_beforeStepLabels . "')==1){document.getElementById('f1').action='" . $deleteSpec['targetUrl'] . "';document.getElementById('f1').submit();}\"><span class='fa fa-undo'></span> " . $deleteSpec['label'] . "</button>";
                }
                else {
                    echo "<button type='button' disabled class='btn btn-danger margin' style='border:1px #ff7700 solid;ccolor:#ff7700;' ><span class='fa fa-undo'></span> " . $deleteSpec['label'] . "</button>";
                }
                ...
                if ((isset($extBtns) && sizeof($extBtns) > 0) || (isset($payBtns) && sizeof($payBtns) > 0)) {
                    ...
                    if (isset($rejectionSpec['targetUrl']) != "" && $rejectionSpec['targetUrl'] != "") {
                        echo "<button type='button' class='btn btn-danger margin' style='border:1px #dd3300 solid;ccolor:#dd3300;' 
                        $disabled_button onclick=\"if(confirm('" . $rejectionSpec['warning'] . " " . $new_beforeStepLabels . "')==1){
                        document.getElementById('f1').action='" . $rejectionSpec['targetUrl'] . "';this.disabled=true;
                        document.getElementById('f1').submit();top.open_holdon();}\"><span class='glyphicon glyphicon-ban-circle'></span> " . $rejectionSpec['label'] . "</button>&nbsp;&nbsp;&nbsp;";
//                        echo "&nbsp;&nbsp;";
                    }
                    ...
                    if (isset($rejectionSpecAll['targetUrl']) != "" && $rejectionSpecAll['targetUrl'] != "") {
                        echo "<button type='button' class='btn btn-danger' style='border:1px #000000 solid;color:#ffffff;background-color:#000000;' 
                        $disabled_button onclick=\"if(confirm('" . $rejectionSpecAll['warning'] . "')==1){
                        document.getElementById('f1').action='" . $rejectionSpecAll['targetUrl'] . "';this.disabled=true;
                        document.getElementById('f1').submit();top.open_holdon();}\"><span class='glyphicon glyphicon-alert'></span>&nbsp;&nbsp; " . $rejectionSpecAll['label'] . "</button>&nbsp;&nbsp;&nbsp;";
                    }
                    else {
                    ...
                    // -------------------------------------------------------------
                    if (isset($approvalSpec['targetUrl']) != "" && $approvalSpec['targetUrl'] != "") {
                        echo "<button button type='button' class='btn btn-success margin' style='border:1px #008800 solid;color:#ffffff;' $disabled_button onclick=\"if(confirm('" . $approvalSpec['warning'] . "')==1){this.disabled=true;document.getElementById('f1').action='" . $approvalSpec['targetUrl'] . "';document.getElementById('f1').submit();top.open_holdon();}\"><span class='glyphicon glyphicon-ok'></span> " . $approvalSpec['label'] . "</button>";
                    }
                    else {
                        echo "&nbsp;";
                    }
                ...
                if (isset($itemLabels) && (sizeof($itemLabels) > 1)) {
                    ...
                    foreach ($detail_items as $iSpec) {
                        ...
                        if ($pairedItemBreakdownEnabled == true) {
                            ...
                            $c_pairedItemField = sizeof($pairedItemField);
                            $c_colspan = ($c_itemLabels - $c_pairedItemField + 1);
                            $contentStr .= "<td colspan='" . $c_colspan . "'>";
                            //----------------
                            ...
                            if (isset($items4) && (sizeof($items4) > 0)) {
                                ...
                                if (isset($itemLabels2)) {
                                    if (sizeof($itemLabels2) && (is_array($itemLabels2))) {
                                        $contentStr .= "<tr class='bg-grey-2 text-uppercase'>";
                                        $contentStr .= "<th style='width:1%;' class='text-muted text-center'>";
                                        $contentStr .= "NO";
                                        $contentStr .= "</th>";
                                        foreach ($itemLabels2 as $key => $label) {
...
//arrPrintKuning($iSpec);
                                        ...
                                        $contentStr .= "<td style='vertical-align:middle; width:1%' class='text-center'>";
                                        $contentStr .= $no;
                                        $contentStr .= "</td>";
                                        ...
                                        foreach ($itemLabels2 as $key => $label) {
                                            ...
                                            switch ($listMode[$key]) {
                                                case "input":
                                                    ...
                                                    $linkSubEditable = $pairedItemEditTarget . "?id=$iID&sid=$sid&$key=";
                                                    $thisValue = "'+removeCommas(this.value)";
                                                    $contentStr .= "<input type='text'  min='$moq' autocomplete='off' " . $readOnly[$key] . " 
                                                keyid=$keyID noid=$noID id_jml=$iID id=$colID  
                                                class='form-control text-right' style='color:$color;'
                                                value='" . niceDecimal($fieldVal) . "'
                                                onclick='this.select()'";
                                                    $contentStr .= " onblur=\"document.getElementById('result').src='" . $linkSubEditable . "$thisValue\"";
                                                    $contentStr .= ">";

//                                                $contentStr .= "<span keyid=$keyID noid=$noID id=$colID class='form-control text-right' style='color:$color;background:#f0f0f0;'>" . niceDecimal($fieldVal) . "$add_data_val</span>";
                                                ...
                                                case "text":
                                                    ...
                                                    if (is_numeric($fieldVal)) {
                                                        ...
                                                        if (strlen($fieldVal) > 10) {
                                                            $contentStr .= "<span keyid=$keyID noid=$noID id=$colID class='' style='color:$color;border:0px;'>" . formatField($key, $fieldVal) . "$add_data_val</span>";
                                                        }
                                                        else {
                                                            $contentStr .= "<span keyid=$keyID noid=$noID id=$colID class='form-control' style='color:$color;border:0px;'>" . formatField($key, $fieldVal) . "$add_data_val</span>";
                                                        }
                                                    }
                                                    break;
                                            }
                                    ...
                                    $colspan2 = count($itemLabels2);
                                    $contentStr .= "<tr id='tr_" . $iSpec['id'] . "' bgcolor=$bgColor>";
                                    $contentStr .= "<td colspan='$colspan2' style='vertical-align:middle;' class='text-uppercase text-right'>total</td>";
                                    $contentStr .= "<td style='vertical-align:middle;' class='text-right'>" . number_format($subtotal, "0", ".", ",") . "</td>";
                                    $contentStr .= "</tr id='tr_" . $iSpec['id'] . "' bgcolor=$bgColor>";
                                }
                            }
                            $contentStr .= "</table class='table table-condensed no-padding table-bordered no-margin'>";
                            ...
                            if (sizeof($pairedItemField) > 0) {
                                foreach ($pairedItemField as $key => $label) {
                                    ...
                                    switch ($listMode[$key]) {
                                        case "input":
                                            $contentStr .= "<input type='text' class='form-control text-right' value='" . $pairedItems2Qty . "' min='0' autocomplete='off'
                                    onblur=\"document.getElementById('result').src='" . $pairedItemRecorder . "?newQty='+removeCommas(this.value)+'&iid=$iID&val=$pairedItems2ID';\"
                                    onmouseout=\"document.getElementById('result').src='" . $pairedItemRecorder . "?newQty='+removeCommas(this.value)+'&iid=$iID&val=$pairedItems2ID';\"
                                    >";
                                            break;
                                        case "text":
                                            if (is_numeric($fieldVal)) {
                                                $contentStr .= "<span class='form-control text-right' style='color:$color;background:#f0f0f0;'>" . niceDecimal($fieldVal) . "</span>";
                                            }
                                            else {
                                                $contentStr .= "<span class='form-control text-left' style='color:$color;border:0px;'>" . str_replace(" ", "&nbsp;", $fieldVal) . "</span>";
                                            }
                                            break;
                                    }
                                    $contentStr .= "</td>";
...
//                                                $linkSubEditable = $iSpec['editTarget'] . "&$key=";
//                                                $thisValue = "'+removeCommas(this.value)";
//                                                $contentStr .= "<input type='text'  min='$moq' autocomplete='off' " . $readOnly[$key] . " keyid=$keyID noid=$noID id_jml=$iID id=$colID  class='form-control text-right' style='color:$color;'
//                                                value='" . niceDecimal($fieldVal) . "'
//                                                onclick='this.select()'";
////                                            $baseInputName = isset($unionSelectors['base']) ? "document.getElementById('" . $unionSelectors['base'] . "_" . $no . "')" : "this";
////                                            $pemicuGerbangAsli = "onblur=\"if(this.value!=this.defaultValue){hiliteDiv(this);document.getElementById('result').src='" . $iSpec['editTarget'] . "'$qtyParam+'$queryParams';} \" $keyupData";
...
////                                            if (isset($unionSelectors['base'])) {
////                                                if ($unionSelectors['base'] == $key) {//==jadi acuan kiriman
////                                                    $contentStr .= str_replace("this", $baseInputName, $pemicuGerbang);
////                                                }
////                                                else {
////                                                    if (in_array($key, $unionSelectors['members'])) {//==jadi member union, tidak memicu perubahan gerbang
////                                                        $contentStr .= $pemicuGerbangUnion;
////                                                    }
////                                                    else {//==biasa aja, memicu perubahan gerbang
////                                                        $contentStr .= $pemicuGerbangAsli;
////                                                    }
////                                                }
////                                            }
////                                            else {
...
//                                                $contentStr .= " onblur=\"document.getElementById('result').src='" . $linkSubEditable . "$thisValue\"";
////                                            if (isset($keyupAction) && $keyupAction == true) {
////                                                $contentStr .= "onkeyup=\"document.getElementById('result').src='" . $iSpec['editTarget'] . "'$qtyParam+'$queryParams';if(parseFloat(removeCommas(this.value))>0){ this.value=addCommas(this.value) }else{ this.value=0 }\"";
////                                            }
////                                            else {
////                                                $contentStr .= "onkeyup=\"delay( function(){ $('#shopping_cart').trigger('change') }, 400, this );if(parseFloat(removeCommas(this.value))>0){ this.value=addCommas(this.value) }else{ this.value=0 }\"";
////                                            }
//                                                $contentStr .= ">";
//                                                break;
//                                            case "text":
...
//                                    if (!$avoidRemove) {
//                                        $contentStr .= "<td width='1%'>";
//                                        $contentStr .= "<a class='text-red btn' title='remove this item' data-toggle='tooltip' data-placement='left'
//                                    onclick=\"document.getElementById('result').src='" . $iSpec['removeTarget'] . "';\"><span class='glyphicon glyphicon-remove'></span></a>";
//                                        $contentStr .= "</td>";
//                                    }
                                        //endregion
