...
class History extends Modul_Controller
{
    ...
    public function viewHistory()
    {
        ...
        // Jika ada filter tanggal aktif dari user, matikan limitasi
...
//                            $kolomValues = isset($row->$fName) ? formatField_he_format($fName, $row->$fName) : "-";
                    ...
                    if($fName == "rencana"){
                        $linkRencana = MODUL_PATH . "Printing/viewRencanaKerja/$jenis_master/$project_id/$transaksi_id";
                        $tmp['rencana'] .= "<div class='input-group'>";
                        $tmp['rencana'] .= "<a class='btn btn-primary btn-block' title='' data-toggle='tooltip' href='javascript:void(0)' 
                                                onclick =\"top.popBig('$linkRencana')\"><span class='glyphicon glyphicon-ok'></span>lihat rencana anggaran</a>";
                        $tmp['rencana'] .= "</div class='input-group'>";
                    }
                }
