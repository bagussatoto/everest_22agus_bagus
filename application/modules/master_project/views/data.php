...
//                $persen = 99;
                ...
                $total_komposisi_rp += $row->total_komposisi*$row->harga;
                $total_digunakan += $row->total_digunakan;
                $total_digunakan_rp += $row->total_digunakan*$row->harga;
                $total_return += $row->total_return;
                $total_return_rp += $row->total_return*$row->harga;
                $total_sisa += $row->sisa;
                $total_sisa_rp += $sisaRp;
                $total_persen += $persen;
                $no++;
            }
            ...
            if($produkID=="qc"){
                ...
                $columnDefs = "
                    ...
                    },
                    {
                        ...
                        render: function ( data, type, row, meta ) {
                            if(!data) return '-';
                            return \"<div class='td-ellipsis' title='\"+data+\"'><b>\" + data + \"</b></div>\";
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function ( data, type, row, meta ) {
                            ...
                            return \"<div class='td-ellipsis' title='\"+fullText+\"'><b>\"+ data +\"</b></div><small><i class='fa fa-dropbox text-navi'></i> <span class='text-bold text-uppercase text-navi td-ellipsis' title='\"+row[7]+\"' style='font-size:11px;'>\"+ row[7] +\"</span></small>\";
                        }
                    },
                    {
                        targets: 8, // pelaksana
                        ...
                        render: function ( data, type, row, meta ) {
                            if(!data) return '-';
                            return \"<div class='td-ellipsis' title='\"+data+\"'><i class='fa fa-user-circle text-blue'></i> <span class='text-bold text-uppercase text-blue'>\"+ data +\"</span></div>\";
                            }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function ( data, type, row, meta ) {
                            ...
                            var btn  = \"\"
                            btn += \"<div class='progress \"+progg_stat+\"' style='margin-bottom:0px;'>\"
                            ...
                            if(progg==100 && data==2){
                                btn += \"<div class='text-red text-bold text-center text-uppercase' style='margin-top:5px;'> menunggu pengecekan<br>(QC) </div>\"
                            }
