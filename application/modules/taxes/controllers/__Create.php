...
//                $this->debugArrPrint($selectorProcessor);
        $mb = New MobileDetect();
        $isMob = $mb->isMobile();
        if ($isMob) {
        ...
        // $this->debugArrPrint($progressFields);
        //endregion
        ...
        if (isset($this->configUi[$jenisTr]['extTool'])) {
            ...
            //$this->debugArrPrint($rawParam);die();
    ...
    public function preview()
    {
        ...
        $items3_sum = array();
        $itemsSrc = array();
        //        $this->debugArrPrint($_SESSION[$cCode]['itemSrc']);
        //        matiHEre();
        ...
        //        $this->debugArrPrint($mainAddValues);
        ...
        //$this->debugArrPrint($addRowLabels);
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (sizeof($iterator) > 0) {
                ...
                if (isset($_SESSION[$cCode]["revert"]["preProc"]["replacer"])) {
                    ...
                    //$this->debugArrPrint($tempCalculate);
...
//            cekOrange("lolos validator @" . __LINE__ . " " . __METHOD__);
            ...
            $this->debugArrPrint($counterForNumber);
            ...
            //$this->debugArrPrint($configCustomParams);
            ...
            if (isset($_SESSION[$cCode]['tableIn_master']) && sizeof($_SESSION[$cCode]['tableIn_master']) > 0) {
                ...
                // $this->debugArrPrint($_SESSION[$cCode]['tableIn_master']);
            ...
            if (isset($_SESSION[$cCode]['tableIn_master_values']) && sizeof($_SESSION[$cCode]['tableIn_master_values']) > 0) {
                ...
                if (sizeof($inserMainValues) > 0) {
                    ...
                    $this->updateTransaksiIndexing($insertID, 'indexing_main_values', $arrBlob);
                }
            ...
            if (isset($_SESSION[$cCode]['tableIn_detail']) && sizeof($_SESSION[$cCode]['tableIn_detail']) > 0) {
                ...
                if (sizeof($insertIDs) == 0) {
                    ...
                    foreach ($indexing_details as $k => $arrID) {
                        ...
                        $this->updateTransaksiIndexing($k, 'indexing_details', $arrBlob);
            ...
            if (isset($_SESSION[$cCode]['tableIn_detail_values']) && sizeof($_SESSION[$cCode]['tableIn_detail_values']) > 0) {
                ...
                if (sizeof($insertIDs) > 0) {
                    ...
                    $this->updateTransaksiIndexing($insertID, 'indexing_detail_values', $arrBlob);
                }
            ...
            ////                    $this->debugArrPrint($tmpOutParams[$cCtr]);
            //                    if (sizeof($tmpOutParams[$cCtr]) > 0) {
            //                        $tobeExecuted = true;
            //                    }
            //                    else {
            ...
            if (sizeof($iterator) > 0) {
                ...
                foreach ($iterator as $cCtr => $tComSpec) {
                    ...
                    if ($tobeExecuted) {
                        ...
                        //                        $this->debugArrPrint($tmpOutParams);
            ...
            if (sizeof($iterator) > 0) {
                foreach ($iterator as $cCtr => $tComSpec) {
                    ...
                    if (isset($_SESSION[$cCode][$srcGateName]) && (sizeof($_SESSION[$cCode][$srcGateName]) > 0)) {
                        $this->debugArrPrint($_SESSION[$cCode][$srcGateName]);
                        foreach ($_SESSION[$cCode][$srcGateName] as $xid => $dSpec) {
                            //                            $id = $dSpec['id'];
                            $id = $xid;
                            $subParams = array();
            ...
            //            $this->debugArrPrint($_SESSION[$cCode]["revert"]);
...
//            $this->lastValidate($insertID);
            ...
            if (sizeof($iterator) > 0) {
                ...
                $tmp = $l->lookupJoined();
                //            cekHitam($this->db->last_query());
                //            $this->debugArrPrint( implode(",",array_keys($_SESSION[$cCode]['items'])));
                    ...
                    foreach ($mongoList as $gateList => $listIDSData) {
                        ...
                        if (sizeof($tmpTrm) > 0) {
                            ...
                            foreach ($tmpTrm as $tmpMain) {
                                ...
                                //                            $this->debugArrPrint($transksi_main);
    ...
    public function doPreCancelPacking()
    {
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (isset($_SESSION[$cCode]['tableIn_master']) && sizeof($_SESSION[$cCode]['tableIn_master']) > 0) {
                ...
                //                $this->debugArrPrint($udTr);
                $nomer_top_replacer = 0;
                if (sizeof($udTr) > 0) {
                    //                    $this->debugArrPrint($udTr[0]->ids_his);
            ...
            validateAllBalances();
            //            $this->debugArrPrint( $_SESSION[$cCode]['mode'] );
            //            $this->debugArrPrint( $cCode );
            //            $this->debugArrPrint( $masterID );
//
