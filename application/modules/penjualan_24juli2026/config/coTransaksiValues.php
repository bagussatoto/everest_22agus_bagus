                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "gudang_id" => "gudangID",
                            "state" => ".active",
                            "jenis" => ".020403",// hutang ke konsumen
                            "produk_id" => "pihakID",
                            "nama" => "pihakName",
...
//                    //</editor-fold>
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "020403" => "-nilai_dipakai_020403",// hutang ke konsumen
                            "010201" => "nilai_tambah_020403",//dikurangi nilai ppn// piutang dagang
                            "0401" => "nett1",// penjualan
                            // "ppn out" => "nilai_tambah_ppn_out",//digeser ke invoicing karena ada pembulatan dpp jika ada tambahan diskon untuk pembulatan
                            "0702" => "ongkir",// jasa kirim
            ...
            "582" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "010201" => "nilai_tambah_ppn_out",// piutang dagang
                            "020305" => "nilai_tambah_ppn_out",// ppn out
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
            ...
            "982" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "0402" => "nett1",// return penjualan
                            "020305" => "-ppn",// ppn out
                            "010304" => "hpp",// persediaan produk
                            "0501" => "-hpp",// hpp
                            "060200040" => "-add_disc",// diskon
                            "020403" => "nett2",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
            ...
            "382spd" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "020409" => "-nilai_dipakai_hutang_ke_konsumen",// hutang valas ke konsumen
                            "010202" => "grand_total",// piutang valas
                            "0401" => "nett2",// penjualan
                            "0702" => "ongkir_rupiah",// jasa kirim
                            "010304" => "-hpp",// persediaan produk
                            "0501" => "hpp",// hpp
                        ),
                        "static" => array(
                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "gudang_id" => "gudangID",
                            "state" => ".active",
                            "jenis" => ".020410",// hutang jasa ke konsumen
                            "produk_id" => "pihakID",
                            "nama" => "pihakName",
                            "nilai" => "tagihan",
                            "transaksi_id" => "masterID",
            ...
            "584" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "020410" => "-nilai_dipakai_020410",// hutang jasa ke konsumen
                            "010205" => "nilai_tambah_020410",// piutang dagang jasa
                            //                            "pph 23 dibayar di muka" => "nilai_tambah_pph_23_dibayar_di_muka",
                            "010101" => "nilai_cash",// kas
                            "0405" => "nett1",// penjualan jasa
                            "020305" => "nilai_tambah_020305",// ppn out
