...
//        $this->jenisTr = $this->uri->segment(3);
        ...
        // cekHitam("area diskon grosir @" . __LINE__);
        /* ----------------------------------------------------------
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (isset($_SESSION[$cCode]['items'])) {
                ...
                // cekHitam("area diskon kategori @" . __LINE__);
                /* -----------------------------------------------------------
                ...
                * -----------------------------------------------------------*/
                ...
                //
                // // cekHijau("potongan_nilai #diskon kategori membuat session main");
                // // arrPrintKuning($potongan_nilai);
                ...
                foreach ($sessItems as $id => $iSpec) {
                    ...
                    // $pro_premi = isset($rows->premi_jual) ? $rows->premi_jual : 0;
                    ...
                    // $pro_jml = $tmp['jml'];
                    //
                    // // cekMerah("pihak_kategori $pihak_kategori");
                    // if ($pihak_kategori == "distributor") {
                    //     // $calc_hasils = $this->selectorDiskon($id, $pro_harga_reseller, $pro_jml, $rows, $sesmain);
                    ...
                    // }
                    // else {
                    //     // $calc_hasils = $this->selectorDiskon($id, $pro_harga, $pro_jml, $rows);
                    //     $calc_hasils = $ld->selectorDiskon($id, $pro_harga, $pro_jml, $rows);
                    //     $calc_hasil = $calc_hasils["simple"];
                    // }
                    //
                    // // cekHitam("area diskon kategori dlm grosir @" . __LINE__);
                    // // cekHere(sizeof($potongan_nilai));
                    // // arrPrintKuning($calc_hasil);
                    // if (sizeof($potongan_nilai) > 0) {
                    //     foreach ($potongan_nilai as $dis_kategori => $item) {
                    //
                    //         if ($item['nilai'] > 0) {
                    //
                    //             cekHere("dapat diskon kategori" . __LINE__);
                    //
                    //             // $calc_hasils = $this->selectorDiskon($id, $pro_harga_reseller, $pro_jml, $rows, $sesmain);
                    //             $calc_hasils = $ld->selectorDiskon($id, $pro_harga_reseller, $pro_jml, $rows, $sesmain);
                    //             $calc_hasil = $calc_hasils["grosir"];
                    ...
                    //     }
                    // }
                    // // -------------------end kategori diskon dlm grosir-----------------------
                    //
                    // // arrPrintKuning($calc_hasil);
                    ...
                    $stok_booking = $tmp['stok_booking'];
                    if ($sesMains['pihakMainJenis'] == "cabang") {
                        $tmp['stok_ready'] = $tmp['stok'] - $stok_booking;
                    }
                    else {
                        $tmp['stok_ready'] = $tmp['stok_center'] - $stok_booking;
                    }
                    ...
                    // cekHitam("update item $id @" . __LINE__);
                    // cekPink("harga_yg_dipakai $harga_yg_dipakai");
...
//        fillValues_he_value_builder($this->jenisTr, 1, 1, $this->configCoreJenis, $this->configUiJenis, my_ppn_factor());
//        fillValues_he_value_builder($this->jenisTr, 1, 1, $this->configCoreJenis, $this->configUiJenis, my_ppn_factor());
