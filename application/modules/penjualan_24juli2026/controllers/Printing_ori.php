...
class Printing extends Modul_Controller
{
    ...
    public function viewReceiptReg()
    {
        ...
        $receiptView = isset($confLayouts["receiptView"]) ? $confLayouts["receiptView"] : array();
        $receiptViewDefault = isset($receiptView["default"]) ? $receiptView["default"] : array();
        $receiptViewConf = isset($receiptView[$step_number]) ? $receiptView[$step_number] : "";
        $mode = isset($receiptView[$step_number]) ? $receiptViewConf : $receiptViewDefault;
        // $mode = isset($receiptView[$step_number]) ? $receiptViewConf : "viewReceiptReg_mod";

        // arrPrintKuning($receiptView);
        cekHijau("$mode");
        cekHijau($receiptViewConf);
