...
class BarcodePrinter extends CI_Controller
{
...
// cekOrange(url_segment());
            $kolom_segmen = url_segment(4);
            $kolom = isset($kolom_segmen) ? $kolom_segmen : "barcode";
            // cekHere($kolom);
            // arrPrint($_POST);
            ...
            foreach ($arrRow as $k => $tmpX) {
                ...
                foreach ($tmpX as $y => $x) {
                    ...
                    $barcode = $tempCode[$xID] ? $tempCode[$xID] : "tidak tersedia";
                    ...
                    $listed .= "<div style='' class='uploaded text-capitalize'><span style='color: #0d6aad;'>$name_data</span>";
    ...
    public function prePrintSave()
    {
        ...
        * ---------------------------------------------*/
        ...
        $action = base_url() . "addons/BarcodePrinter/doPrint";
