            ...
            if (is_array($items) && (sizeof($items) > 0)) {
                ...
                foreach ($items as $iSpec) {
                    if ((isset($iSpec['nama'])) && (strlen($iSpec['nama']) > 0)) {
                        ...
                        $listyle = isset($iSpec["style"]) ? $iSpec["style"]:"";
                        $strContent .= "<li class='list-group-item' style='$listyle'>";
                        ...
                        if (isset($socketURL[$iSpec['id']]) && strlen($socketURL[$iSpec['id']]) > 3) {
                            ...
                            switch ($cCode) {
                                ...
                                case "_TR_461":
                                    ...
                                    break;
                                default:
//                                    isset($iSpec["target_allow"])
                                    $strContent .=  isset($iSpec["target_allow"]) ?"" :"<a href='javascript:void(0);' onclick=\"top.getData('" . $iSpec['target'] . "?selector&id=" . $iSpec['id'] . "$defVal', 'result', 1);$mb_js\" ssonclick=\"document.getElementById('result').src='" . $iSpec['target'] . "?selector&id=" . $iSpec['id'] . "$defVal';$mb_js\">";
//                                    $strContent .= "<a href='javascript:void(0);' onclick=\"document.getElementById('result').src='" . $iSpec['target'] . "?selector&id=" . $iSpec['id'] . "$defVal';$mb_js\">";
                                    break;
                            }
                        }
