...
//                    $_SESSION[$cCode]['out_master'][$key] = $tmpB[0]->$src;
    ...
    public function selectExtern()
    {
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main']['pihakExternRevertRequest'] = isset($tmpB[0]->revertRequest) ? $tmpB[0]->revertRequest : false;
            $_SESSION[$cCode]['main']['pihakExternRevertReference'] = isset($tmpB[0]->revertReference) ? $tmpB[0]->revertReference : false;
            ...
            echo "<script>";
            echo "top.$('#shopping_cart').load('" . base_url() . $this->modul . "/_shoppingCart/viewCart/" . $this->jenisTr . "?selID=$id');";
            echo "top.document.getElementById('pihakExternName').value='" . $tmpPihakName . " ($id)';";
            echo "top.document.getElementById('pilihan_outlet').innerHTML='';";
