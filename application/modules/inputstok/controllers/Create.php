...
//                arrPrintPink($cContent);
                $_SESSION[$cCode]['main']['referenceID'] = $insertID;
                $_SESSION[$cCode]['main']['referenceNumber'] = $tmpNomorNota;
                $_SESSION[$cCode]['main']['referenceNomer'] = $tmpNomorNota;
                $_SESSION[$cCode]['main']['referenceDtime'] = date("Y-m-d H:i:s");
                $_SESSION[$cCode]['main']['referenceFulldate'] = date("Y-m-d");
                $_SESSION[$cCode]['main']['referenceCount'] = $cContent['stepCode'][$_SESSION[$cCode]['main']['stepCode']];
