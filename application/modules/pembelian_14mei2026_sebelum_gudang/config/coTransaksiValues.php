                ...
                "master" => array(
                    array(
                        ...
                        "loop" => array(
                            ...
                            "010306" => "hpp_riil",//persediaan produk riil
...
//                            "persediaan produk"                        => "-hpp",
                            "010306" => "-hpp_riil",//persediaan produk riil
                            "010203" => "nett",//piutang pembelian
                            "01040100005" => "-ppn",//ppn in belum ada faktur
//                            "laba(rugi) selisih fifo return pembelian" => "(hpp+ppn)-nett",
                            "060400008" => "(hpp_riil+ppn)-nett",//laba(rugi) selisih fifo return pembelian
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        "comName" => "RekeningPembantuSupplier",
                        "loop" => array(
                            "01040100005" => "-ppn",//ppn in bekum ada faktur
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "pihakID",
                ...
                "detail" => array(
                    ...
                    array(
                        "comName" => "RekeningPembantuProduk",
                        "loop" => array(
                            "010306" => "sub_hpp_riil",//persediaan produk riil
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "id",
                ...
                "master" => array(
                    array(
                        ...
                        "loop" => array(
                            ...
                            "010307" => "hpp_riil",//persediaan supplies riil
                            "020407" => "-ppv_riil",//hutang lain ppv
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
            ...
            "463" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "060400001" => "harga_disc",//biaya
                            "01040100009" => "nilai_tambah_ppn_in",//ppn in jasa
                            "020404" => "nilai_tambah_piutang_pembelian",//hutang biaya
                            "010203" => "-nilai_dipakai_piutang_pembelian",//piutang pembelian
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
            ...
            "113" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "01040100009" => "-selisih_ppn_realisasi",//ppn in jasa
                            "020404" => "-selisih_ppn_realisasi",//hutang biaya
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "01040100009" => "-ppn_realisasi",//ppn in jasa
                            "01040100006" => "ppn_realisasi",//ppn in realisasi
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
            ...
            "113" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "ppn in jasa" => "-selisih_ppn_realisasi",
...
//                    ),
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "010306" => "exchange__harga",//persediaan produk riil
                            "01040100005" => "exchange__nilai_tambah_ppn_in",//ppn in

                            "020102" => "exchange__nilai_tambah_piutang_pembelian",//hutang dagang
                            "010203" => "-exchange__nilai_dipakai_piutang_pembelian",//piutang pembelian
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "010304" => "exchange__hpp_nppv",//persediaan produk
                            "010306" => "-exchange__harga",//persediaan produk riil
                            "020407" => "exchange__ppv",//hutang lain ppv
//                            "ppn in" => "ppn",
//                            "ppn in"            => "nilai_tambah_ppn_in",
//                            "hutang lain ppv"   => "ppv",
//
...
//                    ),
                    ...
                    array(
                        "comName" => "RekeningPembantuProdukRiil",
                        "loop" => array(
                            "010306" => "exchange__sub_harga",//persediaan produk riil
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "id",
                    ...
                    array(
                        "comName" => "RekeningPembantuProduk",
                        "loop" => array(
                            "010304" => "exchange__sub_hpp_nppv",//persediaan produk
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "id",
            ...
            "960" => array(
                "master" => array(
                    ...
                    array(
                        ...
                        "loop" => array(
                            "010306" => "-hpp_riil",//persediaan produk riil
                            "010203" => "exchange__nett",//piutang pembelian
                            "01040100005" => "-ppn",//ppn in
                            "060400008" => "(hpp_riil+ppn)-exchange__nett",//laba(rugi) selisih fifo return pembelian
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
            ...
            "3463" => array(
                "master" => array(
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "060400003" => "harga_disc",//projek cost
                            "01040100009" => "nilai_tambah_ppn_in",//ppn in jasa
                            "020101" => "nilai_tambah_piutang_pembelian",//hutang dagang
                            "010203" => "-nilai_dipakai_piutang_pembelian",//piutang pembelian
                        ),
...
//                            "extern2_nama" => "transaksi_nomer_target",// so
                    ...
                    array(
                        ...
                        "loop" => array(
                            "060400003" => "-harga_disc",//projek cost
                            "010801" => "harga_disc",//piutang cabang
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "extern2_nama" => "transaksi_nomer_target",// so
                    ...
                    array(
                        ...
                        "loop" => array(
                            "060400003" => "harga_disc",//projek cost
                            "020401" => "harga_disc",//hutang ke pusat
                        ),
                        "static" => array(
                            "cabang_id" => "place2ID",
                            "jenis" => "jenisTr",
