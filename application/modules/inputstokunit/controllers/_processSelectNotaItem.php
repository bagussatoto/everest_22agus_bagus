...
//matiHEre();
                        ...
                        //untuk handling items2
                        $tmp = $_SESSION[$cCode]['items'][$id];
                        $this->load->model("Mdls/MdlProduk");
                        $pp = new MdlProduk();
                        $pp->AddFilter("id='$id'");
                        $tmpProduk =$pp->lookUpAll()->result();
                        $produk_jenis = $tmpProduk[0]->kategori_nama;
                        $produk_kode = $tmpProduk[0]->kode;
                        $rows = $tmpProduk[0];
                        $tmp["produk_kode"]=$rows->kode;
                        $tmp["barcode"]=$rows->barcode;
                        if ($jml_serial * 1 == 1) {
                            $d_kode = $produk_kode;
...
//            $produk_jenis=$_SESSION[$cCode]['items'][$id]["kategori_id"];
            $tmp = $_SESSION[$cCode]['items'][$id];
            $this->load->model("Mdls/MdlProduk");
            $pp = new MdlProduk();
            $pp->AddFilter("id='$id'");
