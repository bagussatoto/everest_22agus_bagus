    ...
    case "preview":
        ...
        if (isset($items) && sizeof($items) > 0) {
            ...
            if (sizeof($itemsSrc) > 0) {
                ...
                $srcItems .= "<tfoot>";
                $srcItems .= "<tr>";
                $srcItems .= "<td colspan='" . count($itemSrcLabels) . "' class='text-right text-bold'>TOTAL PPN MASUKAN</td>";
                $srcItems .= "<td class='text-right text-bold'>" . formatField('subtotal', $nTotal) . "</td>";
                $srcItems .= "</tr>";
                $srcItems .= "</tfoot>";
            ...
            echo $srcItems; //PPN MASUKAN

            $srcItemsTarget1 = "";
            if ((sizeof($itemsTarget1) > 0) && (sizeof($itemSrcLabels) > 1)) {
                $srcItemsTarget1 .= "<div class='table-responsive'>";
                $srcItemsTarget1 .= "<table  class='table table-bordered table-condensed' style='background:#ffffff;'>";
                $srcItemsTarget1 .= "<tr bgcolor='#f5f5f5'>";
                $srcItemsTarget1 .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>no.</th>";
                foreach ($itemSrcLabels as $cKol => $cAlias) {
                    $srcItemsTarget1 .= "<th class='text-muted' style='font-weight:bold;'>";
                    $srcItemsTarget1 .= $cAlias;
                    $srcItemsTarget1 .= "</th>";
                }
                $n = 0;
                $nTotal = 0;
                foreach ($itemsTarget1 as $itemsSrc_0) {
                    $n++;
                    $srcItemsTarget1 .= "<tr line=" . __LINE__ . ">";
                    $srcItemsTarget1 .= "<td>$n</td>";
                    foreach ($itemSrcLabels as $cKol => $cAlias) {
                        $srcItemsTarget1 .= "<td>" . formatField($cKol, $itemsSrc_0[$cKol]);
                        $srcItemsTarget1 .= "</td>";
                    }
                ...
                $srcItemsTarget1 .= "<tfoot>";
                $srcItemsTarget1 .= "<tr>";
                $srcItemsTarget1 .= "<td colspan='" . count($itemSrcLabels) . "' class='text-right text-bold'>TOTAL PPN DIBAYAR BENDAHARA NEGARA</td>";
                $srcItemsTarget1 .= "<td class='text-right text-bold'>" . formatField('subtotal', $nTotal) . "</td>";
                $srcItemsTarget1 .= "</tr>";
                $srcItemsTarget1 .= "</tfoot>";

                $srcItemsTarget1 .= "</table>";
                $srcItemsTarget1 .= "</div>";
            }
            echo $srcItemsTarget1; //PPN DIBAYAR BENDAHARA NEGARA

            $srcItemsSrc1 = "";
            if (sizeof($itemsSrc1) > 0) {
                $srcItemsSrc1 .= "<div class='table-responsive'>";
                $srcItemsSrc1 .= "<table  class='table table-bordered table-condensed' style='background:#ffffff;'>";
                $srcItemsSrc1 .= "<tr bgcolor='#f5f5f5'>";
                $srcItemsSrc1 .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>no.</th>";
                foreach ($srcItemsSrc1Label as $cKol => $cAlias) {
                    $srcItemsSrc1 .= "<th class='text-muted' style='font-weight:bold;'>";
                    $srcItemsSrc1 .= $cAlias;
                    $srcItemsSrc1 .= "</th>";
                }
                $n = 0;
                $nTotal = 0;
                foreach ($itemsSrc1 as $itemsSrc_0) {
                    $n++;
                    $srcItemsSrc1 .= "<tr line=" . __LINE__ . ">";
                    $srcItemsSrc1 .= "<td>$n</td>";
                    foreach ($srcItemsSrc1Label as $cKol => $cAlias) {
                        $srcItemsSrc1 .= "<td>" . formatField($cKol, $itemsSrc_0[$cKol]);
                        $srcItemsSrc1 .= "</td>";
                    }
                ...
                $srcItemsSrc1 .= "<tfoot>";
                $srcItemsSrc1 .= "<tr>";
                $srcItemsSrc1 .= "<td colspan='" . count($srcItemsSrc1Label) . "' class='text-right text-bold'>TOTAL PIB</td>";
                $srcItemsSrc1 .= "<td class='text-right text-bold'>" . formatField('subtotal', $nTotal) . "</td>";
                $srcItemsSrc1 .= "</tr>";
                $srcItemsSrc1 .= "</tfoot>";
...
//                    $viewItems .= "<a class='text-black btn btn-danger btn-xs' title='hapus baris ini' data-toggle='tooltip' data-placement='left'
//                    onclick=\"\">
...
//                }
            ...
            if (isset($shoppingCartMode) && ($shoppingCartMode == "index_multi")) {
                echo "<tfoot>";
                echo "<tr>";
                echo "<td colspan='" . count($itemLabels) . "' class='text-right text-bold'>TOTAL PPN KELUARAN</td>";
                echo "<td class='text-right text-bold'>" . formatField('subtotal', $nTotal) . "</td>";
                echo "</tr>";
                echo "</tfoot>";
            }
            ...
            if (isset($sumRows) && sizeof($sumRows) > 0) {
                foreach ($sumRows as $key => $label) {
                    $colspanX = sizeof($itemLabels2) > $itemLabels ? sizeof($itemLabels2) : sizeof($itemLabels);
                    echo "<tr line=" . __LINE__ . ">";
                    echo "<td colspan='" . $colspanX . "' class='text-right'>$label</td>";
                    echo "<td class='text-right'>";
                    $val = 0;
            ...
            if (isset($items2) && (is_array($items2)) && (sizeof($items2) > 0)) {
                echo "<div class='table-responsive'>";
                if (isset($shoppingCartNoFakturLabel) && ($shoppingCartNoFakturLabel != NULL)) {
                    echo "<h4 style='margin-bottom:-15px;'>$shoppingCartNoFakturLabel</h4>";
                }
                echo "<table class='table table-bordered table-condensed'>";
...
//                                echo "<td>&nbsp;</td>";
                    ...
                    echo "<th ccolspan='7' class='text-muted' style='font-weight:bold;' align='right' width='5'>No</th>";
                    foreach ($itemLabels2 as $key => $label) {
                        echo "<th class='text-muted' style='font-weight:bold;'>";
                        echo $label;
                        echo "</th>";
            ...
            if (count($fakturParam) > 0) {
                ...
                if ($pakai_ini == 1) {
                    $faktur .= "<tr>";
                    foreach ($fakturParam["fields"] as $ff => $f_labels) {
                        $value = formatField($ff, $fakturItems[$ff]);
                        $faktur .= "<td>$value</td>";
                    }
                    $faktur .= "</tr>";
                }
                    ...
                    foreach ($formulirFaktur as $ctt => $fSpec) {
                        $faktur .= "<tr>";
                        foreach ($fakturParam["fields"] as $fff => $f_labels) {
            ...
            if (count($fakturInsentifParam) > 0) {
                $faktur .= "<div class='panel panel-default' style=' margin-top: 10px;'>";
                $faktur .= "<table class='table'>";
                $faktur .= "<tr>";
                foreach ($fakturInsentifParam["fields"] as $fff => $fff_abels) {
                    $faktur .= "<th>$fff_abels</th>";
                }
                $faktur .= "</tr>";
                $pakai_ini = 0;
                if ($pakai_ini == 1) {
                    $faktur .= "<tr>";
                    foreach ($fakturInsentifParam["fields"] as $fff => $ff_labels) {
                        $value_1 = formatField($fff, $fakturInsentifItems[$ff]);
                        $faktur .= "<td>$value_1</td>";
                    }
                    $faktur .= "</tr>";
                }
                else {
//                    arrPrint($formulirInsentifFaktur);
                    foreach ($formulirInsentifFaktur as $cttt => $fSpec1) {
                        $faktur .= "<tr>";
                        foreach ($fakturInsentifParam["fields"] as $fff => $ff_labels) {
                            $linkFaktur = MODUL_PATH . $shopingCartFakturTarget . "/";
                            $labels = "";
                            $btn_formulir = "";
                            $btn_formulir_delete = "";
                            $value1 = formatField($fff, $fSpec1[$fff]);
                            $faktur .= "<td id='td_$fff'>$value1 <span class='text-danger text-bold text-blink'> $labels </span>";
                            $faktur .= "</td>";

                            if (is_numeric($fSpec1[$fff])) {
                                if (!isset($sub_total_bawah[$fff])) {
                                    $sub_total_bawah1[$fff] = 0;
                                }
                                $sub_total_bawah1[$fff] += $fSpec1[$fff];
                            }
                        }
                        $faktur .= "</tr>";
                    }
                    if (sizeof($formulirInsentifFaktur) > 1) {
                        $bgcolor = isset($formulirFakturStyle["bgcolor"]) ? $formulirFakturStyle["bgcolor"] : "";
                        $faktur .= "<tr style='background-color:$bgcolor;'>";
                        foreach ($fakturInsentifParam["fields"] as $fff => $f_labels) {
                            $value = isset($sub_total_bawah[$fff]) ? formatField($fff, $sub_total_bawah1[$fff]) : "";
                            $faktur .= "<td id='td_$fff' class='text-bold' style='font-size:15px;'>$value";
                            $faktur .= "</td>";
                        }
                        $faktur .= "</tr>";
            ...
            echo "<script>
            top.$('.modal-dialog').removeClass('modal-lg').addClass('modal-xl');
            </script>";
    ...
    case "previewMulti":
        ...
        echo "<div id='previewMulti' class='table-responsive bborder-cek'>";
        ...
        if (isset($items) && sizeof($items) > 0) {
            ...
            if (sizeof($itemsSrc) > 0) {
                ...
                $nTotal = 0;
                foreach ($itemsSrc as $itemsSrc_0) {
                    $trid = $itemsSrc_0["transaksi_id"];
                    $n++;
                    $srcItems .= "<tr line=" . __LINE__ . " id='items_preview_$trid'>";
                    $srcItems .= "<td>$n</td>";
                    foreach ($itemSrcLabels as $cKol => $cAlias) {
                        $srcItems .= "<td>" . formatField($cKol, $itemsSrc_0[$cKol]);
                        $srcItems .= "</td>";
                    ...
                    if (!$avoidRemove) {
                        if (isset($qstrLabelsMasukan) && (sizeof($qstrLabelsMasukan) > 0)) {
                            $qstrLabels = $qstrLabelsMasukan;
                            $qstr = "";
                            foreach ($qstrLabels as $key => $label) {
                                $qstr .= "&$key=" . urlencode($itemsSrc_0[$key]);
                            }
                            $previewBlob = blobEncode("preview");
                            if (($itemsSrc_0['sisa'] > 0) && ($itemsSrc_0['nilai_ppn_masukan_didelete'] == 0)) {
                                $state = "false";
                                $icon = "<span class='glyphicon glyphicon-remove'></span>";
                                $gerbang_asal = "sisa";
                                $gerbang_target = "nilai_ppn_masukan_didelete";
                                $btn_hapus = "btn-danger";
                            }
                            elseif (($itemsSrc_0['returned'] > 0) && ($itemsSrc_0['nilai_ppn_masukan_didelete'] == 0)) {
                                $state = "false";
                                $icon = "<span class='glyphicon glyphicon-remove'></span>";
                                $gerbang_asal = "returned";
                                $gerbang_target = "nilai_ppn_masukan_didelete";
                                $btn_hapus = "btn-danger";
                            }
                            elseif (($itemsSrc_0['sisa'] < 1) && ($itemsSrc_0['nilai_ppn_masukan_didelete'] > 0)) {
                                $state = "true";
                                $icon = "<span class='glyphicon glyphicon-refresh'></span>";
                                $gerbang_asal = "nilai_ppn_masukan_didelete";
                                $gerbang_target = "sisa";
                                $btn_hapus = "btn-info";
                            }
                            elseif (($itemsSrc_0['returned'] < 1) && ($itemsSrc_0['nilai_ppn_masukan_didelete'] > 0)) {
                                $state = "true";
                                $icon = "<span class='glyphicon glyphicon-refresh'></span>";
                                $gerbang_asal = "nilai_ppn_masukan_didelete";
                                $gerbang_target = "returned";
                                $btn_hapus = "btn-info";
                            }
                            else {
                                $state = "true";
                                $icon = "<span class='glyphicon glyphicon-refresh'></span>";
                                $btn_hapus = "btn-warning";
                            }
                            $gerbang_asal_blob = urlencode($gerbang_asal);
                            $gerbang_target_blob = urlencode($gerbang_target);
                            $link_remove = $selectProcessorRemove["itemsSrc"] . "?1=1$qstr&src=$previewBlob&asal=$gerbang_asal_blob&target=$gerbang_target_blob&state=false";
                        }
                        $srcItems .= "<td line='" . __LINE__ . "' width='1%'>";
                        $srcItems .= "<a class='text-black btn $btn_hapus btn-xs' 
title='hapus baris ini' 
data-toggle='tooltip' 
data-placement='left'
                    onclick=\"$('#result').load('$link_remove');\">
                    $icon
                    </a>";
                        $srcItems .= "</td>";
                    }
            ...
            if (sizeof($itemsTarget1) > 0) {
                ...
                foreach ($itemsTarget1 as $itemsSrc_0) {
                    $trid = $itemsSrc_0["transaksi_id"];
                    $n++;
                    $srcItemsTarget1 .= "<tr line=" . __LINE__ . " id='items_preview_$trid'>";
                    $srcItemsTarget1 .= "<td>$n</td>";
                    foreach ($itemSrcLabels as $cKol => $cAlias) {
                        $srcItemsTarget1 .= "<td>" . formatField($cKol, $itemsSrc_0[$cKol]);
                        $srcItemsTarget1 .= "</td>";
                    ...
                    if (!$avoidRemove) {
                        if (isset($qstrLabelsKeluaran) && (sizeof($qstrLabelsKeluaran) > 0)) {
                            $qstrLabels = $qstrLabelsKeluaran;
                            $qstr = "";
                            foreach ($qstrLabels as $key => $label) {
                                $qstr .= "&$key=" . blobEncode($iSpec[$key]);
                            }
                            $previewBlob = blobEncode("preview");
                            $link_remove = $selectProcessorRemove["itemsTarget1"] . "?1=1$qstr&src=$previewBlob&state=false";
                        }
                        $srcItemsTarget1 .= "<td line='" . __LINE__ . "' width='1%'>";
                        $srcItemsTarget1 .= "<a class='text-black btn btn-danger btn-xs' 
title='hapus baris ini' 
data-toggle='tooltip' 
data-placement='left'
                    onclick=\"$('#result').load('$link_remove');\">
            ...
            if (sizeof($itemsSrc1) > 0) {
                ...
                foreach ($itemsSrc1 as $itemsSrc_0) {
                    $trid = $itemsSrc_0["transaksi_id"];
                    $n++;
                    $srcItemsSrc1 .= "<tr line=" . __LINE__ . " id='items_preview_$trid'>";
                    $srcItemsSrc1 .= "<td>$n</td>";
                    foreach ($srcItemsSrc1Label as $cKol => $cAlias) {
                        $srcItemsSrc1 .= "<td>" . formatField($cKol, $itemsSrc_0[$cKol]);
                        $srcItemsSrc1 .= "</td>";
                    ...
                    if (!$avoidRemove) {
                        if (isset($qstrLabelsKeluaran) && (sizeof($qstrLabelsKeluaran) > 0)) {
                            ...
                            $previewBlob = blobEncode("preview");
                            $link_remove = $selectProcessorRemove["itemsSrc1"] . "?1=1$qstr&src=$previewBlob&state=false";
                        }
                        $srcItemsSrc1 .= "<td line='" . __LINE__ . "' width='1%'>";
                        $srcItemsSrc1 .= "<a class='text-black btn btn-danger btn-xs' 
title='hapus baris ini' 
data-toggle='tooltip' 
data-placement='left'
                    onclick=\"$('#result').load('$link_remove');\">
...
//                $nTotal += $iSpec['subtotal'] * 1;
                $nTotal += ($iSpec['sisa'] * 1);
                $fieldVal = "";
                $trid = $iSpec["transaksi_id"];
                $bg_color = $iSpec["background_color"];
                echo "<tr line=" . __LINE__ . " id='items_preview_$trid' style='background-color:$bg_color;'>";
                echo "<td align='right'>";
                echo $no;
                echo ".</td>";
                foreach ($itemLabels as $key => $label) {
...
//                            cekHere("$key = " . $iSpec[$key]);
                        ...
                        $previewBlob = blobEncode("preview");
                        if (($iSpec['sisa'] > 0) && ($iSpec['nilai_ppn_keluaran_didelete'] == 0)) {
                            $state = "false";
                            $icon = "<span class='glyphicon glyphicon-remove'></span>";
                            $gerbang_asal = "sisa";
                            $gerbang_target = "nilai_ppn_keluaran_didelete";
                            $btn_hapus = "btn-danger";
                        }
                        elseif (($iSpec['returned'] > 0) && ($iSpec['nilai_ppn_keluaran_didelete'] == 0)) {
                            $state = "false";
                            $icon = "<span class='glyphicon glyphicon-remove'></span>";
                            $gerbang_asal = "returned";
                            $gerbang_target = "nilai_ppn_keluaran_didelete";
                        ...
                        elseif (($iSpec['sisa'] < 1) && ($iSpec['nilai_ppn_keluaran_didelete'] > 0)) {
                            $state = "true";
                            $icon = "<span class='glyphicon glyphicon-refresh'></span>";
                            $gerbang_asal = "nilai_ppn_keluaran_didelete";
                            $gerbang_target = "sisa";
                            $btn_hapus = "btn-info";
                        }
                        elseif (($iSpec['returned'] < 1) && ($iSpec['nilai_ppn_keluaran_didelete'] > 0)) {
                            $state = "true";
                            $icon = "<span class='glyphicon glyphicon-refresh'></span>";
                            $gerbang_asal = "nilai_ppn_keluaran_didelete";
                            $gerbang_target = "returned";
                        ...
                        $gerbang_asal_blob = blobEncode($gerbang_asal);
                        $gerbang_target_blob = blobEncode($gerbang_target);
                        $link_remove = $selectProcessorRemove["items"] . "?1=1$qstr&src=$previewBlob&asal=$gerbang_asal_blob&target=$gerbang_target_blob&state=$state";

                    }
                    $viewItems = "<td line='" . __LINE__ . "' width='1%'>";

                    $viewItems .= "<button id='btn_hapus_ppn_keluaran_$trid' class='text-black btn $btn_hapus btn-xs' 
                        title='hapus baris ini' 
                        data-toggle='tooltip' 
                        data-placement='left'
                        onclick=\"$('#result').load('$link_remove');this.disabled=true;\">
                    $icon
                    </button>";
...
//                }
            ...
            if (isset($sumAddRows) && sizeof($sumAddRows) > 0) {
                ...
                foreach ($sumAddRows as $keyAdd => $label) {
                    $colspanX = sizeof($itemLabels2) > $itemLabels ? sizeof($itemLabels2) : sizeof($itemLabels);
                    if (isset($addRowKolomLabels[$keyAdd])) {
                        $colspanX = $colspanX - count($addRowKolomLabels[$keyAdd]);
                    }
                    echo "<tr line=" . __LINE__ . ">";
                    echo "<td colspan='" . $colspanX . "' class='text-right'>$label</td>";

                    if (isset($addRowKolomLabels[$keyAdd])) {
                        foreach ($addRowKolomLabels[$keyAdd] as $addKolKey => $adKolVal) {
                            $valAddKol = isset($main[$addKolKey]) ? $main[$addKolKey] : 0;
                            echo "<td class='text-right'>  " . formatField_he_format($addKolKey, $valAddKol);
                            echo "</td>";
                        }
                    }
...
//                                echo "<td>&nbsp;</td>";
            ...
            onclick=\"if(confirm('your selected items will be processed. Continue saving?')==1){document.getElementById('result').src='" . $actionTarget . "';this.style.visibility='hidden';top.open_holdon();}\"><span class='glyphicon glyphicon-ok'></span> $buttonLabel</a>";
            echo "</div>";
...
src='$updateMainFieldTarget?ravPrev=$rawPrevURL&rawBuilderURL=$rawBuilderURL&key=$key_note&val='+this.value;\"";
    ...
    case "selectPaymentSrc":
        ...
        if (isset($label_keterangan) && ($label_keterangan != NULL)) {
            $strContent .= "<div class='alert alert-info text-center text-bold' style='font-size:15px;'> $label_keterangan </div>";
        }
...
//            $strContent .= "<table class='table cTable-modal table-condensed table-responsive no-padding table-bordered' id='dtbl-'>";
            $strContent .= "<table class='table cTable-modal table-condensed table-striped compact table-hover no-padding table-bordered' id='dtbl-'>";

            $strContent .= "<thead>";
            $strContent .= "<tr bgcolor='#f0f0f0'>";
            if (sizeof($itemLabels) > 0) {
                $strContent .= "<th class='text-muted text-center'>No</th>";
                $strContent .= "<th class='text-muted text-center' style='background-color: #afff70;'>";
                $strContent .= "<input type='checkbox' id='pilih_all'> select";
                // $strContent .= "select";
                $strContent .= "</th>";
                foreach ($itemLabels as $key => $label) {
            ...
            foreach ($items as $key => $val) {
                $bg_color = (isset($val["background_color"])) ? $val["background_color"] : "";
                $nob++;
                $strContent .= "<tr line=" . __LINE__ . " style='background-color:$bg_color;'>";
                if (sizeof($itemLabels) > 0) {

                    $qstr = "";
                    foreach ($qstrLabels as $key => $label) {
                        $qstr .= "&$key=" . blobEncode(trim($val[$key]));
                    }
                    $strContent .= "<td class='" . $val['class_bg'] . "text-muted text-center'>$nob</td>";
                    $strContent .= "<td class='" . $val['class_bg'] . "text-muted text-center' style='background-color: #afff70;'>";
                    ...
                    if ($val['transaksi_id'] == 0) {
                        $strContent .= "<input disabled cclass='chRadio paymentSrc' type='checkbox' value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "'                         
                        >";
                    }
                    else {
                        if (($pembayaranBerurutan == true) && ($lanjutBerurutan == true)) {
                            $strContent .= "<input urut='$nob' class='chRadio paymentSrc $urut_class' type=checkbox 
                        $checked $disabled $disabledLockerTransaksi $disabledPaymentSrc $disabledHoldLocker 
                        value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "' 
                        ooonclick=\"open_holdon(),document.getElementById('result').src='" . MODUL_PATH . "$selectProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"
                        qstr=\"$qstr\"
                        >";
                        }
                        else {
                            $strContent .= "<input class='chRadio paymentSrc linkCheckBox_" . $val['transaksi_id'] . "' type=checkbox $checked $disabled $disabledLockerTransaksi $disabledPaymentSrc $disabledHoldLocker value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "'
                        onclick=\"open_holdon(),document.getElementById('result').src='" . MODUL_PATH . "$selectProcessor/$jenisTr" . "?1=1" . $qstr . "&state='+this.checked;" . "\">";
                    ...
                    $strContent .= "</td>";
                    foreach ($itemLabels as $key => $label) {
                        $add = ($key == "nomer") ? "-" . $val["globalCounter"] : "";
                        $data_o = isset($val[$key]) ? $val[$key] : 0;
                        if ($key == "extern4_nama") {
                            $color = "bg-danger";
                        }
                        else {
                        ...
                        $strContent .= "<td key-id='$key' id='" . $val['transaksi_id'] . "_span_$key' class='" . $val['class_bg'] . " $color' data-order='$data_o'>";
                        if (isset($val[$key])) {
                            if (isset($label["link"])) {
//                                cekHere($label["link"]);
//                                arrPrintCyan($val);
                                switch ($jenisTr) {
                                    ...
                                    case "462":
                                    case "1462":
                                        $val_extern2_id = $val["extern3_id"];
                                        break;
                                    default:
                                        $val_extern2_id = $val["extern2_id"];
                                        break;
                                }

                                $val_extern_id = $val["extern_id"];
                                $val_extern_nama = $val["extern_nama"];
                                $val_cabang_id = $val["cabang_id"];
                                $nomer_nolink = formatField_he_format("nomer_nolink", $val["extern2_nama"]);
                                $text = $label["label_link"] . " $val_extern_nama ($nomer_nolink)";
                                $blob_ext = blobEncode($text);

                                $value_nilai = (strlen($val[$key]) > 0) ? formatField_he_format($key, $val[$key], $val['jenis_master'], $val['modul_path']) . $add : "-";
                                $link_define = base_url() . $label["link"] . "$val_extern_id/0?o=$val_cabang_id&main_ext2_id=$val_extern_id&ext2_id=$val_extern2_id&blob_ext=$blob_ext";
                                $link_mutasi = "top.BootstrapDialog.show({
                          title:'&nbsp;',
                          message: $('<div id=saldo></div>').load('$link_define'),
...
";
                                $strContent .= "<a href='javascript:void(0)' onclick=\"$link_mutasi\">$value_nilai</a>";
                            }
                            else {
                                $input = (strlen($val[$key]) > 0) ? formatField_he_format($key, $val[$key], $val['jenis_master'], $val['modul_path']) . $add : "-";;
                                if (in_array($key, $shopingCartReferenceEditable)) {
//                                    cekHitam(__LINE__);
                                    $input = "<input sisa='" . $val['sisa'] . "' onkeyup='xyz(this)' state='$key' class='realisasi text-right' pid='" . $val["transaksi_id"] . "' id='" . $val["transaksi_id"] . "_" . $key . "' value='" . number_format($val[$key]) . "' onclick='this.select()' processor='" . $shopingCartReferenceProcessor . "' sonblur=\"$('#result').load('" . $shopingCartReferenceProcessor . "?trid=" . $val["transaksi_id"] . "value='+this.value+'&key=$key');\">";
                                }
//                                $strContent .= (strlen($val[$key]) > 0) ? formatField_he_format($key, $val[$key], $val['jenis_master'], $val['modul_path']) . $add : "-";
                                $strContent .= $input;
                            }
            ...
            if (isset($checkerSaldoHutangUsaha) && ($checkerSaldoHutangUsaha == true)) {
                $saldoHutangUsaha = isset($ses_outMaster["saldoHutangUsaha__saldo"]) ? $ses_outMaster["saldoHutangUsaha__saldo"] : 0;
                $saldoPymSrc = isset($total["sisa"]) ? $total["sisa"] : 0;
                if ($saldoHutangUsaha < $saldoPymSrc) {
                    cekHere("ada salah...");
                }
            }
...
//$('.table.cTable-modal').DataTable();
                    ...
                    var table = $('#dtbl-').DataTable({
                                    stateSave: false,
//                                    order: [[ 10, 'desc' ]],
                                    order: [[ $kolom_sort, 'asc' ]],
                                    lengthMenu: [ [10, 20, 50, 100, -1], [10, 20, 50, 100, 'All'] ],
                                    pageLength: -1,
                                    footerCallback: function ( row, data, start, end, display ) {
                                        var api = this.api();
                                        var intVal = function (value) {
                                            // Handle berbagai tipe data
                                            if (typeof value === 'number') return value;
                                            if (typeof value === 'string') {
                                                // Coba ekstrak angka dari string HTML
                                                if (value.includes('<')) {
                                        ...
                                        // Inisialisasi objek untuk menyimpan total per kolom
                                        var columnTotals = {};

                                        // Loop melalui semua kolom
                                        api.columns().every(function (index) {
                                            // Skip kolom non-numerik berdasarkan header
                                            var headerText = $(this.header()).text().toLowerCase();
                                            var nonNumericHeaders = ['no', 'select', 'date', 'description', 'nomer', 'ref.', 'number'];

                                            if (nonNumericHeaders.some(keyword => headerText.includes(keyword))) {
                                                return;
                                            }
                                            ...
                                            for (var i = 0; i < columnData.length; i++) {
                                                ...
                                                var num = intVal(value);

                                                // Deteksi jika nilai valid untuk perhitungan
                                                if (!isNaN(num) && num !== 0) {
                                                    pageTotal += num;
                                                    validColumn = true;
                                            }
                                            ...
                                            // Simpan total jika kolom valid
                                            if (validColumn) {
                                                columnTotals[index] = pageTotal;
                                            }
                                        });

                                        // Update footer untuk kolom yang valid
                                        api.columns().every(function (index) {
                                            if (columnTotals.hasOwnProperty(index)) {
                                                var total = columnTotals[index];
                                                $(this.footer()).html(
                                                    `<div class=\"text-right text-bold\">\${addCommas(total.toFixed(2))}</div>`
                                        );
                                            } else {
                                                $(this.footer()).html('<div class=\"text-right\">-</div>');
                                    }
                                });
                                    }
//                                    footerCallback: function (row, data, start, end, display) {
//                                        var api = this.api();
//
//                                        // Fungsi untuk ekstrak nilai numerik dari berbagai tipe data
//                                        var getNumericValue = function (item) {
//                                            // Handle jQuery object
//                                            if (item && typeof item === 'object' && item.jquery) {
//                                                item = item.html();
//                                            }
//
//                                            // Handle DOM elements
...
//                                                // Remove formatting characters (sesuaikan dengan kebutuhan)
//                                                return parseFloat(item.replace(/[^\d.-]/g, '')) || 0;
//                                            }
//
...
//
//                                            // Hanya proses kolom yang memiliki footer element
//                                            if (footer.length > 0) {
//                                                var pageTotal = 0;
//                                                var isColumnVisible = column.visible();
//                                                var columnData = column.data();
//
//                                                // Hanya hitung jika kolom terlihat
//                                                if (isColumnVisible && columnData.length > 0) {
...
//                                                        var val = pageData[i];
//                                                        pageTotal += getNumericValue(val);
//                                                    }
//                                                }
//
//                                                // Update footer (gunakan class sesuai kebutuhan)
//                                                footer.html(\"<div class='text-right text-bold'>\" + addCommas(pageTotal) + \"</div>\");
//                                            }
//                                        });
//                                    }
//                                    footerCallback: function (row, data, start, end, display) {
...
//                                        };
//
//                                        // Fungsi untuk ekstrak nilai dari berbagai tipe data
...
//                                            } else if (typeof obj === 'object' && typeof obj.html === 'function') {
//                                                // Handle object with html method
//                                                return obj.html();
//                                            }
//                                            return obj;
//                                        }
//
//                                        // Array kolom yang akan dihitung (5-9)
//                                        [5, 6, 7, 8, 9].forEach(function(colIndex) {
//                                            // Cek apakah kolom ini ada dalam tabel
//                                            if (api.column(colIndex).visible(false, false)) {
//                                                var pageTotal = 0;
//                                                var columnData = api.column(colIndex, { page: 'current' }).data();
//
//                                                columnData.each(function(d, i) {
//                                                    var val = extractValue(d);
//                                                    pageTotal += intVal(val);
//                                                });
//
//                                                // Cek apakah footer kolom ini ada
//                                                var footer = api.column(colIndex).footer();
//                                                if (footer) {
//                                                    var colorClass = '';
//                                                    if (colIndex === 5) colorClass = 'text-primary';
//                                                    else if (colIndex === 6 || colIndex === 7) colorClass = 'text-success';
//                                                    else if (colIndex === 8 || colIndex === 9) colorClass = 'text-danger';
//
//                                                    $(footer).html(
//                                                        \"<div class='text-right text-bold \" + colorClass + \"'>\" +
//                                                        addCommas(pageTotal) + \"</div>\"
//                                                    );
//                                                }
//                                            }
//                                        });
...
//                                            let val;
//                                            if (typeof obj === 'object' && obj !== null && typeof obj.html === 'function') {
//                                                val = obj.html();
//                                            }
...
//                                                val = accounting.formatNumber(obj);
//                                            }
//                                            else {
//                                                val = 0;
//                                            }
//                                            pageTotal7 += intVal(val);
//                                        });
//
//                                        var pageTotal8=0;
...
//                });
                    ...
                    function xyz(elem) {
                        ...
                        keyupTimer = setTimeout(function() {
                            let sisa = Math.round(elem.getAttribute('sisa')).toFixed(0);
                            let state = elem.getAttribute('state');
                            let processor = elem.getAttribute('processor');
                            let id = elem.getAttribute('pid');

                            let doc = document.getElementsByClassName('linkCheckBox_'+id)[0];
                            let linkCheckBox = doc.getAttribute('onclick');
                            let isChecked = doc.checked;

//                            let newUrl = linkCheckBox;
//                            newUrl = newUrl.replace(/realisasi_kurang=[^&]+/, 'realisasi_kurang=MTAwMC4wMA==');
//                            newUrl = newUrl.replace(/realisasi_netto=[^&]+/, 'realisasi_netto=NTAwMC4wMA==');

//                            console.log(\"linkCheckBox\", linkCheckBox);
//                            console.log(\"newUrl\", newUrl);

                            let valueBefore = removeCommas(elem.defaultValue);
                            let valueAfter = removeCommas(elem.value);

                            switch(state){
                                case 'realisasi_netto':
                                    //rumus => sisa - realisasi_netto = realisasi_kurang
//                                    console.log('realisasi_netto');
                                    if( valueAfter*1 <= sisa*1 ){
                                        document.getElementById(id+'_span_realisasi_kurang').innerHTML= addCommas(sisa-valueAfter);
                                        document.getElementById(id+'_realisasi_netto').value = addCommas(valueAfter);

                                        //background jadi kuning sesaat akan di kirim value nya
//                                        document.getElementById(id+'_realisasi_kurang').style.backgroundColor = 'orange';
                                        document.getElementById(id+'_realisasi_netto').style.backgroundColor = 'orange';

                                        //persiapan pengiriman ke processor
                                        $.ajax({
                                            url: processor,
                                            method: 'post',
                                            data: {id:id,sisa:sisa,realisasi_netto:valueAfter,realisasi_kurang:sisa-valueAfter},
                                            success: function(a){
//                                                document.getElementById(id+'_realisasi_kurang').style.backgroundColor = 'lime';
                                                document.getElementById(id+'_realisasi_netto').style.backgroundColor = 'lime';
                                                setTimeout(function(){
//                                                    document.getElementById(id+'_realisasi_kurang').style.backgroundColor = '';
                                                    document.getElementById(id+'_realisasi_netto').style.backgroundColor = '';
//                                                    document.getElementById(id+'_realisasi_kurang').style.fontWeight='bold';
                                                    document.getElementById(id+'_realisasi_netto').style.fontWeight='bold';
                                                    ...
                                                    if(isChecked){
                                                        ...
                                                        newUrl = newUrl.replace(/realisasi_kurang=[^&]+/, 'realisasi_kurang='+aJson['realisasi_kurang']);
                                                        newUrl = newUrl.replace(/realisasi_netto=[^&]+/, 'realisasi_netto='+aJson['realisasi_netto']);
                                                        console.log('newUrl: ', newUrl);
                                                    }
                                        ...
                                        swal('value tidak valid', 'nilai tidak boleh lebih besar dari <r>' + addCommas(sisa) + '</r>', 'warning');
                                        elem.select();
                                    }
                                break;
                                case 'realisasi_netto_original_klo_mau_dipakai_ganti_aja':
                                    //rumus => sisa - realisasi_netto = realisasi_kurang
                                    console.log('realisasi_netto');
                                    if( valueAfter*1 <= sisa*1 ){
                                        document.getElementById(id+'_realisasi_kurang').value = addCommas(sisa-valueAfter);
                                        document.getElementById(id+'_realisasi_netto').value = addCommas(valueAfter);
                                        ...
                                        $.ajax({
                                            url: processor,
                                            method: 'post',
                                            data: {id:id,sisa:sisa,realisasi_netto:valueAfter,realisasi_kurang:sisa-valueAfter,linkCheckBox:linkCheckBox},
                                            success: function(aa){
                                                document.getElementById(id+'_realisasi_kurang').style.backgroundColor = 'lime';
                                                document.getElementById(id+'_realisasi_netto').style.backgroundColor = 'lime';
                                                setTimeout(function(){
                                                    ...
                                                    // window.location.reload();
                                                    viewundoneList();
                                                    // let newParam = JSON.parse(aa);
                                                    // let url = new URL(linkCheckBox);
                                                    // let params = new URLSearchParams(url.search);
                                                    // params.set('realisasi_kurang', newParam['realisasi_kurang']);
                                                    // params.set('realisasi_netto', newParam['realisasi_netto']);
                                ...
                                break;
                                case 'realisasi_kurang':
                                    //rumus => sisa - realisasi_kurang = realisasi_netto
//                                    console.log('realisasi_kurang');
                                    if( valueAfter*1 <= sisa*1 ){
                                        document.getElementById(id+'_realisasi_netto').value = addCommas(sisa-valueAfter);
                                        document.getElementById(id+'_realisasi_kurang').value = addCommas(valueAfter);
                                        //background jadi kuning sesaat akan di kirim value nya
                                        document.getElementById(id+'_realisasi_kurang').style.backgroundColor = 'orange';
                                        document.getElementById(id+'_realisasi_netto').style.backgroundColor = 'orange';
                                        ...
                                        $.ajax({
                                            url: processor,
                                            method: 'post',
                                            data: {id:id,sisa:sisa,realisasi_kurang:valueAfter,realisasi_netto:sisa-valueAfter,linkCheckBox:linkCheckBox},
                                            success: function(aa){
                                                document.getElementById(id+'_realisasi_kurang').style.backgroundColor = 'lime';
                                                document.getElementById(id+'_realisasi_netto').style.backgroundColor = 'lime';
                                                setTimeout(function(){
        ...
        $(document).ready(function() {
            ...
            $('#pilih_all').on('change', function() {
                let isChecked = $(this).is(':checked');
                let checkboxes = $('.chRadio.paymentSrc');
                checkboxes.each(function(index, checkbox) {
                    setTimeout(() => {
                        var urlOnClickNefore = $(checkbox).attr('onclick');
                        console.log('urlOnClickNefore: ', urlOnClickNefore);
                        code = urlOnClickNefore.replace(/this\.checked;/g, \"this.checked+'&is_json=1'\");
                        var urlAfter = code;
                        $(checkbox).attr('onclick', urlAfter);
...
//            }
    ...
    case "selectPaymentExternSrc":
        ...
        $strContent .= "<h4 class='box-title'><span class=\"glyphicon glyphicon-flash blink\"></span> on-going transactions $labelOngoingReguler</h4>";

        if ($link_top != NULL) {
            $disabled_all = (sizeof($items) == 0) ? "disabled" : "";
            $link_top_all = "top.BootstrapDialog.show(
                                   {
                                       title:'$title',
                                       message: " . '$' . "('<div></div>').load('" . $link_top . "'),
                                        size:top.BootstrapDialog.SIZE_WIDE,
                                        draggable:false,
                                        closable:false,
                                        }
            ...
            $strContent .= "<button type='button' class='btn btn-box-tool btn-warning' $disabled_all 
                onclick=\"$link_top_all\" style='font-size:15px;'>
                <i class='fa fa-bars'></i> Tampilkan semua</button>";
            $strContent .= "</div>";
        }
        else {
        ...
        if (sizeof($items) > 0) {
            ...
            //                            </div>";
            $strContent .= "<table id='pembayaran' class='table display'>";
            $strContent .= "<thead>";
            $strContent .= "<tr bgcolor='#f0f0f0'>";
            if (sizeof($itemLabels) > 0) {
                    ...
                    $(document).ready( function(){
                        var table = $('#pembayaran').DataTable({
                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                        ...
                                        var arrayFooter = $('#pembayaran>tfoot>tr>th');
                                        var dpageTotal = [];
                                        jQuery.each(arrayFooter, function(i,d){
                            ...
                            $('.table-responsive.pembayaran').floatingScroll();
                            $('.table-responsive.pembayaran').scroll(function() {
                                setTimeout(function () {
                                    $('#pembayaran').DataTable().fixedHeader.adjust();
                                }, 100);
                            });
                    </script>";
            ...
            $msg = "-the item you specified has no entry-";
            $strContent .= tplNoData($msg);
        }
...
src='$updateMainFieldTarget?ravPrev=$rawPrevURL&rawBuilderURL=$rawBuilderURL&key=$key_note&val='+this.value;\"";
    ...
    case "index_multi_ori":
        ...
        $p = New Layout("$title", "$subTitle", MODUL_TEMPLATE_PATH . "/template/transaksi_index2.html");
        ...
        if (sizeof($arrayOnProgress) > 0) {
            foreach ($arrayOnProgress as $item => $itemsDetails) {
                ...
                //                $arrCheck=array();
                //                foreach($itemsDetails as $ky => $vals){
                //                    $arrCheck[$vals['jenis']] = $vals['jenis'];
                //                }

                //                arrPrintWebs($itemsDetails[0]);

                $qstr = "";
                if ($item == "itemsSrc" && count($arrayOnProgress[$item]) > 0) {

                    //                    $strOnprog .= "<div class='row'>";
                    //                    $strOnprog .= "<div style='padding-right: 7.5px!important;' class='col-lg-12'>";
                    $strOnprog .= "<div class='box box-solid box-success'>";
                    //                    $strOnprog .= "<div class='box-header'><h3>PPN MASUKAN</h3></div>";
                    $strOnprog .= "<div class='box-body'>";
                    $strOnprog .= "<table class='table table-borderedd ppn_masukan_tbl display' style='font-size: 11px;'>";
                    $strOnprog .= "<caption class='text-uppercase fa-2x'>PPN MASUKAN</caption>";
                    $selectedProcessor = $selectProcessor['itemsSrc'];
                    $nop = 0;

                    //bagian header
                    $strOnprog .= "<thead class='text-bold text-uppercase text-center'>";
                    $colspan1 = count($arrayProgressLabels["itemsSrc"]) + 2;
                    $strOnprog .= "<tr>";
                    $strOnprog .= "<th class='no-padding'>No</th>";
                    foreach ($arrayProgressLabels["itemsSrc"] as $key => $label) {
                        $strOnprog .= "<th class='no-padding'>$label</th>";
                    }
                    $strOnprog .= "<th class='no-padding'>pilih</th>";
                    $strOnprog .= "</tr>";
                    $strOnprog .= "</thead>";
                    $strOnprog .= "<tbody>";
                    ...
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        foreach ($qstrLabels as $key => $label) {
                            ...
                            // }
                            $qstr .= "&$key=" . urlencode($valKey);
                        }
                        $checked = "";
                        $disabled = "";
                        //                        $strOnprog .= "<div class='col-md-6 no-padding'>";
                        //                        $strOnprog .= "<div style='padding: 6px;margin: 3px;border: 1px #a2a2a2 solid;' class='alert bg-gray'>";
                        ...
                        $strOnprog .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$ie</td>";
                        ...
                        if (sizeof($arrayProgressLabels['itemsSrc']) > 0) {
                            ...
                            foreach ($arrayProgressLabels['itemsSrc'] as $key => $label) {
                                ...
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    ...
                                    $pymSrcMasterID = isset($val['id_master']) ? $val['id_master'] : "";
                                    $updateItemFieldTarget = $editItemTrg . "$pymSrcID/$pymSrcTrID/$pymSrcMasterID";
                                    $inputType = "text";
                                    $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\"";
                                    //                                    $strOnprog .= "<input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent>";
                                    $strOnprog .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent></td>";
                                    //                                    $strOnprog .="$ie";
                                }
                                else {
                                    //                                    $strOnprog .="$ie";
                                    $strOnprog .= "<td style='padding: 3px;vertical-align: middle;'>
                                                        <span class='' style='' thisval='" . $val[$key] . "' title='$key'>" . formatField_he_format($key, $val[$key]) . "</span>
                                                   </td>";
                                    //                                    $strOnprog .= "<span class='pull-right text-bold' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;max-width: 80%;' thisval='" . $val[$key] . "' title=''>" . formatField_he_format($key, $val[$key]) . "</span>";
                                }

                            }
                        }

                        $checkDisabled = $val['extern_label2'] == '' || $val['extern_label2'] == '000.000-00.00000000' || $val['extern_label2'] == '0' ? "disabled" : "";

                        $strOnprog .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'>
                                            <div name='ppn_masukan_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                                <label class=''><input class='chRadio' title='tic untuk memilih' type=checkbox $checked $checkDisabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label>
                                            </div>
                                        </td>";
                        //                        $strOnprog .="<td style='padding: 3px;'>$ie</td>";
                        $strOnprog .= "</tr>";
                        $ie++;
                    }
                    ...
                    $strOnprog .= "</table>";
                    $strOnprog .= "<div style='font-size: 23px;' class='col-md-12 bg-green'>PPN MASUKAN TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_masukan'>0</span></div>";
                    $strOnprog .= "</div>";
                    $strOnprog .= "</div>";
                    //                    $strOnprog .= "</div>";
                    //                    $strOnprog .= "</div>";
...
//                                    fixedHeader: true,        
                ...
                elseif ($item == "itemsSrc1" && count($arrayOnProgress[$item]) > 0) {

                    //                    arrPrint($arrayOnProgress[$item]);
                    //                    arrPrintWebs($itemsDetails[0]);

                    $strOnprog_1 .= "<div class='box box-solid box-primary'>";
                    $strOnprog_1 .= "<div class='box-body'>";
                    $strOnprog_1 .= "<table class='table ppn_bendahara_negara display nowrap table-bordered' style='font-size: 11px;'>";
                    $strOnprog_1 .= "<caption class='text-uppercase fa-2x'>PIB</caption>";

                    $selectedProcessor = $selectProcessor['itemsSrc1'];

                    $no = 0;
                    //bagian header
                    $strOnprog_1 .= "<thead style='white-space: nowrap;' class='text-bold text-uppercase text-center'>";
                    $colspan2 = count($arrayProgressLabels["itemsSrc1"]) + 2;
                    $strOnprog_1 .= "<tr>";
                    $strOnprog_1 .= "<th class='no-padding'>No</th>";
                    foreach ($arrayProgressLabels["itemsSrc1"] as $key => $label) {
                        $strOnprog_1 .= "<th class='no-padding'>$label</th>";
                    }
                    $strOnprog_1 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog_1 .= "</tr>";
                    $strOnprog_1 .= "</thead>";
                    $strOnprog_1 .= "<tbody>";
                    ...
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $qstr = "";
                        foreach ($qstrLabels as $key => $label) {
                            $qstr .= "&$key=" . urlencode($val[$key]);
                        }
                        $checked = "";
                        $disabled = "";

                        $searching = "";
                        if (sizeof($arrayProgressLabels['itemsSrc1']) > 0) {
                            foreach ($arrayProgressLabels['itemsSrc1'] as $key => $label) {
                                $searching .= $val[$key] . " ";
                            }
                        }
                        $strOnprog_1 .= "<tr>";
                        $strOnprog_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$no</td>";
                        ...
                        if (sizeof($arrayProgressLabels['itemsSrc1']) > 0) {
                            foreach ($arrayProgressLabels['itemsSrc1'] as $key => $label) {
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    ...
                                    $inputType = "text";
                                    $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\" ";
                                    $strOnprog_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input type=$inputType name='$key" . "_" . "$no' class='form-control text-right text-bold' placeholder='$label' value='" . $val[$key] . "' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' onclick='this.select()' $addEvent></td>";
                                }
                                else {
                                    $key_n = $key == "extern2_nama" ? "nomer" : $key;
                                    $strOnprog_1 .= "<td style='padding: 3px;vertical-align: middle;' data-order='" . $val[$key] . "'>
                                        <span
                                            class=''
                                            style='white-space: nowrap; overflow: hidden;'
                                            thisval='" . $val[$key] . "'
                                            title=''>" . formatField_he_format($key_n, $val[$key]) . "
                                        </span>
                                    </td>";
                                }
                            }
                        ...
                        $strOnprog_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
                                            <div name='ppn_pib_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                            <label class=''>
                                            <input class='chRadio' type=checkbox $checked $checkDisabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label></div></td>";
                        $strOnprog_1 .= "</tr>";
                    ...
                    $strOnprog_1 .= "</table>";
                    $strOnprog_1 .= "<div style='font-size: 23px;' class='col-md-12 bg-green'>PIB TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_pib'>0</span></div>";
                    $strOnprog_1 .= "</div>";
                    $strOnprog_1 .= "</div>";
                    //                    $strOnprog2_1 .= "</div>";
                    //                    $strOnprog2_1 .= "</div>";
...
//                        $('.ppn_pib').DataTable().columns.adjust().draw();
                    </script>";


                }
                elseif ($item == "itemsSrc2" && count($arrayOnProgress[$item]) > 0) {

                    $strOnprog_11 .= "<div class='row'>";
                    $strOnprog_11 .= "<div style='padding-right: 7.5px!important;' class='col-lg-12'>";
                    $strOnprog_11 .= "<div class='box box-solid box-success'>";
                    //                    $strOnprog_11 .= "<div class='box-header'><h3>PPN MASUKAN</h3></div>";
                    $strOnprog_11 .= "<div class='box-body'>";
                    $strOnprog_11 .= "<table class='table table-borderedd ppn_masukan_tbl_11 display' style='font-size: 11px;'>";
                    $strOnprog_11 .= "<caption class='text-uppercase fa-2x'>?????</caption>";
                    $selectedProcessor = $selectProcessor['itemsSrc2'];
                    $nop = 0;

                    //bagian header
                    $strOnprog_11 .= "<thead class='text-bold text-uppercase text-center'>";
                    $colspan1 = count($arrayProgressLabels["itemsSrc2"]) + 2;

                    $strOnprog_11 .= "<tr>";
                    $strOnprog_11 .= "<th class='no-padding'>No</th>";
                    foreach ($arrayProgressLabels["itemsSrc2"] as $key => $label) {
                        $strOnprog_11 .= "<th class='no-padding'>$label</th>";
                    }
                    $strOnprog_11 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog_11 .= "</tr>";
                    $strOnprog_11 .= "</thead>";
                    $strOnprog_11 .= "<tbody>";

                    //arrPrint($itemsDetails);
                    ...
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $checked = "";
                        $disabled = "";
                        //                        $strOnprog_11 .= "<div class='col-md-6 no-padding'>";
                        //                        $strOnprog_11 .= "<div style='padding: 6px;margin: 3px;border: 1px #a2a2a2 solid;' class='alert bg-gray'>";

                        $searching = "";
                        if (sizeof($arrayProgressLabels['itemsSrc2']) > 0) {
                            foreach ($arrayProgressLabels['itemsSrc2'] as $key => $label) {
                                $searching .= $val[$key] . " ";
                            }
                        }
                        $strOnprog_11 .= "<td line='" . __LINE__ . "' sini kah style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$ie</td>";
                        ...
                        if (sizeof($arrayProgressLabels['itemsSrc2']) > 0) {
                            ...
                            foreach ($arrayProgressLabels['itemsSrc'] as $key => $label) {
                                ...
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    ...
                                    $updateItemFieldTarget = $editItemTrg . "$pymSrcID/$pymSrcTrID/$pymSrcMasterID";
                                    $inputType = "text";
                                    $addEvent = "onblurss=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\"";
                                    //                                    $strOnprog_11 .= "<input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent>";
                                    $strOnprog_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent></td>";
                                    //                                    $strOnprog_11 .="$ie";
                                }
                                else {
                                    //                                    $strOnprog_11 .="$ie";
                                    $strOnprog_11 .= "<td style='padding: 3px;vertical-align: middle;' data-order='" . $val[$key] . "'>
                                                        <span class='' style='' thisval='" . $val[$key] . "' title='$key'>" . formatField_he_format($key, $val[$key]) . "</span>
                                                   </td>";
                                    //                                    $strOnprog_11 .= "<span class='pull-right text-bold' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;max-width: 80%;' thisval='" . $val[$key] . "' title=''>" . formatField_he_format($key, $val[$key]) . "</span>";
                                }

                            }
                        }

                        $strOnprog_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
                                            <div name='ppn_masukan_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                                <label class=''><input class='chRadio' title='tic untuk memilih' type=checkbox $checked $disabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label>
                                            </div>
                                        </td>";
                        //                        $strOnprog_11 .="<td style='padding: 3px;'>$ie</td>";
                        $strOnprog_11 .= "</tr>";
                        $ie++;
                    }
...
//                                    fixedHeader: true,        
                ...
                elseif ($item == "items" && count($arrayOnProgress[$item]) > 0) {

                    $strOnprog2 .= "<div class='row'>";
                    $strOnprog2 .= "<div style='padding-left: 7.5px!important;' class='col-lg-12'>";
                    $strOnprog2 .= "<div class='box box-solid box-primary'>";
                    //                    $strOnprog2 .= "<div class='box-header'><h3>PPN KELUARAN</h3></div>";
                    $strOnprog2 .= "<div class='box-body'>";
                    $strOnprog2 .= "<table class='table table-borderedd ppn_keluaran_tbl display' style='font-size: 11px;'>";
                    $strOnprog2 .= "<caption class='text-uppercase fa-2x'>PPN KELUARAN</caption>";
                    $selectedProcessor = $selectProcessor['items'];
                    $no = 0;
                    //bagian header
                    $strOnprog2 .= "<thead style='white-space: nowrap;' class='text-bold text-uppercase text-center'>";
                    $colspan2 = count($arrayProgressLabels["items"]) + 2;
                    $strOnprog2 .= "<tr>";
                    $strOnprog2 .= "<th class='no-padding'>No</th>";
                    foreach ($arrayProgressLabels["items"] as $key => $label) {
                        $strOnprog2 .= "<th class='no-padding'>$label</th>";
                    }
                    $strOnprog2 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog2 .= "</tr>";
                    $strOnprog2 .= "</thead>";
                    $strOnprog2 .= "<tbody>";
                    // arrPrint($itemsDetails);
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $strOnprog2 .= "<tr>";
                        $strOnprog2 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$no</td>";

                        if (sizeof($arrayProgressLabels['items']) > 0) {
                            foreach ($arrayProgressLabels['items'] as $key => $label) {
                                $pymSrcJenisID = $val['jenis'];
                                $colorBgClass = $pymSrcJenisID == "114" ? "class='bg-red'" : "";
                                ...
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    ...
                                    $inputType = "text";
                                    $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\" ";
                                    $strOnprog2 .= "<td $colorBgClass style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input type=$inputType name='$key" . "_" . "$no' class='form-control text-right text-bold' placeholder='$label' value='" . $val[$key] . "' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' onclick='this.select()' $addEvent></td>";
                                }
                                else {
                                    $key_n = $key == "extern2_nama" ? "nomer" : $key;

                                    if ($key != 'nomer' && strlen($val[$key]) > 21) {
                                        $valkey = substr($val[$key], 0, 18) . "...";
                                    }
                                    else {
                                        $valkey = $val[$key];
                                    }
                                    ...
                                    style='white-space: nowrap; overflow: hidden;'
                                    thisval='" . $val[$key] . "'
                                    title=''>" . formatField_he_format($key_n, $valkey) . "</span></td>";
                                }
                            }
                        }
                        ...
                        $strOnprog2 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
    <div name='ppn_keluaran_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
    <label class=''>
    <input class='chRadio' type=checkbox $checked $checkDisabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' name='" . $val['extern2_nama'] . "' id='opt" . $val['id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label></div></td>";
                    ...
                    $strOnprog2 .= "</table>";
                    $strOnprog2 .= "<div style='font-size: 23px;' class='col-md-12 bg-blue'>PPN KELUARAN TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_keluaran'>0</span></div>";
                    $strOnprog2 .= "</div>";
                    $strOnprog2 .= "</div>";
                    $strOnprog2 .= "</div>";
                    $strOnprog2 .= "</div>";
                ...
                elseif ($item == "itemsTarget1" && count($arrayOnProgress[$item]) > 0) {

                    $strOnprog2_1 .= "<div class='box box-solid box-primary'>";
                    $strOnprog2_1 .= "<div class='box-body'>";
                    $strOnprog2_1 .= "<table class='table ppn_bendahara_negara display nowrap table-bordered' style='font-size: 11px;'>";
                    $strOnprog2_1 .= "<caption class='text-uppercase fa-2x'>Ppn Dibayar Bendahara Negara</caption>";

                    $selectedProcessor = $selectProcessor['itemsTarget1'];

                    $no = 0;

                    //bagian header
                    $strOnprog2_1 .= "<thead style='white-space: nowrap;' class='text-bold text-uppercase text-center'>";
                    $colspan2 = count($arrayProgressLabels["itemsTarget1"]) + 2;
                    $strOnprog2_1 .= "<tr>";
                    $strOnprog2_1 .= "<th class='no-padding'>No</th>";

                    foreach ($arrayProgressLabels["itemsTarget1"] as $key => $label) {
                        $strOnprog2_1 .= "<th class='no-padding'>$label</th>";
                    }

                    $strOnprog2_1 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog2_1 .= "</tr>";
                    $strOnprog2_1 .= "</thead>";
                    $strOnprog2_1 .= "<tbody>";
                    //arrPrint($itemsDetails[0]);
                    foreach ($itemsDetails as $key => $val) {
                        $no++;
                        ...
                        $xx_extern2_nama = $val['extern2_nama'];
                        ...
                        $disabled = "";
                        $searching = "";
                        if (sizeof($arrayProgressLabels['itemsTarget1']) > 0) {
                            foreach ($arrayProgressLabels['itemsTarget1'] as $key => $label) {
                                $searching .= $val[$key] . " ";
                            }
                        }
                        $strOnprog2_1 .= "<tr>";
                        $strOnprog2_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$no</td>";
                        ...
                        if (sizeof($arrayProgressLabels['itemsTarget1']) > 0) {
                            foreach ($arrayProgressLabels['itemsTarget1'] as $key => $label) {
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    ...
                                    $inputType = "text";
                                    $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\" ";
                                    $strOnprog2_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input type=$inputType name='$key" . "_" . "$no' class='form-control text-right text-bold' placeholder='$label' value='" . $val[$key] . "' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' onclick='this.select()' $addEvent></td>";
                                }
                                else {
                                    $key_n = $key == "extern2_nama" ? "nomer" : $key;
                                    ...
                                    if ($key == 'extern_date2' && $val[$key] == '') {
                                        $key_n = 'asd';
                                        $valkey = '<r>none</r>';
                                    }


                                    $strOnprog2_1 .= "<td style='padding: 3px;vertical-align: middle;' data-order='" . $val[$key] . "'>
                                        <span
                                            class='$key'
                                            title='" . $val[$key] . "'
                                            style='white-space: nowrap; overflow: hidden;'
                                            thisval='" . $val[$key] . "'
                                            title=''>" . formatField_he_format($key_n, $valkey) . "
                                        </span>
                                    </td>";
                                }
                            }
                        ...
                        $strOnprog2_1 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
                                            <div name='ppn_bendahara_negara_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                            <label class=''>
                                            <input extern_label2='" . $val['extern_label2'] . "' class='chRadio' type=checkbox $checked $checkDisabled value='" . $val['transaksi_id'] . "' name='b_" . $xx_extern2_nama . "' id='opt" . $val['id'] . "' onclick=\"var state=this.checked;top.$('#result').load('$selectedProcessor/$jenisTr" . "?$qstr&state='+state);setTimeout(function() { myKlik('b_$xx_extern2_nama','$xx_extern2_nama') }, 2000)\"></label></div></td>";
                        $strOnprog2_1 .= "</tr>";
                    ...
                    $strOnprog2_1 .= "</tbody>";
                    $strOnprog2_1 .= "</table>";
                    $strOnprog2_1 .= "<div style='font-size: 23px;' class='col-md-12 bg-blue'>PPN BENDAHARA NEGARA TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_bendahara'>0</span></div>";
                    $strOnprog2_1 .= "</div>";
                    $strOnprog2_1 .= "</div>";

                    $strOnprog2_1 .= "
                    <script>
                        $('.ppn_bendahara_negara').DataTable({
                            pageLength: -1,
                            lengthmenu: [[ 10, 25, 50, -1 ], [10, 25, 50, 'All']],
                            paging: false,
                            searching: true,
...
//                        $('.ppn_bendahara_negara').DataTable().columns.adjust().draw();
                        function myKlik(s,t){
                            // console.log(s);
                            // console.log(t);
                            var src = $('input[name=\'' + s + '\']');
                            
                            // $(src).click(function() {
                                if(!$(src).is(':checked')){
                                    $('input[name=\'' + t + '\']').prop('checked',true).trigger('click');
                                }
                                else{                                    
                                    $('input[name=\'' + t + '\']').prop('checked',false).trigger('click');
                                }
                ...
                elseif ($item == "itemsTarget2" && count($arrayOnProgress[$item]) > 0) {

                    $strOnprog2_11 .= "<div class='row'>";
                    $strOnprog2_11 .= "<div style='padding-left: 7.5px!important;' class='col-lg-12'>";
                    $strOnprog2_11 .= "<div class='box box-solid box-primary'>";
                    $strOnprog2_11 .= "<div class='box-body'>";
                    $strOnprog2_11 .= "<table class='table ppn_keluaran_tbl_211 display datatable' style='font-size: 11px;'>";
                    $strOnprog2_11 .= "<caption class='text-bold'>??????</caption>";

                    $selectedProcessor = $selectProcessor['items2'];
                    $no = 0;
                    //bagian header
                    $strOnprog2_11 .= "<thead style='white-space: nowrap;' class='text-bold text-uppercase text-center'>";
                    $colspan2 = count($arrayProgressLabels["items2"]) + 2;
                    $strOnprog2_11 .= "<tr>";
                    $strOnprog2_11 .= "<th class='no-padding'>No</th>";

                    foreach ($arrayProgressLabels["items2"] as $key => $label) {
                        $strOnprog2_11 .= "<th class='no-padding'>$label</th>";
                    }

                    $strOnprog2_11 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog2_11 .= "</tr>";
                    $strOnprog2_11 .= "</thead>";
                    $strOnprog2_11 .= "<tbody>";
                    ...
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $strOnprog2_11 .= "<tr>";
                        $strOnprog2_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$no</td>";


                        if (sizeof($arrayProgressLabels['items2']) > 0) {
                            foreach ($arrayProgressLabels['items2'] as $key => $label) {
                                if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                    $pymSrcID = $val['id'];
                                    $pymSrcTrID = $val['transaksi_id'];
                                    ...
                                    $inputType = "text";
                                    $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\" ";
                                    $strOnprog2_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'><input type=$inputType name='$key" . "_" . "$no' class='form-control text-right text-bold' placeholder='$label' value='" . $val[$key] . "' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' onclick='this.select()' $addEvent></td>";
                                }
                                else {
                                    $key_n = $key == "extern2_nama" ? "nomer" : $key;
                                    $strOnprog2_11 .= "<td style='padding: 3px;vertical-align: middle;' data-order='" . $val[$key] . "'><span class='' style='white-space: nowrap; overflow: hidden;' thisval='" . $val[$key] . "' title=''>" . formatField_he_format($key_n, $val[$key]) . "</span></td>";
                                }
                            }
                        }

                        $strOnprog2_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
                                            <div name='ppn_keluaran_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                            <label class=''>
                                            <input class='chRadio' type=checkbox $checked $disabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label></div></td>";
                        $strOnprog2_11 .= "</tr>";
                    ...
                    $strOnprog2_11 .= "
                    <script>
                        $('.ppn_keluaran_tbl_211').DataTable({
                            pageLength: -1,
                            lengthmenu: [[ 10, 25, 50, -1 ], [10, 25, 50, 'All']],
                            paging: false,
                            searching: true,
        ...
        $strOnprog3 .= "<div class='clearfix'>&nbsp;</div>";
        $strOnprog3 .= "<div class='clearfix'>&nbsp;</div>";

        $strOnprog3 .= "<div class='col-lg-12 no-padding'>
                            <div class='panel'>
                                ...
                                <div class='box-body no-padding' id='shopping_cart'>
                                    <div class='panel-body'>
                                        <div class='text-danger text-bold text-center'>you have not chosen any item yet</div>
                                        <div class='meta text-center'>you can do so by selecting items from available selectors</div>
                                    </div>
                                </div>
                            </div>
                        </div>";
        ...
        $strOnprog3 .= "\n
            <script>
            $('#shopping_cart').bind('DOMSubtreeModified', function(){
              console.log('changed');
              
var masukan = $(\"div[name=ppn_masukan_search]\");
var total_mas = 0;
if(masukan.length>0){
    jQuery.each(masukan, function(i, b){
        var ticBox = $(\"label input\", $(b))
        if( $(ticBox).is(':checked') ){
            var sidTmp = $(b).attr('search_id');
            var sid = sidTmp.trim();
            var masTmp = sid.split(' ');
            var masPpn = 0;
            if(masTmp.length>0){
                jQuery.each(masTmp, function(ii,bb){
                    masPpn = bb
                })
            }
            total_mas += masPpn*1
    ...
    $('#total_masukan').html( addCommas(total_mas) );
}

var keluaran = $(\"div[name=ppn_keluaran_search]\");
var total_kel = 0;
if(keluaran.length>0){
    jQuery.each(keluaran, function(i, b){
        var ticBox = $(\"label input\", $(b))
        if( $(ticBox).is(':checked') ){
            var sidTmp = $(b).attr('search_id');
            var sid = sidTmp.trim();
            var kelTmp = sid.split(' ');
            var kelPpn = 0;
            if(kelTmp.length>0){
                jQuery.each(kelTmp, function(ii,bb){
                    kelPpn = bb
                })
            }
            total_kel += kelPpn*1
    ...
    $('#total_keluaran').html( addCommas(total_kel) );
}

var bendahara = $(\"div[name = ppn_bendahara_negara_search]\");
var total_ben = 0;
if(bendahara.length>0){
    jQuery.each(bendahara, function(i, b){
        var ticBox = $(\"label input\", $(b))
        if( $(ticBox).is(':checked') ){
            var sidTmp = $(b).attr('search_id');
            var sid = sidTmp.trim();
            var benTmp = sid.split(' ');
            var benPpn = 0;
            if(benTmp.length>0){
                jQuery.each(benTmp, function(ii,bb){
                    benPpn = bb
                })
            }
            total_ben += benPpn*1
    ...
    $('#total_bendahara').html( addCommas(total_ben) );
}

var pib = $(\"div[name = ppn_pib_search]\");
var total_pib = 0;
if(pib.length>0){
    jQuery.each(pib, function(i, b){
        var ticBox = $(\"label input\", $(b))
        if( $(ticBox).is(':checked') ){
            var sidTmp = $(b).attr('search_id');
            var sid = sidTmp.trim();
            var pibTmp = sid.split(' ');
            var pibPpn = 0;
            if(pibTmp.length>0){
                jQuery.each(pibTmp, function(ii,bb){
                    pibPpn = bb
                })
            }
            total_pib += pibPpn*1
    ...
    $('#total_pib').html( addCommas(total_pib) );
}
            });
            </script>\n";
        ...
        //        $data .= "<tbody>";
        //        $data .= "<tr><td width='50%' style='border: solid #3c6f91 1px; white-space: nowrap; width: 1px;'>";
        //        $data .= "<div class='container-fluid'>";
        //        $data .= $strOnprog;
        //        $data .= $strOnprog_1;
        //        $data .= $strOnprog2_1;
        //        $data .= $strOnprog_11;
        //        $data .= "</div class='container-fluid'>";
        //        $data .= "</td><td width='50%' style='border: solid #3c6f91 1px; white-space: nowrap; width: 1px;'>";
        //        $data .= "<div class='container-fluid'>";
        //        $data .= $strOnprog2;
        //        $data .= $strOnprog2_11;
        //        $data .= "</div class='container-fluid'>";
        ...
        $data .= "<div class='row'>";
        $data .= "<div style='padding-left: 7.5px!important;padding-right: 5px!important;' class='col-lg-12'>";
        $data .= $strOnprog;
        ...
        $data .= "</div>"; //col-md-6
        $data .= "</div>"; //col-md-6
        // $data .= "<div style='font-size: 23px;' class='col-md-12 bg-green'>PPN MASUKAN TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_masukan'>0</span></div>";
        $data .= "</div>"; //col-md-6
        ...
        $data .= $strOnprog2;
        // $data .= "<div class='row'>";
        // $data .= "<div style='font-size: 23px;' class='col-md-12 bg-blue'>PPN KELUARAN TERPILIH <span style='font-size: 30px;' class='text-bold pull-right' id='total_keluaran'>0</span></div>";
        // $data .= "</div>"; //col-md-6
        $data .= $strOnprog2_1;
        $data .= $strOnprog2_11;
        $data .= "</div>"; //col-md-6
...
//                if ($item == "itemsSrc" && count($arrayOnProgress[$item]) > 0) {
                if ($item == "itemsSrc") {
                    ...
                    $strOnprog .= "<caption class='ttext-uppercase ffa-2x bborder-cek'>";
                    $strOnprog .= "<span class='text-uppercase fa-2x'>PPN MASUKAN</span>";

                    if (isset($filterBulan) && $filterBulan == true) {
                        $bulan_masukan_v = isset($bulan_masukan) ? $bulan_masukan : date("Y-m");
                        $bulan_keluaran_v = isset($bulan_keluaran) ? $bulan_keluaran : date("Y-m");
                        $bulan_max_v = isset($bulan_keluaran_max) ? $bulan_keluaran_max : date("Y-m");
                        $filter_tipe_v = isset($filterBulanTipe) ? $filterBulanTipe : "combo";

                        switch ($filter_tipe_v) {
                            case "button":
                                if (isset($bulanMundur) && is_array($bulanMundur)) {
                                    $strOnprog .= "<span class='pull-right fa-2x'>Pilih Bulan disini: ";
                                    foreach ($bulanMundur as $bln) {
                                        $tanda = ($bln == $bulan_masukan_v) ? "btn-success" : "btn-info";
                                        $bulan_f = formatBulan($bln);
                                        $strOnprog .= "<input id='month_masukan' class='btn $tanda' type='button' name='month_masukan' 
                                        value='$bulan_f' placeholder='pilih bulan/tahun' 
                                        onclick=\"loadPaging('$link_kembali&step=1&date_keluaran=$bulan_keluaran_v&date_masukan=$bln', 'undoneList');\">";
                                    }
                                    $strOnprog .= "</span>";
                                }
                                break;
                            case "combo":
                                $strOnprog .= "<span class='pull-right fa-2x'>Pilih Bulan disini: ";
                                $strOnprog .= "<input id='month_masukan' type='month' name='month_masukan' max='$bulan_max_v'
                                    value='$bulan_masukan_v' placeholder='pilih bulan/tahun' 
                                    onchange=\"loadPaging('$link_kembali&step=1&date_keluaran=$bulan_keluaran_v&date_masukan='+this.value, 'undoneList');\">";
                                $strOnprog .= "</span>";
                                break;
                        }
                    }
                    ...
                    if (count($itemsDetails) > 0) {
                        ...
                        foreach ($itemsDetails as $key => $val) {
                            ...
                            $checked = array_key_exists($trid, $refItemSrc) ? "checked" : "";
                            ...
                            if (sizeof($arrayProgressLabels['itemsSrc']) > 0) {
                                ...
                                foreach ($arrayProgressLabels['itemsSrc'] as $key => $label) {
                                    ...
                                    if (isset($defaultItemTrgEditable) && in_array($key, $defaultItemTrgEditable)) {
                                        ...
                                        $addEvent = "onblur=\"top.$('#result').load('$updateItemFieldTarget?id=$pymSrcID&key=$key&val='+this.value)\"";
                                        //                                    $strOnprog .= "<input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent>";
                                        $strOnprog .= "<td line='" . __LINE__ . "' style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'>
                                    <input title='entry/edit e-faktur' placeholder='entry/edit e-faktur' type=$inputType name='$key" . "_" . "$nop' style='width: 100%;height: 26px; padding: 1px 1px !important; font-size: 12px;' class='form-control text-right text-bold' value='" . $val[$key] . "' onclick='this.select()' $addEvent>
                                    </td>";
                                        //                                    $strOnprog .="$ie";
                                    }
                                    else {
                                        //                                    $strOnprog .="$ie";
                                        $newVal = $key == "extern_date2" && $val[$key] == "0000-00-00" ? "<span class='text-red'>no-date</span>" : formatField_he_format($key, $val[$key]);
                                        $strOnprog .= "<td line='" . __LINE__ . "' data-order='" . $val[$key] . "'style='padding: 3px;vertical-align: middle;'>
                                                   <span class='' style='' thisval='" . $val[$key] . "' title='$key'>" . $newVal . "</span>
                                                   </td>";
                            ...
                            $strOnprog .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' data-order='" . $val[$key] . "'>
                                            <div name='ppn_masukan_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                                <label class=''><input class='chRadio ppn_masukan' title='tic untuk memilih' type=checkbox $checked $checkDisabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label>
                                            </div>
                                        </td>";
                            $strOnprog .= "</tr>";
                            $ie++;
...
//                        $('.ppn_pib').DataTable().columns.adjust().draw();
                ...
                elseif ($item == "itemsSrc2" && count($arrayOnProgress[$item]) > 0) {
                    ...
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $strOnprog_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;' class='text-center'>$ie</td>";
...
//                                    fixedHeader: true,        
                ...
                elseif ($item == "itemsSrc4" && count($arrayOnProgress[$item]) > 0) {
//arrPrint($arrayOnProgress[$item]);
                    $strOnprog_11 .= "<div class='row'>";
                    $strOnprog_11 .= "<div style='padding-right: 7.5px!important;' class='col-lg-12'>";
                    $strOnprog_11 .= "<div class='box box-solid box-success'>";
                    //                    $strOnprog_11 .= "<div class='box-header'><h3>PPN MASUKAN</h3></div>";
                    $strOnprog_11 .= "<div class='box-body'>";
                    $strOnprog_11 .= "<table class='table table-borderedd ppn_masukan_dtp_tbl_11 display' style='font-size: 11px;'>";
                    $strOnprog_11 .= "<caption class='text-uppercase fa-2x'>PAJAK DITANGGUNG PEMERINTAH(INSENTIF)</caption>";
                    $selectedProcessor = $selectProcessor['itemsSrc4'];
                    $nop = 0;

                    //bagian header
                    $strOnprog_11 .= "<thead class='text-bold text-uppercase text-center'>";
                    $colspan1 = count($arrayProgressLabels["itemsSrc4"]) + 2;

                    $strOnprog_11 .= "<tr>";
                    $strOnprog_11 .= "<th class='no-padding'>No</th>";
                    foreach ($arrayProgressLabels["itemsSrc4"] as $key => $label) {
                        $strOnprog_11 .= "<th class='no-padding'>$label</th>";
                    }
                    $strOnprog_11 .= "<th class='no-padding'>pilih</th>";
                    $strOnprog_11 .= "</tr>";
...
//                    arrPrintwebs($itemsDetails);
                    foreach ($itemsDetails as $key => $val) {
                        ...
                        $searching = "";
                        if (sizeof($arrayProgressLabels['itemsSrc4']) > 0) {
                            foreach ($arrayProgressLabels['itemsSrc4'] as $key => $label) {
                                $searching .= $val[$key] . " ";
                            }
                        }
                        ...
                        $strOnprog_11 .= "<td style='padding: 3px;text-align: center; vertical-align: middle;'>
                                            <div name='ppn_dtp_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
                                                <label class=''><input class='chRadio' title='tic untuk memilih' type=checkbox $checked $disabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' id='opt" . $val['transaksi_id'] . "' onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?$qstr&state='+this.checked;\"></label>
                                            </div>
                                        </td>";
                        //                        $strOnprog_11 .="<td style='padding: 3px;'>$ie</td>";
                    ...
                    $strOnprog_11 .= "
                            <script>
                                $('.ppn_masukan_dtp_tbl_11').DataTable({
                                    pageLength: -1,
                                    lengthmenu: [[ 10, 25, 50, -1 ], [10, 25, 50, 'All']],
                                    paging: false,
                                    searching: true,
...
//                elseif ($item == "items" && count($arrayOnProgress[$item]) > 0) {
                elseif (($item == "items")) {
                    ...
                    $strOnprog2 .= "<caption class='ttext-uppercase ffa-2x bborder-cek'>";
                    $strOnprog2 .= "<span class='text-uppercase fa-2x'>PPN KELUARAN</span>";

                    // START OF COMPLETE REPEATED LOGIC
                    if ($filterBulan == true) {
                        $bulan_masukan_v2 = isset($bulan_masukan) ? $bulan_masukan : date("Y-m");
                        switch ($filterBulanTipe) {
                            case "button":
//                                arrPrint($bulanMundur);
                                $strOnprog2 .= "<span class='pull-right fa-2x'>Pilih Bulan disini: ";
                                foreach ($bulanMundur as $bln) {
                                    $tanda = ($bln == $bulan_keluaran) ? "btn-success" : "btn-info";
                                    $bulan_keluaran_f = formatBulan($bln);
                                    $strOnprog2 .= "<input id='month_keluaran' class='btn $tanda' type='button' name='month_keluaran' 
                                    value='$bulan_keluaran_f' placeholder='pilih bulan/tahun' 
                                    onclick=\"loadPaging('$link_kembali&step=1&date_masukan=$bulan_masukan_v2&date_keluaran=$bln', 'undoneList');\">";
                                }
                                $strOnprog2 .= "</span>";
                                break;
                            case "combo":
                                $strOnprog2 .= "<span class='pull-right fa-2x'>Pilih Bulan disini: ";
                                $strOnprog2 .= "<input id='month_keluaran' type='month' name='month_keluaran' max='$bulan_keluaran_max'
                                    value='$bulan_keluaran' placeholder='pilih bulan/tahun' 
                                    onchange=\"loadPaging('$link_kembali&step=1&date_masukan=$bulan_masukan_v2&date_keluaran='+this.value, 'undoneList');\">";
                                $strOnprog2 .= "</span>";
                                break;
                        }
                    }
                    ...
                    if (count($itemsDetails) > 0) {
                        foreach ($itemsDetails as $key => $val) {
                            ...
                            foreach ($qstrLabels as $key => $label) {
                                // $qstr .= "&$key=" . urlencode($val[$key]);
                                $qstr .= "&$key=" . blobEncode($val[$key]);
                            }
                            $trid = $val['transaksi_id'];
                            $checked = array_key_exists($trid, $refItems) ? "checked" : "";
                            $disabled = "";
    ...
    <div name='ppn_keluaran_search' search_id='$searching' style='white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'>
    <label class=''>
    <input class='chRadio' type=checkbox $checked $checkDisabled $disabledLockerTransaksi value='" . $val['transaksi_id'] . "' name='" . $val['extern2_nama'] . "' id='opt" . $val['id'] . "' 
    onclick=\"document.getElementById('result').src='$selectedProcessor/$jenisTr" . "?1=1$qstr&state='+this.checked;\"></label></div></td>";
...
//                        $('.ppn_bendahara_negara').DataTable().columns.adjust().draw();
        ...
        $jmlItems = count($refItems);
        $strOnprog3 .= "\n
        <script>
            var targetNode = document.getElementById('shopping_cart');
            ...
            function updateTotals() {
                calculateTotal('div[name=ppn_masukan_search]', '#total_masukan');
                calculateTotal('div[name=ppn_keluaran_search]', '#total_keluaran');
                calculateTotal('div[name=ppn_bendahara_negara_search]', '#total_bendahara');
                calculateTotal('div[name=ppn_pib_search]', '#total_pib');
            }
        
            function calculateTotal(selector, outputId) {
                let total = 0;
                $(selector).each(function () {
                    let input = $('label input', this);
                    if (input.is(':checked')) {
                        let sid = $(this).attr('search_id')?.trim();
                        if (sid) {
                            let values = sid.split(' ').map(Number);
                            total += values.length > 0 ? values[values.length - 1] : 0;
                        }
                    }
                });
                
                $(outputId).html(addCommas(total));
            }
        
            function shoppingCart() {
              if(top.document.getElementById('shopping_cart')){
                    top.$('#shopping_cart').load('$viewCart');
                }
            }
...
//            }
    ...
    case "selectPaymentExternSrcValas":
        $title = isset($title) ? $title : "";
        $subTitle = isset($subTitle) ? $subTitle : "";
        $arrayHistoryLabels = isset($arrayHistoryLabels) ? $arrayHistoryLabels : array();
        $arrayHistory = isset($arrayHistory) ? $arrayHistory : array();
        ...
        $strContent .= "<div class='box box-solid box-danger'>";
        $strContent .= "<div class='box-header with-border text-uppercase'>";
        $strContent .= "<h4 class='box-title'><span class=\"glyphicon glyphicon-flash blink\"></span> on-going transactions $labelOngoingValas</h4>";
        ...
        if (sizeof($items) > 0) {
            ...
            //                                <div id=\"external_filter_container\"></div>
            //                            </div>";
            $strContent .= "<table id='pembayaranValas' class='table display'>";
            $strContent .= "<thead>";
            $strContent .= "<tr bgcolor='#f0f0f0'>";
            if (sizeof($itemLabels) > 0) {
                $strContent .= "<td class='text-muted text-right'>";
            ...
            $strContent .= "<script>
                    $(document).ready( function(){
                        var table = $('#pembayaranValas').DataTable({
                            dom: 'lBfrtip',
                            fixedHeader: true,
                            lengthMenu: [ [10, 20, 50, 100, -1], [10, 20, 50, 100, 'All'] ],
                            pageLength: -1,
