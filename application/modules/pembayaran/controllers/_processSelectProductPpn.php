...
//        }
    ...
    public function select()
    {
        ...
        if (sizeof($_SESSION[$cCode]['main']) > 0) {
            ...
            unset($_SESSION[$cCode]['main_elements'][$helpName]);
        ...
        if (isset($_SESSION[$cCode]['items'])) {
            ...
            if($ppn==1){
                $pphjenis = "1";//pph23 lihat MdlPphMetodeSewa
                $pph_tarif = 2;

            }
            else{
                $pphjenis = "2";//pphps4ayat2
                $pph_tarif = 10;
            }
            ...
            if (isset($_SESSION[$cCode]['main'])) {
                ...
                $_SESSION[$cCode]['main']["pphjenis"] = $pphjenis;
                $_SESSION[$cCode]['main']["pphjenis"] = $pphjenis;
                $_SESSION[$cCode]['main']["pph_tarif"] = $pph_tarif;
            }
