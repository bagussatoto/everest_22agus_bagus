        ...
        if (sizeof($steps) > 1) {
            ...
            foreach ($steps as $tStep => $stepData) {
                ...
                if (($tStep == 1) && ($gunggungFieldsView == true)) {
                    $isiBadge = isset($arrayOnprogressGroupNonNpwp[$tStep]) ? "<span class='badge bg-red'>" . sizeof($arrayOnprogressGroupNonNpwp[$tStep]) . "</span>" : "";
...
//            cekHere("[$entry_faktur_masal]");
            ...
            if (count($steps) == $stepper) {
                ...
                foreach ($item_data as $key => $val) {
                    ...
                    //----------------------
//                    $background_color = isset($arrayOnprogressMarking[$key]['style']) ? $arrayOnprogressMarking[$key]['style'] : "";
                    $background_color = isset($arrayOnprogressGunggungMark[$key]['style']) ? $arrayOnprogressGunggungMark[$key]['style'] : "";
//                    arrPrintCyan($val);
                    $no++;
...
//                                            },
                                            ...
                                            rowCallback: function(row, data, index) {
                                                ...
                                                if(data[3].value!=''){
                                                    $(row).addClass('bg-gray').css('opacity', 0.5).attr('title','anda bisa merubah data NPWP di data konsumen jika NPWP salah, jika NPWP benar, maka faktur untuk transaksi ini bisa di tindak lanjut melalui menu PreEFaktur pada tab sebelah kiri.');
                                                }
...
//                                                    $('.floating-box-static-bottom').html(strInputFaktur);
                                        ...
                                        function checkNext(e){
                                            ...
                                            if(er>0){
                                                ...
                                                top.$.get(urlFollowUpMulti, function(a){
                                                    console.log('urlFollowUpMulti: '+urlFollowUpMulti)
                                                }, 5000)
                                                //lanjutkan jika info E-Faktur sudah lengkap
                                                top.location.reload();
                                                      }
                                                });
