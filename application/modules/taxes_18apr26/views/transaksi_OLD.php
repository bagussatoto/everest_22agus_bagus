        ...
        if ((isset($items) && sizeof($items) > 0) || (isset($items2) && sizeof($items2) > 0)) {
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                if (isset($xShipmentBtn['targetUrl']) && $xShipmentBtn['targetUrl'] != "") {
                    ...
                    $btnStyle = "class='btn btn-danger' style='border:1px #d4251c solid;color:#ffffff;'";
                    $btnWarning = $xShipmentBtn['warning'];
                    $actionTarget = $xShipmentBtn['targetUrl'];
                    $btnLabel = "<span class='fa fa-remove'></span> " .$xShipmentBtn['label'];
                    // ----------------------------------
                    echo "<button type='button' $btnStyle onclick=\"confirm_alert_result('Peringatan','$btnWarning','$actionTarget');this.disabled=true;\">$btnLabel</button>";
                }
