                    ...
                    $(document).ready( function(){
                        var table = $('#table_history_$segmenUriEnc').DataTable({
                            ...
                            footerCallback: function ( row, data, start, end, display ) {
                                ...
                                top.$('span.overlay').addClass('hidden')
                            });
                    </script>";
    ...
    case "showData":
        ...
        if (isset($stepLabels) && sizeof($stepLabels) > 0) {
            ...
            foreach ($stepLabels as $step => $label) {
                ...
                $varUrl = $steps[$step]['target'] == $currentState ? "javascript:void(0);" : "if($('#historyList>div.box-body')){ $('#historyList>div.box-body').append(`<div id='overlay_history'><div id='text'>Loading Content...</div></div>`); document.getElementById('overlay_history').style.display = 'block'; $('#historyList').load('$linkStep'); }else{ console.log('tidak ada container undoneList'); }";
...
//            $content .= "<form name='fSelect'>";
        ...
        $content .= "<script>
                    $(document).ready( function(){
                        ...
                        top.$('span.overlay').addClass('hidden');
                        top.$('div#overlay').css('display', 'none');
                        top.$('div#overlay_history').css('display', 'none');
                    </script>";
