...
//                $this->db->where_in("produk_id", $prodIds);
            ...
            // arrPrint($selectorSrcParamFields);
            // matiHEre();
            $tmpP = array();
            if(sizeof($selectorSrcParamFields)>0){
...
//         cekKuning($selectorView);
    ...
    public function selectItem3()
    {
        ...
        $selectorModel = isset($this->configUi[$jenisTr]['selectorModel3']) ? $this->configUi[$jenisTr]['selectorModel3'] : "MdlProduk";
        $selectorSrcModel = isset($this->configUi[$jenisTr]['selectorSrcModel3']) ? $this->configUi[$jenisTr]['selectorSrcModel3'] : "MdlProduk";
...
//        cekmerah($this->db->last_query());
        ...
        if (sizeof($tmpO) > 0) {
            $processor = $this->modulPath . $this->configUi[$jenisTr]['selectorProcessor3'] . "/$jenisTr";
...
//        arrprint($data);die();
    ...
    public function selectItem4()
    {
        ...
        $selectorModel = isset($this->configUi[$jenisTr]['selectorModel4']) ? $this->configUi[$jenisTr]['selectorModel4'] : "MdlProduk";
        $selectorSrcModel = isset($this->configUi[$jenisTr]['selectorSrcModel4']) ? $this->configUi[$jenisTr]['selectorSrcModel4'] : "MdlProduk";
...
//        cekmerah($this->db->last_query());
        ...
        if (sizeof($tmpO) > 0) {
            $processor = $this->modulPath . $this->configUi[$jenisTr]['selectorProcessor4'] . "/$jenisTr";
