...
//                                    break;
                                ...
                                case "items3"://
                                    $items3Registries = unserialize(base64_decode($row->$param));
                                    break;
                                case "items3_sum"://
                                ...
                                case "items4"://
                                    $items4Registries = unserialize(base64_decode($row->$param));
                                    break;
                                case "items4_sum"://
...
//        arrPrint($globalVars);
        ...
        $data = array(
            ...
            "items4" => $items4Registries,
            "customLeftElements" => $items4Registries,
            "customRightElements" => $items4Registries,
        );
        //endregion
