...
//        "modul" => "distribusijasa",
        ...
        "steps" => array(
//            1 => array(
//                "label" => "SERVICE PROJECT DISTRIBUTION",
...
//        ),
        ...
        "connectToEdit" => array(
            1 => array(
                "enabled" => true,
                "connectTo" => "3461re",
                "label" => "EDIT SERVICE PROJECT DISTRIBUTION",
            ),
        ),
        "connectToReject" => array(
            1 => array(
                "enabled" => true,
                "connectTo" => "3461rrj",
                "label" => "REJECT SERVICE PROJECT DISTRIBUTION",
            ),
        ),
    ),
    "3465" => array(
//        "modul" => "distribusijasa",
        "icon" => "fa fa-cart-arrow-down",
        "label" => "reception distribution service project",
        "place" => "branch",
        "steps" => array(
            1 => array(
                "label" => "SERVICE PROJECT DISTRIBUTION",
            ...
            2 => array(
                "label" => "RECEIVE SERVICE PROJECT DISTRIBUTION",
                "actionLabel" => "receive",
                "source" => "3465r",
                "target" => "3465",
                "userGroup" => "o_project",
