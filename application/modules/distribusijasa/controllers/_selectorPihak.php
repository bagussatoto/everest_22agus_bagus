...
//arrPrintPink($items);
    ...
    public function selectPihakExtern()
    {
        ...
        $pihakAddStaticEntry = isset($this->configUi[$jenisTr]['pihakAddStaticEntry']) ? $this->configUi[$jenisTr]['pihakAddStaticEntry'] : array();
        $pihakExternViewedFields = isset($this->configUi[$jenisTr]['pihakExternViewedFields']) ? $this->configUi[$jenisTr]['pihakExternViewedFields'] : array();
...
//        cekPink(sizeof($tmpO));
        //        arrPrint($tmpO);
//
        $processor = base_url() . $this->modul . "/" . $this->configUi[$jenisTr]['pihakExternProcessor'] . "/" . "$jenisTr/" . $this->configUi[$jenisTr]['pihakModelExtern'];
        if (sizeof($tmpO) > 0) {
            foreach ($tmpO as $row) {
                ...
                if (strlen($tmpName) > 1) {
                    ...
                    if (sizeof($pihakExternViewedFields) > 0) {
