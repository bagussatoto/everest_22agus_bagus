        ...
        if ((isset($items) && sizeof($items) > 0) || (isset($items2) && sizeof($items2) > 0)) {
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                foreach ($items as $id => $iSpec) {
                    ...
                    $faktur = "";
                    if (isset($shopingCartFakturItems) && (count($shopingCartFakturItems) > 0)) {
                        if (isset($showFormulirFaktur[$id]) && ($showFormulirFaktur[$id] == true)) {
...
//
//
                                                $value = "<span cclass='form-control no-border no-shadow'>" . formatField($fff, $fSpec[$fff]) . "</span>";
                                                $faktur .= "<td ids='td_$fff'>$value";
