    ...
    var arrProduk = JSON.parse(localStorage.getItem('items'));
        ...
        $p->addTags(
            array(
                ...
                "add_pihak_project"                      => $addPihakStrProject,
...
// arrPrintHijau($_GET);
        ...
        if (sizeof($arrayOnProgress) > 0) {
            ...
            if ($isMobile == true & $stepper == 2) {
                ...
                foreach ($arrayOnProgress as $key => $val) {
                    ...
                    $strOnprogMbl .= "<p>" . $val['customers_nama'] . "</p>";
                    $strOnprogMbl .= "</div>";
        ...
        /*--------versi mobile--------*/
        if($isMobile == true & $stepper == 2){
            $str = "<div class='text-uppercase'><h3>pre packing list</h3></div>";
            $str .= $strOnprogMbl;
        }
        echo $str;
        break;
