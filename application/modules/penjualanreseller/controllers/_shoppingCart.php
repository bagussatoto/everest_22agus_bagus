...
//        $this->jenisTr = $this->uri->segment(3);
        ...
        $itemSubNumLabels = isset($this->configUi[$this->jenisTr]['shoppingCartSubNumFields'][$stepNumber]) ? $this->configUi[$this->jenisTr]['shoppingCartSubNumFields'][$stepNumber] : array();
        ...
        if (isset($_SESSION[$cCode])) {
            ...
            if (isset($_SESSION[$cCode]['items'])) {
                ...
                foreach ($_SESSION[$cCode]['items'] as $id => $iSpec) {
                    ...
                    // $tmp['subtotal'] = isset($iSpec['subtotal']) ? $iSpec['subtotal_dropshiper'] : 0;
                    ...
                    // $tmp['subtotal'] = isset($iSpec['subtotal']) ? $iSpec['subtotal']."8888" : 0;
...
//                            $main[$key] = $valItem;
        ...
        * ---------------------------------------------------------------------------------*/
        ...
        if (isset($_SESSION[$cCode]['main']['pihakLevel'])) {
            ...
            $pihakLevelNama = isset($data_mains['pihakLevelNama']) ? $data_mains['pihakLevelNama'] : "";
...
//                "dtime" => "date",
    ...
    public function fetchElement()
    {
        ...
        $ppnFactor = isset($_SESSION[$cCode]["main"]["ppnFactor"]) ? $_SESSION[$cCode]["main"]["ppnFactor"] : matiHEre("gagal emdapatakan data ppn, silahkan relogin untuk membersihkan sesi atau ubah qty produk");
        $stepNum = 1;
