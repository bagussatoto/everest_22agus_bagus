...
//showLast_query("biru");
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main']['pihakResellerID'] = $id;
            // $_SESSION[$cCode]['main']['pihakLevel'] = $tmpB[0]->level_id;
            $_SESSION[$cCode]['main']['pihakResellerName'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            $_SESSION[$cCode]['main']['pihakResellerName2'] = isset($tmpB[0]->$selectColumn) ? formatNota($selectColumn, $tmpB[0]->$selectColumn) : "";
//            $_SESSION[$cCode]['main']['pihakResellerDisc'] = isset($tmpB[0]->diskon) ? $tmpB[0]->diskon : "";
