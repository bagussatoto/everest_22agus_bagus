...
//                 matiHere(__LINE__ . " " .__METHOD__);
                ...
                cekBiru("masuk ke diskon2an:: $pro_premi || $pro_harga @" . __LINE__);
    ...
    private function selectorDiskon($produk_id, $produk_harga, $produk_jml)
    {
        ...
        $calc_hasil = $dp->calcDiskon($pro_harga, $diskon_pokok, $diskon_event, "diskon");
