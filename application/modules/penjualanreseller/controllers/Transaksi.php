...
//                            if ((my_cabang_id() == CB_ID_PUSAT) && ($spec['cabang_id'] == CB_ID_PUSAT)) {
                ...
                if ($allowFollowup) {
                    ...
                    $tmp['action'] = "<div class='input-group'>";
                    $tmp['action'] .= "<button class='btn btn-block $class_button' title='turn this entry into $stepLabel' 
                                $disabled_button $disabled_button_kreditlimit 
