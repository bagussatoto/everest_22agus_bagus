...
//                    $advanceAmountItemsLabel = isset($receiptAdvanceAmountValue[$key_result][$stepNumber]) ? $receiptAdvanceAmountValue[$key_result][$stepNumber] : array();
                    ...
                    $receiptAdvanceItemsLabel[$id] = $advanceItemsLabel + $advanceNumItemsLabel + array("subtotal" => "total price");
                    $receiptAdvanceSubItemsLabel[$id] = $advanceSubItemsLabel + $advanceSubNumItemsLabel + array("subtotal" => "subtotal");
                    $receiptAdvanceNumType[$id] = $advanceSubNumItemsLabel + array("subtotal" => "subtotal");
