...
//                                        cekHere($eKey);
        ...
        if ((isset($items) && sizeof($items) > 0) || (isset($items2) && sizeof($items2) > 0)) {
            ...
            if (isset($items) && sizeof($items) > 0) {
                ...
                $contentStr .= "<table class='table dataTable compact table-bordered table-condensed table-hover display' style='width: 100%;'>";
                $contentStr .= "<thead>";
                ...
                // normalize total columns (1 for No. + item label columns)
                $totalCols = 1 + sizeof($itemLabels);

                if (isset($sumRows) && sizeof($sumRows) > 0) {
                    // print 'In Words' as a full-width row if present
                    if (strlen($inWord) > 5) {
                        $contentStr .= "<tr>";
                        $contentStr .= "<td style='vertical-align: bottom;' colspan='".$totalCols."' class='text-left'>In Words :<br> <span class='text-bold text-uppercase'>$inWord</span></td>";
                        $contentStr .= "</tr>";
                    }
                    foreach ($sumRows as $key => $label) {
                        if (isset($mainValues[$key])) {
                            if ($mainValues[$key] > 0) {
                                $contentStr .= "<tr>";
                                $contentStr .= "<td colspan='".($totalCols - 1)."' class='text-right'>$label</td>";
            ...
            if (isset($items5) && sizeof($items5) > 0) {
                ...
                // $contentStr .=  "<div class='table-responsive no-padding no-border border-cek overflow-h'>";
                ...
                $contentStr .=  "<caption class='text-bold text-red'>PILIH PADA DAFTAR PEKERJAAN DIBAWAH INI SEBAGAI KOMPONEN DASAR PENAGIHAN</caption>";

                if (count($itemLabels5)*1>0 && is_array($itemLabels5)) {
                    //region header table anakan
                    $contentStr .=  "<thead>";
                    $contentStr .=  "<tr>";
                    $contentStr .=  "<td class='text-muted bg-grey-1 text-center'>";
                    $contentStr .=  "No";
                    $contentStr .=  "</td>";
                    foreach ($itemLabels5 as $key => $label) {
                        $contentStr .=  "<td class='text-muted bg-grey-1 text-center text-capitalize'>";
                        $contentStr .=  $label . "";
                        $contentStr .=  "</td>";
                    }
                    $contentStr .=  "</tr>";
...
//            arrPrint($items5);
                ...
                foreach ($items5 as $iSpec) {
                    ...
                    foreach($itemLabels5 as $key=>$label){
                        ...
                        //endregion
                        $contentStr .=  "<td class='$cAlign'>";
                        $tabIndexNum = $colCtr . $no;
                        if (is_numeric($iSpec[$key])) {
                            $contentStr .=  str_replace('.00', '', number_format($iSpec[$key], 2));
                        }
                        else {
                            if(is_array($iSpec[$key])){
                                ...
                                $contentStr .=  "<table width='100%' class=''>";
                                $total_rp = 0;
                                if(isset($isProduk['produk'])){
                                    foreach($isProduk['produk'] as $ky => $prdData){
                                        ...
                                        $contentStr .=  "<tr class='text-meta text-bold'>";
                                        $contentStr .=  "<td>".$prdData['produk_dasar_nama']."</td>";
                                        $contentStr .=  "<td class='text-bold'>".$prdData['jml']."x</td>";
                                        $contentStr .=  "<td class='text-right'>@".number_format($prdData['harga'])."</td>";
                                        $contentStr .=  "<td>&nbsp; $qtyLebih</td>";
                                        $contentStr .=  "<td>&nbsp;</td>";
                                        $contentStr .=  "<td class='text-right'><span class='pull-left'>Rp.</span>".number_format($prdData['saldo'])."</td>";
                                        $contentStr .=  "</tr>";
                                ...
                                if(isset($isProduk['biaya'])){
                                    foreach($isProduk['biaya'] as $ky => $prdData){
                                        ...
                                        $contentStr .=  "<td>".$prdData['produk_dasar_nama']."</td>";
                                        $contentStr .=  "<td class='text-bold'>".$prdData['jml']."x</td>";
                                        $contentStr .=  "<td class='text-right'>@".number_format($prdData['nilai'])."</td>";
                                        $contentStr .=  "<td>&nbsp;</td>";
                                        $contentStr .=  "<td>&nbsp;</td>";
                                        $contentStr .=  "<td class='text-right'><span class='pull-left'>Rp.</span>".number_format($prdData['saldo'])."</td>";
                                        $contentStr .=  "</tr>";
                                ...
                                $contentStr .=  "<tr class='text-purple text-bold'>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;' class='text-bold'>&nbsp;</td>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;'>&nbsp;</td>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;' class='text-right'>&nbsp;</td>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;'>&nbsp;</td>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;'>&nbsp;</td>";
                                $contentStr .=  "<td style='border-top: 1px solid gray;' class='text-right'><span class='pull-left'>Rp.</span>".number_format($total_rp)."</td>";
                                $contentStr .=  "</tr>";

                                $contentStr .=  "</table>";
                            }
                            else{
                                $contentStr .=  $iSpec[$key];
                            }
                        }
                        $contentStr .=  "</td>";
                    }
                ...
                $contentStr .=  "<td class=''>&nbsp;</td>";
                $contentStr .=  "<td class=''>&nbsp;</td>";
                $contentStr .=  "<td class='text-right valign-m text-uppercase'>".number_format($hrg5)."</td>";

//                $contentStr .=  "<td class=''>&nbsp;</td>";
//                $contentStr .=  "<td class='text-right valign-m text-uppercase'>".number_format($bobot_wo5, 2)."%</td>";
//                $contentStr .=  "<td class=''>&nbsp;</td>";
...
//                                    $elementStr .= $colLabel!="" ? "<td style='width: 1em;white-space: nowrap;vertical-align: top;'>$colLabel</td><td style='width: 1em;white-space: nowrap;vertical-align: top;'> : </td><td style='vertical-align: top;' class='text-uppercase'>$val</td>" : "<td colspan='3'>$val</td>";
        ...
        if ((isset($items) && sizeof($items) > 0) || (isset($items2) && sizeof($items2) > 0)) {
            ...
            if (isset($items) && sizeof($items) > 0 && sizeof($items5) == 0) {
                $contentStr .= "<div class='table-responsivez' style='border:0px solid red;'>";
                $contentStr .= "<table class='table dataTable compact table-bordered table-condensed table-hover display' style='width: 100%;'>";
                $contentStr .= "<thead>";
                $contentStr .= "<tr bgcolor='#f5f5f5'>";
                $contentStr .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>No.</th>";
                ...
                $totalCols = 1 + sizeof($itemLabels);
                if (strlen($inWord) > 5) {
                    $rowspan = isset($sumRows) ? (sizeof($sumRows) + 1) : 1;
                    $labelColspan = $totalCols - 1; // label spans all but last column
                }
                else {
                    ...
                    if ( empty($items5) ) {
                        foreach ($sumRows as $key => $label) {
                            if (isset($mainValues[$key])) {
                                if ($mainValues[$key] > 0) {
                                    $contentStr .= "<tr>";
                                    $contentStr .= "<td colspan='" . $labelColspan . "' class='text-right'>$label</td>";
                                    $contentStr .= "<td class='text-right'>";
                                    if (isset($mainValues[$key])) {
                                        $contentStr .= formatField($key, round($mainValues[$key]));
                                    }
                        ...
                        if (strlen($inWord) > 5) {
                            $contentStr .= "<tr>";
                            $contentStr .= "<td style='vertical-align: bottom;' colspan='" . $labelColspan . "' rowspan='$rowspan' class='text-left'>In Words :<br> <span class='text-bold text-uppercase'>$inWord</span></td>";
                            $contentStr .= "</tr>";
                        }
                    }
                }
            ...
            // mode 1 nama WO dan nominal
            // mode 2 rincian material / jasa per WO
            // mode 3 summary material / jasa dan QTY
            // mode 4
...
//                                arrPrint($prdData);
                ...
                // =========================================================
                // Controller bisa mengirim $nilai_total_project (contoh: 100000000). Jika tidak, default 0 agar tidak error.
                $nilai_total_project        = isset($mainValues['projectNilai']) && $mainValues['projectNilai'] > 0 ? (float)$mainValues['projectNilai'] : 0;
                $uang_muka_dipakai_ppn      = isset($mainValues['uang_muka_dipakai_ppn']) && $mainValues['uang_muka_dipakai_ppn'] > 0 ? (float)$mainValues['uang_muka_dipakai_ppn'] : 0;
            ...
            if (isset($items2) && sizeof($items2) > 0) {
                $no = 0;
                $contentStr2 .= "<div class='table-responsivez' style='border:0px solid red;'>";
                $contentStr2 .= "<table class='table table-bordered table-condensed' style='width: 100%;'>";
                $contentStr2 .= "<tr bgcolor='#f5f5f5'>";
                $contentStr2 .= "<th class='text-muted' style='font-weight:bold;' align='right' width='5'>No.</th>";
                foreach ($itemLabels2 as $key => $label) {
...
//                $contenStr5 .= "</div>";
        ...
        // =========================================================================
        // TAMBAHAN: DROPDOWN PILIHAN OPSI CETAK TABEL (tampil hanya jika $items5 tidak kosong)
        // =========================================================================
