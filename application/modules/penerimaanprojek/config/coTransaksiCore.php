    ...
    "7499_ORI" => array(
        ...
        "tableIn" => array(
            ...
            "mainValues" => array(
                ...
                "ppn" => "ppn",
                "dpp_ppn" => "dpp_ppn",
                "ppn_belum_dibayar" => "ppn_belum_dibayar",
                "grand_ppn" => "grand_ppn",
                "new_net1" => "new_net1",
                "new_net3" => "new_net3",
                "dpp_pengganti" => "dpp_pengganti",
                "dpp_pengganti_factor" => "dpp_pengganti_factor",
                "piutang_usaha" => "piutang_usaha",
                "selisih_round" => "selisih_round",
...
//            "nilai_bayar" => "nilai_entry+totalCredit+nilai_biaya+(pph22_nilai+ppn_nilai_dibayar)+selisih_round-(deposit_konsumen+pendapatan_lain_lain)",
            ...
            "pph22_dan_ppn" => "pph22_nilai+ppn_nilai_dibayar",
            "deposit_dan_pendapatan" => "deposit_konsumen+pendapatan_lain_lain",
            "nilai_bayar_1" => "nilai_entry+totalCredit",
            "nilai_bayar_2" => "nilai_bayar_1+nilai_biaya",
            "nilai_bayar_3" => "nilai_bayar_2+pph22_dan_ppn",
            "nilai_bayar_4" => "nilai_bayar_3+selisih_round",
            "nilai_bayar" => "nilai_bayar_4-deposit_dan_pendapatan",


            // lebih bayar di switch by chepy 11-jan 2021
//            "lebih_bayar" => "(nilai_entry-nilai_biaya-pph22_nilai-ppn_nilai_dibayar)+totalCredit-nilai_round",
            "lebih_bayar_1" => "nilai_entry-nilai_biaya",
            "lebih_bayar_2" => "lebih_bayar_1-pph22_nilai",
            "lebih_bayar_3" => "lebih_bayar_2-ppn_nilai_dibayar",
            "lebih_bayar_4" => "lebih_bayar_3+totalCredit",
            "lebih_bayar" => "lebih_bayar_4-nilai_round",
        ...
        "additionalMainBuilders" => array(//==main
            ...
            "nilai_sisa" => "nilai_round-totalCredit-nilai_biaya",
//            "new_sisa" => "((selisih_round*-1)+sisa)-(nilai_entry+totalCredit+pph22_nilai+ppn_nilai_dibayar)",
            "new_sisa_penambah_1" => "selisih_round*-1",
            "new_sisa_penambah" => "new_sisa_penambah_1+sisa",
            "new_sisa_pengurang_1" => "nilai_entry+totalCredit",
            "new_sisa_pengurang_2" => "new_sisa_pengurang_1+pph22_nilai",
            "new_sisa_pengurang" => "new_sisa_pengurang_2+ppn_nilai_dibayar",
            "new_sisa" => "new_sisa_penambah-new_sisa_pengurang",
        ),
...
//            ),
        ...
        "valueBuilders" => array(
            ...
            "amount" => "sisa",
            "dpp_ppn" => "nilai_entry-uang_muka_dipakai_ppn",
            "dpp_pengganti" => "dpp_ppn*(11/12)",
            "dpp_pengganti_factor" => "11/12",
            "ppn" => "(12/100)*dpp_pengganti",// ppn bisa 0 jika ada uang muka+ppn belum habis
            "penjualan" => "nilai_entry",
            "penjualan_bulat" => "nilai_entry",
            "grand_total" => "nilai_entry",

            "ppn_belum_dibayar" => "ppn-uang_muka_npajak_dipakai",// ini ppn dari uang muka per-project

            "grand_ppn" => "ppn",
            "new_net1" => "nilai_entry",
            "new_net3" => "dpp_ppn+ppn",// bisa hanya dpp_ppn jika ada uang muka+ppn belum habis
            "tagihan" => "dpp_ppn+ppn",// bisa hanya dpp_ppn jika ada uang muka+ppn belum habis
            "grand_total_ui" => "nilai_entry",
            "piutang_usaha" => "dpp_ppn+ppn_belum_dibayar",
        ),
        //-------------------
//        "injectorPajak" => array(
...
//                            "2030060" => "ppn",// ppn out
//
                            "2010050" => "-uang_muka_dipakai_ppn",// hutang ke konsumen

                            "4030" => "-new_net3", // penjualan kontijensi
                            "4010" => "penjualan_bulat",// penjualan
                            "2030060" => "ppn_belum_dibayar",// ppn out

                            "1010020010" => "piutang_usaha", // piutang usaha
...
//                        "transaksi_no" => "nomer",
                    ...
                    array(
                        ...
                        "loop" => array(
                            "2030060" => "-uang_muka_npajak_dipakai",// ppn keluaran belum ada faktur
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => "projectID",// project
                            "extern_nama" => "projectName",
                            "extern2_id" => "pihakID",// konsumen
