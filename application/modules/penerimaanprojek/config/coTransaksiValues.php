...
//                        "comName" => "Jurnal",
//                        "loop" => array(
////                            "hutang valas ke konsumen" => "-creditAmount",
//                            "piutang valas" => "-nilai_bayar_change",
//                            "valas" => "nilai_bayar_change",
//                        ),
//                        "static" => array(
//                            "cabang_id" => "placeID",
//                            "jenis" => "jenisTr",
...
//                        "comName" => "Jurnal",
//                        "loop" => array(
//                            "hutang ke konsumen" => "-creditAmount",
//                            "piutang dagang jasa" => "-(creditAmount+nilai_entry+pph_23)",
//                            "kas" => "nilai_entry",
            ...
            "7488" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "020403" => "-(credit_note_dipakai+uang_muka_dipakai)",// hutang ke konsumen
                            "010101" => "nilai_cash",// kas
                            "010206" => "-nilai_dipakai_010206",// piutang retensi
                            "0602" => "nilai_biaya",// biaya usaha
                            "060400009" => "selisih_round",// selisih pembulatan
                            "01040100002" => "pph22_nilai",// pph22 dibayar dimuka
                            "01040100010" => "ppn_nilai_dibayar",// ppn dibayar bendahara negara
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "0701" => "pendapatan_lain_lain",// pendapatan lain_lain
                            "020403" => "deposit_konsumen",// hutang ke konsumen
                            "010101" => "deposit_konsumen+pendapatan_lain_lain",// kas
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "01040100002" => "-pph22_nilai",// pph22
                            "01040100010" => "-ppn_nilai_dibayar",// ppn dibayar bendahara negara
                            "020401" => "-(pph22_nilai+ppn_nilai_dibayar)",// hutang ke pusat
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
                    ...
                    array(
                        ...
                        "loop" => array(
                            "01040100010" => "ppn_nilai_dibayar",// ppn dibayar bendahara negara
                            "01040100002" => "pph22_nilai",// pph22
                            "010801" => "-(pph22_nilai+ppn_nilai_dibayar)",// piutang cabang
                        ),
                        "static" => array(
                            "cabang_id" => "-1",
                            "cabang_nama" => "PUSAT",
            ...
            "7499" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "010206" => "piutang_retensi",// piutang retensi
                            "010201" => "new_net3",// piutang dagang
                            "0403" => "penjualan",// penjualan projek
                            "020305" => "ppn",// ppn out
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
