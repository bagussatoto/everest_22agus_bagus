...
//            "diskon" => "discount",
    ...
    "7499" => array(
        ...
        "shortHistoryFields" => array(
            ...
            "referenceSO_Nomer__1" => array(
                "step" => 1,
                "key" => "nomer_reference_so",
                "label" => "SO number",
                "modul" => "master_project",
            ),
            "referenceSO_Nomer__2" => array(
                "step" => 2,
                "key" => "nomer_reference_so",
                "label" => "SOA number",
                "modul" => "master_project",
...
//                "noPrefetch" => false,
//                "pairMethod" => array(
//                    "recom" => "ReComUangMukaCustomer",
//                    "calculate" => array(
//                        "source" => "sisa",
//                        "target" => "uang_muka_dipakai_ppn",
//                        "pair_source" => "nilai_sisa", //sunbe sumber yang dibandingkan
//                    ),
//                ),
//            ),
...
//            ),
        ...
        "pairMakers" => array(
            1 => array(
                "ppn_um" => array(
                    "helperName" => "he_pair_ppn_uangmuka_project",
                    "functionName" => "cekPairPpnUangMukaProject",
                    "params" => array(
                        "cabang_id" => "placeID",
                        "extern_id" => "projectID",// project id
                        "extern2_id" => "pihakID",// customer id
                        "periode" => ".forever",
                        "rekening" => ".2030060",
                    ),
                ),
...
//                        "hideRow" => true,
                    ...
                    "uang_muka_npajak_dipakai" => array(
                        "label" => "ppn sudah dibayar (dari uang muka)",
                        "defaultValue" => "uang_muka_npajak_dipakai",
                        "keyPressAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1),
//                        "hideRow" => true,
                        "saldo" => "uang_muka_npajak_saldo",
                    ),
                    "ppn_belum_dibayar" => array(
                        "label" => "ppn belum dibayar (kekurangan)",
                        "defaultValue" => ".0",
                        "keyPressAction" => "",
                        'disabled' => "disabled",
                        "addPoints" => array(1),
