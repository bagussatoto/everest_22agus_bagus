    ...
    public function index()
    {
        ...
        foreach ($trTr as $row) {
            ...
            if (!isset($this->configUi[$this->jenisTr])) {
                ...
                if (isset($configUi)) $configUi[$this->jenisTr] = $this->configUi[$this->jenisTr];
            }
            if (!isset($this->configLayout[$this->jenisTr])) {
                ...
                if (isset($configLayout)) $configLayout[$this->jenisTr] = $this->configLayout[$this->jenisTr];
            }
            if (!isset($this->configCore[$this->jenisTr])) {
                ...
                if (isset($configCore)) $configCore[$this->jenisTr] = $this->configCore[$this->jenisTr];
            }
