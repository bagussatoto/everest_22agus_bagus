                        ...
                        if (isset($socketURL[$iSpec['id']]) && strlen($socketURL[$iSpec['id']]) > 3) {
                            ...
                            switch ($cCode) {
                                ...
                                case "_TR_461":
                                    ...
                                    break;
                                default:
                                    $link_img = isset($iSpec['link_img']) && $iSpec['link_img'] != "" ? $iSpec['link_img'] : base_url() . "public/images/img_blank.gif";
                                    $strContent .= "<i onclick=\"showImageSwal('".$iSpec['nama']."','".$link_img."')\" class='fa fa-photo'></i>&nbsp;&nbsp;<a href='javascript:void(0);' onclick=\"document.getElementById('result').src='" . $iSpec['target'] . "?selector&id=" . $iSpec['id'] . "$defVal';$mb_js\">";
                                    break;
                            }
                        }

                        /* --------------------------------------------
                         * yg tampil di selector view, dikirim dari kontroler
                         * */
                        // $strContent .= isset($iSpec['nama']) ? $iSpec['nama'] : "";
                        $strContent .= "<span class='text-uppercase'>" . $iSpec['label'] . "</span>";
