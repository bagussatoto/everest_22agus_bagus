 ...
 * -------------------------------------------------------*/
        ...
        $tanggal_transaksi .= "<p class='no-margin'>$nomer <i class='hidden-on-print' style='color: #FFFFFF'>$trIdKhusus</i></p>";
...
//         cekHijau("$template");
    ...
    case "viewReceipt_new":
        ...
        $tanggal_transaksi .= "<div class='text-uppercase' style='float: left;text-align: left; overflow: hidden;margin-top: -15px;'>";
        $tanggal_transaksi .= "<h4 id='title' class='no-margin text-renggang-55 text-bold'>$title</h4>";
        ...
        $orderDate = $ids_his['1']['dtime'];
        $orderNomer = $ids_his['1']['nomer'];
        // arrPrintHijau($ids_his);
        ...
        $ordergDate .= "<div class='text-capitalize'>$orderDate</div>";
        $ordergDate .= "</div>";
        $ordergDate .= "</div>";
        ...
        $status .= "<div class='text-capitalize'>$pembayaran_sys / $kirim_metode_nama</div>";
        $status .= "</div>";
        $status .= "</div>";
