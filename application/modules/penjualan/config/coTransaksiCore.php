    ...
    "5822" => array(
        ...
        "valueGates" => array(//==sumber nilai yang dikirim kemana2
            "master" => array(//==sumber nilai utama
                "customerID" => "pihakID",
                "customerName" => "pihakName",
                "marketplaceID" => "pihakMarketplaceID",
                "marketplaceName" => "pihakMarketplaceName",
                "tipe_penjualan" => "pihakTipeID",
                "tipe_penjualan_nama" => "pihakTipeName",
            ),
            "detail" => array(//===sumber nilai berupa rincian
                //--------------
//                "disc" => "harga-nett1",
...
//                                "ppv_riil" => "ppv_riil",
        ...
        "tableIn" => array(
            "master" => array(
                ...
                "cabang_id" => "placeID",
                "cabang_nama" => "placeName",
                "transaksi_nilai" => "nilai_tambah_2010050_2010050010",
                "transaksi_jenis" => "jenisTr",
                "keterangan" => "description",
                ...
                "referensi_nomer" => "referenceNomer",
                "referensi_jenis" => "referenceJenis",
                "referensi_id_top" => "referenceID__1",
                "referensi_nomer_top" => "referenceNomer__1",
                "referensi_jenis_top" => "referenceJenis__1",
                "reference_id_top" => "referenceID__1",
                "reference_nomer_top" => "referenceNomer__1",
                "reference_jenis_top" => "referenceJenis__1",
                "pembayaran" => "paymentMethod",
                "pembayaran_sys" => "paymentMethod",
                //---------------
                "pengirim_id" => "pengirimID",
...
//                            "supplierID" => "pihakID",
                    ...
                    // rekening pembantu produk serial paket
                    array(
                        "comName" => "RekeningPembantuProdukPerSerial",
                        "loop" => array(
                            "1010030030" => ".-1",//persediaan produk, sub_diskon_nilai_total
        ...
        "rejectComponent" => array(
            "5822" => array(
                "master" => array(
                    ...
                    // UANG MUKA KONSUMEN TANPA PPN DIPINDAH KE DC
                    // JURNAL CABANG
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "2010050" => "-nilai_bayar",// hutang ke konsumen
                            "2040010" => "nilai_bayar",// hutang ke pusat
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                        "comName" => "PaymentUangMuka",
                    ...
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "1010060010" => "nilai_bayar",// piutang cabang
                            "2010050" => "nilai_bayar",// hutang ke konsumen
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
...
//                            "cabang_id" => "placeID",
                ...
                "detail" => array(
                    array(
                        ...
                        "static" => array(
                            ...
                            "produk_id" => "id",
                            "produk_nama" => "name",
                            "reference_id_so_so" => "referenceID__2",
                            "reference_id_so_po" => "referenceID__2",
                        ),
                        "reversable" => true,
                        "srcGateName" => "items",
                        "srcRawGateName" => "items",
        ...
        //---- reload value_builder (true, false)
        "reloadValueBuilder" => true,
    ),
...
//                        "srcRawGateName" => "items",
                    ...
                    array(
                        "comName" => "RekeningPembantuHppRiilItem",
                        "loop" => array(
                            "5030" => "-sub_hpp_riil",//persediaan hpp riil
                        ),
                        "static" => array(
                            "cabang_id" => ".-1",
                            "extern_id" => "id",
                ...
                "master" => array(
                    array(
                        ...
                        "static" => array(
                            ...
                            "transaksi_dibayar" => ".0",
                            "transaksi_reject" => ".0",
                            "transaksi_fullfillment" => "grandTotal",
                            "transaksi_nett" => "grandTotal",
                            "transaksi_saldo" => "grandTotal",
                            "transaksi_id" => "transaksiDatas",
                            "transaksi_no" => "transaksiDatas__nomer",
                        ),
                        "srcGateName" => "main",
                        "srcRawGateName" => "main",
                        "reversable" => true,
            ...
            "master_dependent" => array(
                "paymentMethod" => array(
                    "cash" => array(
                        "nilai_cash" => "tagihan",
                        "nilai_credit" => "0",
                        "nilai_penjualan_cash" => "nett1-(add_diskon+diskon_kategori_unit)",
                        "nilai_penjualan_credit" => "0",
                        "nilai_penjualan_produk" => "nett1-(add_diskon+diskon_kategori_unit)-harga_jasa",
                        "nilai_ppn_cash" => "grand_ppn",
                        "nilai_ppn_credit" => "0",
                        "nilai_piutang_dagang" => "0",
                        "kredit_limit_order" => "0",
                        "defaultPaymentMethod" => ".cash",
...
//            //            "grand_hutang" => "",
        ...
        "preProcessor" => array(
            "5823pkd" => array( // dijalankan bila mendapatkan target 582so, (bila mendapatkan optTarget 582spod tidak dijalankan)
                "master" => array(
                    //untuk reguler terbit items3_sum
                    array(
                        "comName" => "ProdukSerialNumberExtractor",
...
//                            "nilai" => "nett1+ppn",
                    ...
                    array(
                        ...
                        "static" => array(
                            ...
                            "force" => ".true",
                            "payment_method" => "paymentMethod",
                            "pos_jenis" => ".cash",//biar baca saldo hutang kekonsumen walaupun paymentmethode credit
//                            "nilai" => "nett1+ppn",
                        ),
                        "resultParams" => array(
                            "main" => array(
                ...
                "master" => array(
                    ...
                    array(
                        ...
                        "loop" => array(
                            "2010050" => "-(nilai_dipakai_2010050_2010050010+pym_src_dipakai)",// hutang ke konsumen
//                            "2010050" => "-nilai_dipakai_2010050_2010050010",// hutang ke konsumen
//                            "1010020010" => "nilai_tambah_2010050_2010050010",// piutang dagang, jalur POS tidak menerbitkan piutang (26 feb 2025)
                            "4010" => "nilai_penjualan_cash",// penjualan digeser ke penjualan lokal dari penjualan
                            "7010130" => "ongkir",// jasa kirim
                            "1010030030" => "-hpp",// persediaan produk
                            "5010" => "(hpp+ppv_riil)",// hpp
                            "7010150" => "ppv_riil",// laba lain lain
                            "2030060" => "nilai_ppn_cash",// ppn out
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "2010050" => "-nilai_dipakai_2010050_2010050010",// hutang ke konsumen
//                            "1010020010" => "nilai_tambah_2010050_2010050010",// piutang dagang, jalur POS tidak menerbitkan piutang (26 feb 2025)
                            "4010" => "nilai_penjualan_cash",// penjualan
                            "7010130" => "ongkir",// jasa kirim
                            "1010030030" => "-hpp",// persediaan produk
                            "5010" => "(hpp+ppv_riil)",// hpp
                            "7010150" => "ppv_riil",// laba lain lain
...
//                            "cabang_id" => "placeID",
    ...
    //pengeluaran cashback berupa produk
    "66771" => array(
        "counters" => array(
            "stepCode|placeID",
            "stepCode|olehID",
...
// END OF COMPLETE REPEATED LOGIC
        ...
        "valueBuilders" => array(
            "selisih_hpp" => "hutang_hadiah_produk-hpp",
        ),
        "preProcessor" => array(
            "66771" => array(
                "master" => array(
                ...
                "master" => array(
                    array(
                        ...
                        "loop" => array(
                            ...
                            "1010030030" => "-hpp",// persediaan produk
                            "7010010" => "selisih_hpp",//laba(rugi) selisih fofo persediaan
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "jenis" => "jenisTr",
...
//                            "validate" => ".1",
    ...
    "66773" => array(
        ...
        "valueBuilders" => array(
            "dpp_pengganti" => "hpp*(11/12)",
            "dpp_pengganti_factor" => "11/12",
            "ppn" => "(11/100)*dpp_pengganti",
            "new_grand_ppn" => "(11/100)*dpp_pengganti",
            "grand_ppn" => "(11/100)*dpp_pengganti",
            "new_grand_ppn" => "(11/100)*dpp_pengganti",
            "ppn_out_bulat" => "(11/100)*dpp_pengganti",
            "dpp_ppn" => "hpp",
            "grandTotal" => "hpp+ppn",
            "new_net3" => "hpp+ppn",
            "grand_pembulatan" => "hpp+ppn",
            //----
            ...
            "66773" => array(
                "master" => array(
                    array(
                        "comName" => "Jurnal",
                        "loop" => array(
                            "6010" => "grandTotal",//potongan penjualan
//                            "4010" => "hpp",//penjualan
                            "2030060" => "ppn",//ppn keluaran
//                            "5010" => "hpp",// hpp
                            "1010030030" => "-hpp",// persediaan produk
                        ),
                        "static" => array(
...
//                    ),
                    array(
                        ...
                        "loop" => array(
                            "6010" => "grandTotal",//biaya usaha
                        ),
                        "static" => array(
                            "cabang_id" => "placeID",
                            "extern_id" => ".4",//tembakan dulu.
                            "extern_nama" => ".Perlengkapan Promosi",
                            "jenis" => "jenisTr",
                        ),
                        "srcGateName" => "main",
                        "srcRawGateName" => "main",
