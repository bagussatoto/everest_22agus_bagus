...
//        arrPrint($_GET);
        ...
        $configElement = $this->configUi[$jenisTr]['receiptElements'];
        $configElementPatch = $this->configUi[$jenisTr]['followUpLiveEditField'];
...
//        arrPrint($this->uri->segment_array());
        ...
        if (sizeof($ltTmp) > 0) {
            /**
             * tambahin alerttoGo biir refresh halaman
             */
