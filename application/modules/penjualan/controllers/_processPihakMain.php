...
class _processPihakMain extends Modul_Controller
{
    ...
    public function select()
    {
        ...
        /* --------------------------------------------
         * pengantian gudang akan menghapus session item
         * --------------------------------------------*/
        $link_remove_item = base_url() . "penjualan/_processSelectProduct/remove/5822";
        $items = $_SESSION[$cCode]['tableIn_master_values']['pihakMainID'];
        if (isset($_SESSION[$cCode]['main']['pihakMainID'])) {
            // cekAlert("ok $items **** $id");

            if ($items != $id) {
                // cekAlert("cleaning item tanpa delet pihak");
                echo "<script>setTimeout(
                        function() {
                            top.document.getElementById('result').src='$link_remove_item';     
                        },200
                    )</script>";
            }
        }
        elseif ($items != $id) {
            // cekAlert("cleaning item");
            echo "<script>setTimeout(
                        function() {
                            top.document.getElementById('result').src='$link_remove_item';     
                        },200
        ...
        if (sizeof($tmpB) > 0) {
            ...
            $_SESSION[$cCode]['main']['pihakMainJenis'] = isset($tmpB[0]->jenis) ? $tmpB[0]->jenis : "";
    ...
    public function remove()
    {
        ...
        $_SESSION[$cCode]['main']['pihakMainJenis'] = null;
        unset($_SESSION[$cCode]['main']['pihakMainID']);
        unset($_SESSION[$cCode]['main']['pihakMainName']);
        unset($_SESSION[$cCode]['main']['pihakMdlName']);
        unset($_SESSION[$cCode]['main']['pihakMainJenis']);
        //        unset($_SESSION[$cCode]['items']);//tak matiin ini bgreset kalau acum a ganti pihak
    ...
    {
        $cCode = "_TR_" . $this->jenisTr;
        $_SESSION[$cCode]['main']['pihakMain2ID'] = null;
        $_SESSION[$cCode]['main']['pihakMain2Name'] = null;
        //        $_SESSION[$cCode]['main']['pihakMdlName'] = null;
        unset($_SESSION[$cCode]['main']['pihakMain2ID']);
        unset($_SESSION[$cCode]['main']['pihakMain2Name']);
        //        unset($_SESSION[$cCode]['main']['pihakMdlName']);
        unset($_SESSION[$cCode]['items']);
    ...
    public function selectSalesman()
    {
        ...
        if (sizeof($tmpB) > 0) {
            $_SESSION[$cCode]['main']['pihakMain2ID'] = $id;
            $_SESSION[$cCode]['main']['pihakMain2Name'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            ...
            echo "<script>";
            echo "  top.$('#shopping_cart').load('" . MODUL_PATH . "/_shoppingCart/viewCart/" . $this->jenisTr . "?selID=$id');";
            echo "top.document.getElementById('pihakMain2Name').value='" . $tmpPihakName . "';";
            //            echo "top.document.getElementById('pilihan_item2').innerHTML='';";
            echo "top.document.getElementById('pilihan_item2').style.display='none';";
            echo "</script>";
        }
        else {
            $_SESSION[$cCode]['main']['pihakMain2ID'] = $id;
            $_SESSION[$cCode]['main']['pihakMain2Name'] = "";
            if (sizeof($pihakMainValueSrc) > 0) {
                foreach ($pihakMainValueSrc as $key => $src) {
                    $_SESSION[$cCode]['main'][$key] = $tmpB[0]->$src;
                }
            ...
            echo "<script>";
            echo "  top.$('#shopping_cart').load('" . MODUL_PATH . "/_shoppingCart/viewCart/" . $this->jenisTr . "?selID=$id');";
            echo "top.document.getElementById('pihakMain2Name').value='" . $_SESSION[$cCode]['main']['pihakMainName'] . "';";
            echo "top.document.getElementById('pilihan_item2').innerHTML='';";
            echo "</script>";
        }
...
//        }
        ...
        if (sizeof($tmpB) > 0) {
            $_SESSION[$cCode]['main']['pihakTipeID'] = $id;
            $_SESSION[$cCode]['main']['pihakTipeName'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            $_SESSION[$cCode]['main']['pihakTipeJenis'] = isset($tmpB[0]->jenis) ? $tmpB[0]->jenis : "";
...
//            }
            ...
            if ($id == 0) {
                $_SESSION[$cCode]['main']['pihakMarketplaceID'] = 0;
                $_SESSION[$cCode]['main']['pihakMarketplaceName'] = "";
                $_SESSION[$cCode]['main']['pihakMarketplaceJenis'] = "";
                echo "<script>";
                echo "top.document.getElementById('data_marketplace').style.display='none';";

                echo "</script>";
            }
            else{
                echo "<script>";
                echo "top.document.getElementById('data_marketplace').style.display='block';";
                echo "</script>";
            }
            ...
            $_SESSION[$cCode]['main']['pihakTipeID'] = $id;
            $_SESSION[$cCode]['main']['pihakTipeName'] = "";
//            if (sizeof($pihakMainValueSrc) > 0) {
//                foreach ($pihakMainValueSrc as $key => $src) {
//                    $_SESSION[$cCode]['main'][$key] = $tmpB[0]->$src;
//                }
//            }
    ...
    public function selectMarketplace()
    {
...
//        }
        ...
        if (sizeof($tmpB) > 0) {
            $_SESSION[$cCode]['main']['pihakMarketplaceID'] = $id;
            $_SESSION[$cCode]['main']['pihakMarketplaceName'] = isset($tmpB[0]->$selectColumn) ? $tmpB[0]->$selectColumn : "";
            $_SESSION[$cCode]['main']['pihakMarketplaceJenis'] = isset($tmpB[0]->jenis) ? $tmpB[0]->jenis : "";
