        ...
        if (isset($_SESSION[$cCode])) {
            if (isset($_SESSION[$cCode]['items'])) {
                ...
                foreach ($_SESSION[$cCode]['items'] as $id => $iSpec) {
                    ...
                    //---------------
//                    cekHere("[$shopingCartPaymentItemsColorEnabled]");
...
//                $show = ($cekPPN_nilai > 0) ? true : false;
        ...
        cekHere("[shopingCartReload: $shopingCartReload]");
            ...
            case "uang_muka_dipakai":
                ...
                if ($val > $sisa_total) {
                    $selisih = $val - $sisa_total;
                        if ($selisih > -1) {
                        $msg = "Uang Muka konsumen yang akan dipakai melebihi tagihan. Silahkan diperiksa lagi. code: " . __LINE__;
                        echo "<script>
