...
switch ($mode) {
    ...
    case "scaner_ori":
        ...
        $list_data .= "<input id='qr_scaner' type='$tipe_input' class='form-control' value='' placeholder='kode produk' onkeyup=\"getData('" . $do_scane . "?str='+encodeURI(this.value), 'hasil')\">";
            ...
            <div class='row hidden-xs'>
                <div class='container-fluid'>
                    <div id='input-group-qr' class='input-group' style='display:block!important;'>
                        <input id='qr_scaner' type='$tipe_input' $disabledScanner onclick='select()' class='form-control text-center text-bold' value='' placeholder='kode produk'>
