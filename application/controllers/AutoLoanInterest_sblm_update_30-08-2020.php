...
//            arrPrint($paymentSource);
            ...
            foreach ($finalData as $produk_id => $detilSourceItems){
                ...
                cekHitam($produk_id . " ||| produk_id");

                        $npwp = isset($arrDtaHutangPihak[$produk_id]->npwp) ? $arrDtaHutangPihak[$produk_id]->npwp : "";
                        $pph_nilai = isset($arrDtaHutangPihak[$produk_id]->ppn) ? $arrDtaHutangPihak[$produk_id]->ppn : "";
                        $pph_nilai = strlen($npwp)>10 && $pph_nilai==15 ? 15 : 15;
