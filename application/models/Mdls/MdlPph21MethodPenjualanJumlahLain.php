...
class MdlPph21MethodPenjualanJumlahLain extends MdlMother
{
...
//        ),
    ...
    protected $staticData = array(
        array(
            "id" => "npwp",
            "name" => "PPh Ps.21 (tarif 2.5%)",
            "tarif" => "2.5",
            "tarif_label" => "2.5%",
//            "tarif" => "5",
//            "tarif_label" => "5%",
        ),
        // tgl 1 maret 2025, tarif yang dipakai pph21 2.5%, punya npwp dan tidak punya npwp
        array(
            "id" => "non_npwp",
            "name" => "PPh Ps.21 (tarif 5%)",
            "tarif" => "5",
            "tarif_label" => "5%",
        ),
