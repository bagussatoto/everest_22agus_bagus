...
class MdlPpnStatic extends MdlMother
{
...
//        "jenis='payment'",
    ...
    protected $staticData = array(
        array(
            "id" => "pm",
            "name" => "pm (ada faktur pajak)",
//            "label" =>"ppn masukan",
            "notif" =>"Adanya PPN dan tanpa PPN berdampak pada Jurnal",
        ),
        array(
            "id" => "non_pm",
            "name" => "non pm (tanpa faktur pajak)",
//            "label"=>"non ppn masukan",
            "notif" =>"Adanya PPN dan tanpa PPN berdampak pada Jurnal",
        ),
