...
class MdlPph23MethodPotonganModeBarang extends MdlMother
{
...
//        "trash='0'",
    ...
    protected $staticData = array(
        array(
            "id" => "1",
            "name" => "ditanggung penerima hadiah",
            "tarif" => "15",
            "notif" => "Penerima Hadiah menganggung/membayar PPh23",
            "kode" => "1",
        ),
        array(
            "id" => "2",
            "name" => "ditanggung pemberi hadiah",
            "tarif" => "15",
            "notif" => "Pemberi Hadiah menganggung/membayar PPh23",
            "kode" => "0",
        ),
