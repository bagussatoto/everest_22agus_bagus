...
class MdlFasilitasPajakStatic extends MdlMother
{
...
//        "jenis='payment'",
    ...
    protected $staticData = array(
        array(
            "id" => "1",
            "nama" => "tanpa fasilitas pajak",
            "name" => "tanpa fasilitas pajak",
            "keterangan"=>"pajak normal",

        ),
        array(
            "id" => "2",
            "nama" => "pajak ditanggung pemerintah",
            "name" => "pajak ditanggung pemerintah",
            "keterangan"=>"PPN DITANGGUNG PEMERINTAH. kode 07",
        ),
    );
