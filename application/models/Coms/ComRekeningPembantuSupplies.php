...
class ComRekeningPembantuSupplies extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_supplies_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_supplies",
            //            "cache" => "_rek_pembantu_supplies_cache",
        );
...
//                        $this->tableName = $table[$key]["cache"];
                        ...
                        $pakai_average = 1;
                        if($pakai_average==1){
                            //update average degnan data terbaru supaya selalu sinkron degnan rekening
                            $f = new MdlFifoAverageSupplies();
                            $f->setFilters(array());
                            $f_updateData = array(
                            ...
                            $f->updateData($f_where,$f_updateData);
                        }
//                        matiHEre();
