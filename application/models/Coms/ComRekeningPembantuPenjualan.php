...
class ComRekeningPembantuPenjualan extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] > 0)) ? $this->inParams['static']['extern_id'] : mati_disini(("unknown customerID*. Please contact system administrator."));
                    $extern2ID = (isset($this->inParams['static']['extern2_id']) && ($this->inParams['static']['extern2_id'] > 0)) ? $this->inParams['static']['extern2_id'] : 0;
...
//                            mati_disini(("insufficient balance for $key " . $this->inParams['static']['extern_nama'] . ""));
//                        }
//                    }
