...
//                                    matiHEre(__LINE__."::".$cCode."::".$pName_surce);
                                    ...
                                    $msg = "Nilai rata-rata[$pId] $pNama dibawah 1 ($produk_hpp_avg). Silahkan periksa kembali transaksi anda. code: " . __LINE__;
                                }
                ...
                if ($pakai_exec == 1) {
                    ...
                    if ($array_params['static']['jml'] > 0) {
                        ...
                        if (sizeof($faTmp) > 0) {
                            ...
                            cekHere("cek stok: $jml_hasil <= " . $last_stock[$array_params['static']['produk_id']] . " jml masuk: " . $array_params['static']['jml'] . ", jenis: " . $array_params['static']['jenis']);
...
//        arrPrintPink($tmp_result);
        // SoT dipindah ke ComRekeningPembantuProduk, pakai_average=1
