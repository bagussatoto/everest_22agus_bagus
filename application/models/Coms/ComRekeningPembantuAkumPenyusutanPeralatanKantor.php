...
class ComRekeningPembantuAkumPenyusutanPeralatanKantor extends MdlMother
{
...
//        $this->tableName_fifoAvg = "fifo_avg";
        $this->tableName = "_rek_pembantu_akumperkantor_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_akumperkantor",
        );
    }
