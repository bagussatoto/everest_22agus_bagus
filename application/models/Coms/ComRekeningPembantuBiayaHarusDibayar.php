...
class ComRekeningPembantuBiayaHarusDibayar extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_biayaharusdibayar_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_biayaharusdibayar",
        );
