...
class ComRekeningPembantuUangMuka extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_uang_muka_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_uang_muka",
        );
        $elementTimeStart = microtime(true);
//        $this->rekeningAlias = fetchAccountStructureAlias();
//        showLast_query("ungu");
//        heGetTimedQuery($elementTimeStart);
    }
