...
class ComRekeningPembantuAkumPenyusutanKendaraan extends MdlMother
{
...
//        $this->tableName_fifoAvg = "fifo_avg";
        $this->tableName = "_rek_pembantu_akumpenyukendaraan_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_akumpenyukendaraan",
        );
    }
