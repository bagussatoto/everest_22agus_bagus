...
//
//
                            cekHitam("[afterPosition: $afterPosition] [afterNumber: $afterNumber]");
                            cekHitam(detectRekDefaultPosition($key));
                            cekHitam((int)$afterNumber);
                            if ($afterPosition != detectRekDefaultPosition($key) && ((int)$afterNumber != 0)) {
