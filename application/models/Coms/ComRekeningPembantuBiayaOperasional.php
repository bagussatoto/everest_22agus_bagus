...
class ComRekeningPembantuBiayaOperasional extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayaoperasional_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayaoperasional",
        );
