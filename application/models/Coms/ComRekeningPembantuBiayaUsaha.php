...
class ComRekeningPembantuBiayaUsaha extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayausaha_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayausaha",
        );
...
//                            $lCounter++;
                            ...
                            $_preValues = $this->cekPreValue($key, $this->inParams['static']['cabang_id'], $periode, $this->inParams['static']['extern_id'], $this->inParams['static']['fulldate']);
...
//                            arrPrint($pSpec_mode);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $date = NULL)
    {
        if ($date != NULL) {
