...
class ComRekeningPembantuLogamMulia extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_sublogammulia_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_sublogammulia",
        );
    }
