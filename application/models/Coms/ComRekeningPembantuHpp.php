...
class ComRekeningPembantuHpp extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $_preValues = $this->cekPreValue($key, $this->inParams['static']['cabang_id'], $periode, $externID, $this->inParams['static']['fulldate']);
...
//                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_kredit_periode"] = 0;
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $fulldate)
    {
        if (isset($fulldate)) {
