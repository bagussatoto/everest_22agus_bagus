...
class ComRekeningPembantuCustomerItem extends MdlMother
{
            ...
            foreach ($this->periode as $periode) {
                foreach ($this->inParams as $array_params) {
                    ...
                    foreach ($array_params['loop'] as $key => $value) {
                        ...
                        $_preValues = $this->cekPreValue($key, $array_params['static']['cabang_id'], $periode, $array_params['static']['extern_id']);
