    ...
    public function pair($inParams)
    {
        ...
        foreach ($inParams as $this->inParams) {
            ...
            if (sizeof($this->inParams['static']) > 0) {
                ...
                $jenis = isset($this->inParams['static']['jenis']) ? $this->inParams['static']['jenis'] : 0;
                $cashbackCheck = isset($this->inParams['static']['cashbackCheck']) ? $this->inParams['static']['cashbackCheck'] : 0;

                if ($ppn_sudah_faktur > 0) {
                    if (($jenis == 16677) && ($cashbackCheck == 3)) {
                        cekHitam("cashback/hadiah produk, tidak ada komisi ap payment");
