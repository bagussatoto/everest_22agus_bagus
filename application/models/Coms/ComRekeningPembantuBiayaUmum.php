...
class ComRekeningPembantuBiayaUmum extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayaumum_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayaumum",
        );
...
//                        cekMerah("create tabel $val - $key");
    ...
    public function fetchBalances($rek, $key = "", $sortBy = "", $sortMode = "ASC", $periode="forever", $date=NULL)
