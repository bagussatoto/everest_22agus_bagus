...
class ComRekeningPembantuReturnPenjualan extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] > 0)) ? $this->inParams['static']['extern_id'] : die(lgShowAlert("unknown customerID*. Please contact system administrator."));
