...
class ComRekeningPembantuBiayaProjectMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayaproject_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayaproject",
        );
...
//                            $lCounter++;
                        ...
                        $extern_id = isset($this->inParams['static']['extern_id']) ? $this->inParams['static']['extern_id'] : 0;
                        if ($extern_id == 0) {
...
//arrPrint($this->outParams);
                        ...
                        if ($pakai_exec == 1) {
                            ...
                            if (sizeof($this->outParams) > 0) {
                                cekMerah("outParams biaya project");
//                                    arrPrint($this->outParams);
