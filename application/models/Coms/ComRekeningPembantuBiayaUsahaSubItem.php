...
class ComRekeningPembantuBiayaUsahaSubItem extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayausaha_detail_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayausaha_detail",
        );
