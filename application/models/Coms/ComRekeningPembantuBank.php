...
class ComRekeningPembantuBank extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_bank_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_bank",
        );
    }
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $_preValues = $this->cekPreValue($key, $inParams['static']['cabang_id'], $periode, $inParams['static']['extern_id'],$inParams['static']['extern2_id']);
...
//                    arrPrint($this->outParams);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $pihak_id,$extern2_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
