...
class ComRekeningPembantuBiayaUmumSubMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subbiayaumum_detail_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subbiayaumum_detail",
        );
