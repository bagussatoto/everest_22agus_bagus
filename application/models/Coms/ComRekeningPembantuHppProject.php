...
class ComRekeningPembantuHppProject extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_hpp_project_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_hpp_project",
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] > 0)) ? $this->inParams['static']['extern_id'] : mati_disini(("unknown projectID*. Please contact system administrator."));
                    $extern2ID = (isset($this->inParams['static']['extern2_id']) && ($this->inParams['static']['extern2_id'] > 0)) ? $this->inParams['static']['extern2_id'] : mati_disini(("unknown customerID*. Please contact system administrator."));
...
//                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_kredit_periode"] = 0;
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $rekening2_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
